...
<div class="page-card subjects-page">
    ...
    <div class="subj-header anim-in" style="animation-delay:.02s;">
        <div>
            <h2>My Subjects</h2>
            <p>View your enrolled subjects, schedules, and assigned teachers for <?php echo e($semesterLabel); ?>.</p>
        </div>
    ...
    <div class="subj-stats anim-in" style="animation-delay:.08s;">
        <div class="subj-stat">
            ...
            <div>
                ...
                <span class="value"><?php echo e($totalSubjects); ?></span>
            </div>
        </div>
        <div class="subj-stat">
            ...
            <div>
                ...
                <span class="value"><?php echo e(number_format($totalUnits, 1)); ?></span>
            </div>
        </div>
        <div class="subj-stat">
            ...
            <div>
                ...
                <span class="value" style="font-size:.98rem;"><?php echo e($semesterLabel); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="subj-grid anim-in" id="subjGrid" style="animation-delay:.2s;">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <?php
            ...
            <div class="subject-card"
                 style="animation-delay:<?php echo e(.04 * $index); ?>s;"
                 data-title="<?php echo e(strtolower($subjectTitle)); ?>"
                 data-teacher="<?php echo e(strtolower($teacherName)); ?>"
                 data-units="<?php echo e($units); ?>">
                <div class="card-top">
                    <span class="code-badge"><?php echo e($subjectCode); ?></span>
                    <span class="status-pill"><?php echo e($status); ?></span>
                </div>

                <h3 class="subject-title"><?php echo e($subjectTitle); ?></h3>

                <div class="teacher-row">
                    <div class="avatar"><?php echo e($initials ?: 'T'); ?></div>
                    <div class="teacher-meta">
                        <span class="name"><?php echo e($teacherName); ?></span>
                        <span class="role"><?php echo e($teacherRole); ?></span>
                    </div>
                </div>
                ...
                <div class="meta-grid">
                    <div class="meta-item">
                        ...
                        <span class="meta-value"><?php echo e(number_format($units, 1)); ?></span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label">Schedule</span>
                        <span class="meta-value"><?php echo e($schedule); ?></span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label">Room</span>
                        <span class="meta-value"><?php echo e($room); ?></span>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\subjects\index.blade.php ENDPATH**/ ?>