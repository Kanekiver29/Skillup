...
<?php $__env->startSection('title', 'Reports – SkillUp Admin'); ?>
...
<div class="rp-page">
        ...
        <div class="rp-header-inner">
            <div class="rp-header-left">
                ...
                <div>
                    ...
                    <p class="rp-subtitle">Analytics snapshot as of <?php echo e(now()->format('F d, Y')); ?></p>
                </div>
            </div>
            <div class="rp-actions">
                <a href="<?php echo e(route('admin.reports.export')); ?>" target="_blank" class="rp-btn rp-btn-blue">
                    <i class="fas fa-file-csv"></i> Export CSV
                </a>
                <a href="<?php echo e(route('admin.excel.export-enrollment')); ?>" target="_blank" class="rp-btn rp-btn-green">
    ...
    <section class="rp-stats-grid">
        ...
        <div class="rp-card rp-stat-card">
            ...
            <p class="rp-stat-value"><?php echo e(number_format($totalUsers)); ?></p>
            <p class="rp-stat-meta">
                <?php echo e($totalAdmins); ?> admin<?php echo e($totalAdmins !== 1 ? 's' : ''); ?> &bull;
                <?php echo e(number_format($totalStudents)); ?> student<?php echo e($totalStudents !== 1 ? 's' : ''); ?>

            </p>
            <p class="rp-stat-positive">+<?php echo e($newUsersThisMonth); ?> new this month</p>
        </div>
        ...
        <div class="rp-card rp-stat-card">
            ...
            <p class="rp-stat-value"><?php echo e(number_format($totalCourses)); ?></p>
            <p class="rp-stat-meta">
                <?php echo e(number_format($publishedCourses)); ?> published &bull;
                <?php echo e(number_format($totalCourses - $publishedCourses)); ?> draft
            </p>
        </div>
        ...
        <div class="rp-card rp-stat-card">
            ...
            <p class="rp-stat-value"><?php echo e(number_format($totalEnrollments)); ?></p>
            <p class="rp-stat-meta"><?php echo e(number_format($completedEnrollments)); ?> completed</p>
        </div>
        ...
        <div class="rp-card rp-stat-card">
            ...
            <p class="rp-stat-value"><?php echo e($avgProgress); ?>%</p>
            <div class="rp-progress-track"><div class="rp-progress-fill" style="width: <?php echo e(min($avgProgress, 100)); ?>%"></div></div>
        </div>
        ...
        <div class="rp-card">
            ...
            <div class="rp-chart-body" style="display:flex;flex-direction:column;align-items:center;">
                ...
                <div class="rp-donut-legend">
                    <span><span class="dot" style="background:var(--success)"></span>Completed (<?php echo e(number_format($completedEnrollments)); ?>)</span>
                    <span><span class="dot" style="background:var(--accent)"></span>In Progress (<?php echo e(number_format($totalEnrollments - $completedEnrollments)); ?>)</span>
                </div>
            </div>
        </div>
        ...
        <div class="rp-card">
            <div class="rp-card-head">
                ...
                <div class="rp-live-meta">
                    ...
                    <div>Total rows: <span id="live-row-count"><?php echo e($recentEnrollments->count()); ?></span></div>
                </div>
            </div>
                ...
                <table class="rp-table">
                    ...
                    <tbody id="live-enrollments-body">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td>
                                    <p class="rp-cell-strong truncate max-w-[180px]"><?php echo e($enrollment->user->name ?? '—'); ?></p>
                                    <p class="rp-cell-meta"><?php echo e($enrollment->created_at->format('M d, Y')); ?></p>
                                </td>
                                <td class="rp-cell truncate max-w-[180px]"><?php echo e($enrollment->course->title ?? 'Deleted Course'); ?></td>
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="rp-progress-text"><?php echo e($enrollment->progress ?? 0); ?>%</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="rp-td-right rp-cell-meta"><?php echo e($enrollment->updated_at->diffForHumans()); ?></td>
                            </tr>
    ...
    <section class="rp-bottom-grid">
        ...
        <div class="rp-card">
            <div class="rp-card-head">
                ...
                <a href="<?php echo e(route('admin.courses.index')); ?>" class="rp-link">View all</a>
            </div>
            <div class="rp-table-wrap">
                <table class="rp-table">
                    <thead class="rp-thead">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td class="rp-rank"><?php echo e($i + 1); ?></td>
                                <td>
                                    <p class="rp-cell-strong truncate max-w-xs"><?php echo e($course->title); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->category): ?>
                                        <p class="rp-cell-meta"><?php echo e($course->category); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="rp-td-right"><span class="rp-pill-count"><?php echo e(number_format($course->enrollments_count)); ?></span></td>
                            </tr>
        ...
        <div class="rp-card">
            <div class="rp-card-head">
                ...
                <a href="<?php echo e(route('admin.enrollments.index')); ?>" class="rp-link">View all</a>
            </div>
            <div class="rp-table-wrap">
                <table class="rp-table">
                    <thead class="rp-thead">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td>
                                    <p class="rp-cell-strong truncate max-w-[130px]"><?php echo e($enrollment->user->name ?? '—'); ?></p>
                                    <p class="rp-cell-meta"><?php echo e($enrollment->created_at->format('M d, Y')); ?></p>
                                </td>
                                <td class="rp-cell truncate max-w-[130px]"><?php echo e($enrollment->course->title ?? 'Deleted Course'); ?></td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new ApexCharts(document.querySelector('#trends-chart'), {
        ...
        theme: { mode: 'dark' },
        series: [
            { name: 'New Signups',   data: <?php echo json_encode($monthlySignups, 15, 512) ?> },
            { name: 'Enrollments',   data: <?php echo json_encode($monthlyEnrollments, 15, 512) ?> },
            { name: 'Completions',   data: <?php echo json_encode($monthlyCompletions, 15, 512) ?> },
        ],
        xaxis: {
    ...
    const completed  = <?php echo json_encode($completedEnrollments, 15, 512) ?>;
    const inProgress = <?php echo json_encode($totalEnrollments - $completedEnrollments, 15, 512) ?>;
    ...
    const liveApiUrl = '<?php echo e(route('admin.reports.liveData')); ?>';
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\users\reports.blade.php ENDPATH**/ ?>