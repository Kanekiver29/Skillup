    ...
    <div class="quiz-card" id="quiz-card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($result)): ?>
            ...
            <div class="quiz-complete">
                <div class="score-display"><?php echo e($percentage); ?>%</div>
                <p class="score-fraction"><?php echo e($result->score ?? 0); ?> of <?php echo e($result->total ?? 0); ?> correct</p>
                <div class="score-message"><?php echo e($message); ?></div>

                <div class="result-progress"><div class="result-progress-fill" data-target="<?php echo e($percentage); ?>"></div></div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($result->breakdown)): ?>
                    <div class="breakdown">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $result->breakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="breakdown-item <?php echo e($row->is_correct ? 'correct' : 'incorrect'); ?>" style="animation-delay: <?php echo e($index * 60); ?>ms">
                                <span><?php echo e($row->question); ?></span>
                                <span><?php echo e($row->is_correct ? '✓ Correct' : '✗ ' . ($row->selected_text ?? 'No answer')); ?></span>
                            </div>
                ...
                <div class="button-group">
                    <a href="<?php echo e(route('quiz')); ?>" class="btn btn-primary"><i class="fa-solid fa-repeat"></i> Retake Quiz</a>
                    <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back to Courses</a>
                </div>
            </div>

        <?php elseif($quiz && $questions->isNotEmpty()): ?>
            <form method="POST" action="<?php echo e(route('quiz.submit', $quiz->id)); ?>" id="quiz-form">
                <?php echo csrf_field(); ?>

                <div class="progress-track">
                    <span id="progress-label">Question 1 of <?php echo e($questions->count()); ?></span>
                    <span><?php echo e($quiz->title ?? 'Quiz'); ?></span>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    ?>
                    <div class="question-container <?php echo e($index === 0 ? 'active' : ''); ?>" data-index="<?php echo e($index); ?>">
                        <div class="question-number">Question <?php echo e($index + 1); ?></div>
                        <div class="question-text"><?php echo e($qText); ?></div>
                        <div class="options">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php $optionText = $option->option_text ?? $option->text ?? (string) $option; ?>
                                <label class="option">
                                    <input type="radio" name="answers[<?php echo e($question->id); ?>]" value="<?php echo e($option->id ?? $optionText); ?>" required>
                                    <span><?php echo e($optionText); ?></span>
                                </label>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <div class="no-quiz">
                ...
                <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i> Back to Courses</a>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Userpage\course\quiz.blade.php ENDPATH**/ ?>