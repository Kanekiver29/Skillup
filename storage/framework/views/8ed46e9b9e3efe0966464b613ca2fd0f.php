...
<?php $__env->startSection('title', 'Career Help - SkillUp Help Center'); ?>
    ...
    <div class="container py-12 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="rounded-3xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
                ...
                <p class="text-slate-600 leading-relaxed">Visit the <a href="<?php echo e(route('help.index')); ?>" class="text-cyan-600 hover:underline">Help Center</a> or <a href="<?php echo e(route('contact')); ?>" class="text-cyan-600 hover:underline">contact support</a> for personalized assistance.</p>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\help\career.blade.php ENDPATH**/ ?>