...
<?php $__env->startSection('title', 'Sign In — SkillUp'); ?>
        ...
        <div class="auth-card-wrap">
            <div class="auth-card" id="authCard">
                ...
                <div class="auth-body">
                    ...
                    <?php if($errors->any() && !$errors->has('email') && !$errors->has('password') && !$errors->has('login_as')): ?>
                        ...
                        <div class="auth-field" data-auth-animate>
                            ...
                            <div class="role-select" id="roleSelect" role="group" aria-label="Account type">
                                ...
                                <button type="button" data-role="admin"
                                    class="auth-role-btn <?php echo e(old('login_as', 'student') === 'admin' ? 'is-active' : ''); ?>"
                                    aria-pressed="<?php echo e(old('login_as', 'student') === 'admin' ? 'true' : 'false'); ?>">
                                    <i class="fas fa-shield-alt"></i>Admin
                                </button>
                                <button type="button" data-role="staff"
                                    class="auth-role-btn <?php echo e(old('login_as', 'student') === 'staff' ? 'is-active' : ''); ?>"
                                    aria-pressed="<?php echo e(old('login_as', 'student') === 'staff' ? 'true' : 'false'); ?>">
                                    <i class="fas fa-user-shield"></i>Staff
                                </button>
                                <button type="button" data-role="teacher"
                                    class="auth-role-btn <?php echo e(old('login_as', 'student') === 'teacher' ? 'is-active' : ''); ?>"
                                    aria-pressed="<?php echo e(old('login_as', 'student') === 'teacher' ? 'true' : 'false'); ?>">
                                    <i class="fas fa-chalkboard-teacher"></i>Instructor
                                </button>
                                <button type="button" data-role="student"
                                    class="auth-role-btn <?php echo e(old('login_as', 'student') === 'student' ? 'is-active' : ''); ?>"
                                    aria-pressed="<?php echo e(old('login_as', 'student') === 'student' ? 'true' : 'false'); ?>">
                                    <i class="fas fa-graduation-cap"></i>Student
                                </button>
                            </div>
                            <input type="hidden" name="login_as" id="login-as" value="<?php echo e(old('login_as', 'student')); ?>">
                            <?php $__errorArgs = ['login_as'];
                        ...
                        <div class="auth-field" data-auth-animate>
                            ...
                            <div class="auth-input-wrap">
                                <input
                                    ...
                                    class="auth-input <?php echo e($errors->has('email') ? 'is-error' : ''); ?>"
                        ...
                        <div class="auth-field" data-auth-animate>
                            ...
                            <div class="auth-input-wrap">
                                <input
                                    ...
                                    id="password"
                                    name="password"
                                    class="auth-input <?php echo e($errors->has('password') ? 'is-error' : ''); ?>"
                                    placeholder="••••••••"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="auth-remember-row" data-auth-animate>
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="auth-forgot" style="margin:0;">Forgot?</a>
                            <?php endif; ?>
                        </div>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="auth-btn-outline" data-auth-animate>
                ...
                <div class="auth-footer-bar">
                    ...
                    <a href="<?php echo e(route('terms')); ?>">Terms</a> and
            ...
            <p style="text-align:center">
                <a href="<?php echo e(url('/')); ?>" class="auth-back">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('auth.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/auth/login.blade.php ENDPATH**/ ?>