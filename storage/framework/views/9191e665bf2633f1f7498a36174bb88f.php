...
<head>
    ...
    <title><?php echo e($sectionMeta['title'] ?? 'Student Report'); ?> - <?php echo e($user->name); ?></title>
    <style>
    ...
    <main class="print-shell">
        <div class="print-toolbar">
            ...
            <div class="print-toolbar-actions">
                <a class="back-button" href="<?php echo e(route('sias.student.reports.' . $currentSection)); ?>">Back</a>
        ...
        <header class="school-heading">
            <div class="school-brand">
                <img class="school-logo" src="<?php echo e(asset('image/logo new.jpg')); ?>" alt="SIAS logo">
                <div>
                <h2>SIAS Student Portal</h2>
                <p>Official student report</p>
                </div>
            </div>
            <div style="text-align:right;color:#4b5563;font-size:.85rem;"><?php echo e(now()->format('F j, Y')); ?></div>
        </header>

        <div class="report-meta">
            <div><span>Student</span><strong><?php echo e($user->name); ?></strong></div>
            <div><span>Student ID</span><strong><?php echo e($user->student_id ?? $user->id); ?></strong></div>
            <div><span>Period</span><strong><?php echo e(session('current_period') ?? '2025-2'); ?></strong></div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\reports\print.blade.php ENDPATH**/ ?>