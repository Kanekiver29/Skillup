    ...
    <div class="ccx-page" role="dialog" aria-modal="true" aria-labelledby="ccxModalTitle">
        ...
        <div class="ccx-scroll-body">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                <div class="ccx-alert ccx-alert--success"><?php echo e(session('success')); ?></div>
            ...
            <div class="ccx-grid">
                <form method="POST" action="<?php echo e(route('staff.courses.store')); ?>" class="ccx-form" id="courseForm" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <section class="ccx-card">
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="title" name="title" class="ccx-input" maxlength="150"
                                   value="<?php echo e(old('title')); ?>" placeholder="e.g. Advanced React Patterns" required data-track data-count>
...
$message = $__bag->first($__errorArgs[0]); ?><span class="ccx-error"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="short_description" name="short_description" class="ccx-input" maxlength="200"
                                   value="<?php echo e(old('short_description')); ?>" placeholder="One line that sells the course" data-track data-count>
                            <div class="ccx-field-foot">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ccx-field">
                            ...
                            <textarea id="description" name="description" class="ccx-textarea"
                                      placeholder="What will students learn? Structure, outcomes, prerequisites..." data-track><?php echo e(old('description')); ?></textarea>
                            <div class="ccx-field-foot">
                    ...
                    <section class="ccx-card">
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="image_url" name="image_url" type="url" class="ccx-input"
                                   value="<?php echo e(old('image_url')); ?>" placeholder="https://..." data-track>
                            <div class="ccx-field-foot">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="category" name="category" class="ccx-input" list="category-suggestions"
                                   value="<?php echo e(old('category')); ?>" placeholder="e.g. Web Development" required data-track>
                        ...
                        <div class="ccx-field">
                            ...
                            <select id="level" name="level" class="ccx-select" data-track>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lvl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($lvl); ?>" <?php if(old('level', 'Beginner') == $lvl): echo 'selected'; endif; ?>><?php echo e($lvl); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <div class="ccx-field-foot">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="duration_hours" name="duration_hours" type="number" step="0.1" min="0" max="1000"
                                   class="ccx-input" value="<?php echo e(old('duration_hours')); ?>" placeholder="e.g. 6.5" data-track>
                            <div class="ccx-field-foot">
                    ...
                    <section class="ccx-card">
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="instructor_name" name="instructor_name" class="ccx-input"
                                   value="<?php echo e(old('instructor_name')); ?>" placeholder="e.g. Dana Alvarez" data-track>
                            <div class="ccx-field-foot">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ccx-field">
                            ...
                            <input id="instructor_title" name="instructor_title" class="ccx-input"
                                   value="<?php echo e(old('instructor_title')); ?>" placeholder="e.g. Senior Frontend Engineer" data-track>
                            <div class="ccx-field-foot">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <section class="ccx-card">
                        ...
                        <div class="ccx-checkrow">
                            <input type="checkbox" name="is_published" value="1" id="published" <?php if(old('is_published')): echo 'checked'; endif; ?>>
                            <div>
...
(function(){
    ...
    var hasServerErrors = <?php echo e($errors->any() ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\courses\create.blade.php ENDPATH**/ ?>