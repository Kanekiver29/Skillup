...
<head>
    ...
    <script>
        (() => {
            const saved = <?php echo json_encode(data_get(auth()->user(), 'settings.appearance', [])) ?>;
...
<body class="bg-light-background text-dark">
    ...
    <?php echo $__env->make('components.navigation.desktop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.navigation.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-10 mb-14">
                ...
                <div data-footer-animate class="footer-delay-1">
                    ...
                    <ul class="space-y-3.5 text-sm text-slate-400">
                        <li><a href="<?php echo e(route('features')); ?>"       class="footer-link">Features</a></li>
                        <li><a href="<?php echo e(route('how-it-works')); ?>"   class="footer-link">How It Works</a></li>
                        <li><a href="<?php echo e(route('courses.index')); ?>" class="footer-link">Courses</a></li>
                        <li><a href="<?php echo e(route('faq')); ?>"            class="footer-link">FAQ</a></li>
                    </ul>
                </div>
                ...
                <div data-footer-animate class="footer-delay-3">
                    ...
                    <ul class="space-y-3.5 text-sm text-slate-400">
                        <li><a href="<?php echo e(route('privacy')); ?>"       class="footer-link">Privacy Policy</a></li>
                        <li><a href="<?php echo e(route('terms')); ?>"         class="footer-link">Terms &amp; Conditions</a></li>
                        <li><a href="<?php echo e(route('cookie-policy')); ?>" class="footer-link">Cookie Policy</a></li>
            ...
            <div data-footer-animate class="mt-12 text-center">
                ...
                <div class="footer-agency-logos mx-auto mt-6">
                    <img src="<?php echo e(asset('image/logo new.jpg')); ?>" alt="APARRI Polytechnic Institute logo" class="footer-agency-logo" loading="lazy" />
                    <img src="<?php echo e(asset('image/hello.png')); ?>" alt="Partner logo" class="footer-agency-logo" loading="lazy" />
                    <img src="<?php echo e(asset('image/bagong-pilipinas-logo-png_seeklogo-534301.png')); ?>" alt="Bagong Pilipinas logo" class="footer-agency-logo" loading="lazy" />
                </div>
    ...
    <div id="knowledgeChatBubble" title="SKILL.UP BOT" role="button" tabindex="0" aria-label="Open SKILL.UP BOT" class="chat-bubble-pulse fixed bottom-6 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-white shadow-[0_22px_50px_-20px_rgba(0,230,255,0.9)] shadow-slate-900/30 cursor-grab ring-4 ring-white transition-transform duration-200 hover:scale-105 hover:bg-blue-700 overflow-visible select-none">
        ...
        <img src="<?php echo e(asset('image/logo_oif_skillup_1_-removebg-preview.png')); ?>" alt="SKILL.UP BOT logo" class="relative h-11 w-11 rounded-full object-cover pointer-events-none" draggable="false" />
...
</html><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\layout\app.blade.php ENDPATH**/ ?>