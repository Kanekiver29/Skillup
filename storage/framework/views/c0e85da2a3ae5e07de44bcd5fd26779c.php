...
<div class="page-card enrollment-page" style="max-width:100%;">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
        <div class="enrollment-login anim-in">
            ...
            <form method="POST" action="<?php echo e(route('sias.student.enrollment')); ?>">
                <?php echo csrf_field(); ?>
                <label>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="btn-white">Back</a>
                </div>
            </form>
        </div>
    <?php else: ?>
        ...
        <div class="enrollment-grid">
            <div class="enrollment-header anim-in">
                <div class="enrollment-summary">
                    ...
                    <span><strong>Course:</strong> <?php echo e($programCourseTitle ?? 'Bachelor of Science in Information Technology'); ?></span>
                    <span>Curriculum: <?php echo e($programCourseCategory ?? 'BSIT Curriculum 2018'); ?>, Year: <?php echo e($yearLevel); ?>, Graduating: No, Finished: No</span>
                </div>
                ...
                <section class="enrollment-card anim-in" style="animation-delay:.05s;">
                    ...
                    <div class="table-scroll">
                        <table class="enrollment-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $preEnlisted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="anim-in row" style="animation-delay:<?php echo e(0.05 + (min($loop->index, 8) * 0.03)); ?>s;">
                                        <td><?php echo e($enrollment->course?->slug ?? $enrollment->course?->id ?? '—'); ?></td>
                                        <td><?php echo e(Str::limit($enrollment->course?->title ?? 'Course name', 40)); ?></td>
                ...
                <section class="enrollment-card validated anim-in" style="animation-delay:.1s;">
                    ...
                    <div class="table-scroll">
                        <table class="enrollment-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $validated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="anim-in row" style="animation-delay:<?php echo e(0.05 + (min($loop->index, 8) * 0.03)); ?>s;">
                                        <td><?php echo e($enrollment->course?->slug ?? $enrollment->course?->id ?? '—'); ?></td>
                                        <td><?php echo e($enrollment->course?->title ?? 'Course title'); ?></td>
                                        <td style="color:var(--accent-ink);"><?php echo e(Str::limit($enrollment->course?->short_description ?? $enrollment->course?->description ?? '—', 60)); ?></td>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\enrollment\index.blade.php ENDPATH**/ ?>