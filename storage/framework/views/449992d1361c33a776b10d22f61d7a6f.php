...
<div class="syl-wrap" style="position:relative; min-height:100vh; padding: 1.5rem 1.5rem 3rem;">
    ...
    <div class="syl-page-header">
        ...
        <a href="<?php echo e(route('staff.subjects.create')); ?>" class="syl-new-btn">
    ...
    <div class="syl-stats">
        ...
        <div class="syl-stat-card">
            ...
            <div>
                <div class="syl-stat-val" style="color:#34D399;"><?php echo e($active); ?></div>
        ...
        <div class="syl-stat-card">
            ...
            <div>
                <div class="syl-stat-val" style="color:#94A3B8;"><?php echo e($inactive); ?></div>
        ...
        <div class="syl-panel-content">
            ...
            <div class="syl-toolbar">
                <div class="syl-toolbar-left">
                    ...
                    <span class="syl-toolbar-title">subjects.index — <?php echo e($total); ?> <?php echo e(Str::plural('record', $total)); ?></span>
                </div>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="syl-row" style="--i:<?php echo e($loop->index); ?>;">
                                <td>
                                    <span style="font-family: monospace; color:#A5B4FC;"><?php echo e($subject->subject_code ?? '—'); ?></span>
                                </td>
                                <td>
                                    <div style="color:#CBD5E1; font-weight:500;"><?php echo e($subject->title); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->description): ?>
                                    <div style="font-size: 0.72rem; color: var(--text-dim); max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e($subject->description); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td>
                                    <span class="syl-date">
                                        <?php echo e($subject->units ?? 0); ?> Units <span class="syl-date-arrow">•</span> <?php echo e($subject->hours ?? 0); ?> Hours
                                    </span>
                                </td>
                                <td>
                                    <span class="syl-course-pill">
                                        <?php echo e($subject->course->title ?? '—'); ?>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; justify-content:center; gap:4px;">
                                        ...
                                        <a href="<?php echo e(route('staff.subjects.edit', $subject)); ?>"
                                        ...
                                        <form action="<?php echo e(route('staff.subjects.destroy', $subject)); ?>"
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\subjects\index.blade.php ENDPATH**/ ?>