...
<div id="skillup-subjects-scope">
    ...
    <div class="container">
        <div class="breadcrumb">
            <a href="<?php echo e(route('courses.index')); ?>">← Back to Courses</a>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subjects && $subjects->count() > 0): ?>
            <div class="book">
                        ...
                        <div class="subject-card">
                            ...
                            <div class="subject-header">
                                ...
                                <div class="subject-info">
                                    ...
                                    <h3><?php echo e($subject->title ?? 'Subject'); ?></h3>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->subject_code): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->teacher): ?>
                                        <p class="subject-teacher">👨‍🏫 <?php echo e($subject->teacher->name); ?></p>
                                    <?php else: ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->subject_type): ?>
                                        <span class="subject-type-tag"><?php echo e($subject->subject_type); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            ...
                            <p class="subject-description">
                                <?php echo e($subject->description ?: ('Master the fundamentals and advanced concepts of ' . ($subject->title ?? 'this subject') . ' with comprehensive lessons and assessments.')); ?>

                            </p>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->units || $subject->hours || $course): ?>
                                <div class="subject-meta">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->units): ?> <span>🎓 <?php echo e($subject->units); ?> Units</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->hours): ?> <span>⏱️ <?php echo e($subject->hours); ?> Hours</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course): ?> <span class="meta-course">🔗 <?php echo e($course->title); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="subject-stats">
                                <div class="stat">
                                    ...
                                    <span class="stat-value" data-count-to="<?php echo e($lessonCount); ?>">0</span>
                                </div>
                                <div class="stat">
                                    <span class="stat-label">Quizzes</span>
                                    <span class="stat-value" data-count-to="<?php echo e($quizCount); ?>">0</span>
                                </div>
                                <div class="stat">
                                    <span class="stat-label">Progress</span>
                                    <span class="stat-value" data-count-to="<?php echo e((int) $progress); ?>" data-suffix="%">0%</span>
                                </div>
                            </div>

                            <div class="primary-action">
                                <a href="<?php echo e($course ? route('courses.show', $course->slug ?? $course->id) : '#'); ?>" class="btn btn-dark">
                                    <i class="fa-solid fa-book-open"></i> Open Course
                                </a>
                            </div>

                            <div class="secondary-actions">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($firstLesson && $firstLesson->slug && $firstLesson->module?->slug && $course?->slug): ?>
                                    <a href="<?php echo e(route('lessons.show', [$course->slug, $firstLesson->module->slug, $firstLesson->slug])); ?>" class="btn btn-outline">
                                        <i class="fa-solid fa-list-ul"></i> Table of Contents
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e($course ? route('courses.show', $course->slug ?? $course->id) : '#'); ?>" class="btn btn-outline">
                                        <i class="fa-solid fa-list-ul"></i> Table of Contents
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($firstQuiz && $firstQuiz->slug && $firstQuiz->module?->slug && $course?->slug): ?>
                                    <a href="<?php echo e(route('quizzes.show', [$course->slug, $firstQuiz->module->slug, $firstQuiz->slug])); ?>" class="btn btn-outline">
                                ...
                                <a href="<?php echo e(url('/exam')); ?>" class="btn btn-outline">
                                    <i class="fa-solid fa-clipboard-check"></i> Exam
                                </a>

                                <a href="<?php echo e(url('/grades')); ?>" class="btn btn-outline">
        ...
        <?php else: ?>
            <div class="book">
                ...
                <div class="no-subjects">
                    ...
                    <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-dark">Browse Courses</a>
                </div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Userpage\course\subject.blade.php ENDPATH**/ ?>