...
<div class="att-page relative min-h-full">
    <div class="att-wrap">
        ...
        <div class="att-header">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDays > 0): ?>
                <div class="att-badges">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($streak >= 2): ?>
                    ...
                    <span
                        class="status-stamp stamp-badge <?php echo e($onTrack ? 'stamp-on-track' : 'stamp-attention'); ?> inline-flex items-center px-3 py-1 text-xs font-semibold font-mono"
                        role="status"
                    >
                        <?php echo e($onTrack ? 'On track' : 'Needs attention'); ?>
        ...
        <div class="ledger-card hero-card hero-reveal">
            <div class="hero-top">
                <p class="font-display hero-figure" style="color: var(--ink);">
                    <?php echo e(number_format($hoursLogged, 1)); ?><small> / <?php echo e(number_format($targetHours, 1)); ?>h</small>
                </p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hoursDelta !== null && $hoursDelta != 0): ?>
                    <p class="text-xs font-mono font-medium" style="color: <?php echo e($hoursDelta > 0 ? 'var(--sage)' : 'var(--mustard)'); ?>;">
                        <?php echo e($hoursDelta > 0 ? '+' : ''); ?><?php echo e($hoursDelta); ?>h vs last week
                    </p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="mt-8 relative" style="height: 34px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDays > 0 || $targetHours > 0): ?>
                    <div class="marker-pin absolute -top-1 -translate-y-full font-mono text-xs font-semibold px-1.5 py-0.5 rounded"
                         style="--pin-left: <?php echo e($pinLeftPct); ?>%; background: var(--ink); color: var(--paper);"
                         role="img" aria-label="<?php echo e($progressPct); ?> percent of target hours completed">
                ...
                <div class="absolute left-0 right-0 top-[15px] h-[3px] rounded-full overflow-hidden" style="background: var(--rule-soft);"
                     role="progressbar" aria-valuenow="<?php echo e($progressPct); ?>" aria-valuemin="0" aria-valuemax="100" aria-label="Progress toward weekly target hours">
                    <div class="track-fill h-full rounded-full" style="--fill-to: <?php echo e($progressPct); ?>%; background: <?php echo e($onTrack ? 'var(--sage)' : 'var(--mustard)'); ?>;"></div>
                </div>
                <div class="absolute left-0 right-0 top-0" style="height: 34px;" aria-hidden="true">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i <= 10; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <span class="tick" style="left: <?php echo e($i * 10); ?>%; top: 10px; bottom: 10px;"></span>
                ...
                <span class="absolute right-0 bottom-0 text-[11px] font-mono" style="color: var(--ink-faint);"><?php echo e(number_format($targetHours, 0)); ?>h</span>
            </div>
            ...
            <div class="stat-row">
                <div class="stat-item">
                    ...
                    <span class="stat-value font-mono"><?php echo e(number_format($hoursRemaining, 1)); ?>h</span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Avg / active day</span>
                    <span class="stat-value font-mono"><?php echo e(number_format($avgPerActiveDay, 1)); ?>h</span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Days active</span>
                    <span class="stat-value font-mono"><?php echo e($activeDays); ?> / <?php echo e($totalDays); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6">
            <div class="week-heading">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDays > 0): ?>
                    <span class="text-xs font-mono" style="color: var(--ink-faint);"><?php echo e($activeDays); ?>/<?php echo e($totalDays); ?> logged</span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalDays > 0): ?>
                <ul class="week-grid" style="--day-count: <?php echo e(min($totalDays, 7)); ?>;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $isActive = $day['state'] === 'active'; ?>
                        <li class="punch-card <?php echo e($isActive ? 'is-active' : ''); ?>" tabindex="0">
                            <span class="text-xs font-medium" style="color: var(--ink-soft);"><?php echo e($day['label']); ?></span>
                            <span class="punch-dot <?php echo e($isActive ? 'filled' : ''); ?>" aria-hidden="true"></span>
                            <span class="text-xs font-mono tabular-nums" style="color: <?php echo e($isActive ? 'var(--ink)' : 'var(--ink-faint)'); ?>;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isActive && isset($day['hours'])): ?>
                                    <?php echo e(number_format($day['hours'], 1)); ?>h
                                <?php else: ?>
                                    &mdash;
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\attendance\index.blade.php ENDPATH**/ ?>