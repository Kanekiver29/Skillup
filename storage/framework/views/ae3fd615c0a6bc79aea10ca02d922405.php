...
<div style="max-width: 960px; margin: 0 auto; padding: 1rem 0 2rem;">
    ...
    <div style="background:#fff; border:1px solid #e5edf9; border-radius:1rem; padding:1.5rem; box-shadow:0 12px 30px rgba(30,64,175,0.06);">
        <form action="<?php echo e(route('staff.quizzes.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:1.25rem;">
                ...
                <div style="grid-column:1 / -1;">
                    ...
                    <textarea id="description" name="description" rows="4" style="width:100%; padding:0.8rem 0.9rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a; resize:vertical;"><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <input id="passing_score" name="passing_score" type="number" min="0" max="100" value="<?php echo e(old('passing_score', 60)); ?>"
                           style="width:100%; padding:0.8rem 0.9rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;" />
                </div>
                ...
                <div>
                    ...
                    <input id="time_limit_minutes" name="time_limit_minutes" type="number" min="0" value="<?php echo e(old('time_limit_minutes', 30)); ?>"
                           style="width:100%; padding:0.8rem 0.9rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;" />
                </div>
            </div>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\quizzes\create.blade.php ENDPATH**/ ?>