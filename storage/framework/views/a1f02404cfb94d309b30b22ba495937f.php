...
<body>
    <div class="print-actions">
        ...
        <a href="<?php echo e(route('teacher.grades.index')); ?>">Back to grades</a>
    </div>
        ...
        <header class="header">
            <div class="brand">
                ...
                <div>
                    ...
                    <p><?php echo e($studentId ? 'Individual student record' : 'Teacher grade records'); ?></p>
                </div>
            </div>
            <div class="printed">Printed: <?php echo e(now()->format('F d, Y h:i A')); ?></div>
        </header>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $summary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <section class="student-section">
                <div class="student-heading">
                    <div>
                        <h2><?php echo e($summary['student']?->name ?? 'Student'); ?></h2>
                        <p><?php echo e($summary['courses']->implode(', ') ?: 'No course listed'); ?></p>
                    </div>
                    <div class="average">Average: <?php echo e($summary['average'] !== null ? number_format($summary['average'], 1) . '%' : '—'); ?></div>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $summary['records']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td><?php echo e($record['course']); ?></td>
                                <td><?php echo e($record['title']); ?></td>
                                <td><?php echo e($record['type']); ?></td>
                                <td class="score"><?php echo e($record['score'] !== null ? number_format($record['score'], 2) . ' / ' . number_format($record['max_score'], 2) : '—'); ?></td>
                                <td class="percent"><?php echo e(number_format($record['percentage'], 1)); ?>%</td>
...
<?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\teacher\grades\print.blade.php ENDPATH**/ ?>