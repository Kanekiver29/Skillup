...
<div class="em-page">
    ...
    <form method="GET" action="<?php echo e(route('staff.enrollments.index')); ?>" class="em-toolbar">
        ...
        <?php if(request()->hasAny(['search','status','course','year_level'])): ?>
    ...
    <div class="em-card">
        ...
        <div class="em-pagination">
            ...
            <div class="em-pagination__pages">
                ...
                <?php if($enrollments->onFirstPage()): ?>
                ...
                <?php $__currentLoopData = $enrollments->getUrlRange(max(1, $enrollments->currentPage()-2), min($enrollments->lastPage(), $enrollments->currentPage()+2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($enrollments->hasMorePages()): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/enrollments/index.blade.php ENDPATH**/ ?>