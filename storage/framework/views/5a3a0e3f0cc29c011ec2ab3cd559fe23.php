        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 relative">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-2">
                <div>
                    ...
                    <p class="text-gray-400 text-sm sm:text-base">Welcome back, <span class="text-cyan-400 font-semibold"><?php echo e(auth()->user()->name); ?></span></p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
            ...
            <div class="admin-stagger bg-gray-800 rounded-lg sm:rounded-xl border border-gray-700 p-4 sm:p-6 hover:border-cyan-600 transition glass-card">
                ...
                <div class="text-2xl sm:text-3xl font-bold text-white live-counter" id="counter-total" data-count-target="<?php echo e((int) $userCount); ?>"><?php echo e($userCount); ?></div>
                <p class="text-xs text-gray-500 mt-2">Active user accounts</p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($newSignupsToday)): ?>
                    <p class="text-xs text-gray-500 mt-1">New today: <span class="font-semibold text-green-400">+<?php echo e($newSignupsToday); ?></span></p>
            ...
            <div class="admin-stagger bg-gray-800 rounded-lg sm:rounded-xl border border-gray-700 p-4 sm:p-6 hover:border-cyan-600 transition glass-card">
                ...
                <div class="text-2xl sm:text-3xl font-bold text-white live-counter" id="counter-courses" data-count-target="<?php echo e((int) $activeCourses); ?>"><?php echo e($activeCourses); ?></div>
            ...
            <div class="admin-stagger bg-gray-800 rounded-lg sm:rounded-xl border border-gray-700 p-4 sm:p-6 hover:border-cyan-600 transition glass-card">
                ...
                <div class="text-2xl sm:text-3xl font-bold text-white live-counter" id="counter-enrolled" data-count-target="<?php echo e((int) $enrollmentCount); ?>"><?php echo e($enrollmentCount); ?></div>
            ...
            <div class="admin-stagger bg-gray-800 rounded-lg sm:rounded-xl border border-gray-700 p-4 sm:p-6 hover:border-cyan-600 transition glass-card">
                ...
                <div class="text-2xl sm:text-3xl font-bold text-white live-counter" id="counter-badges" data-count-target="<?php echo e((int) $badges); ?>"><?php echo e($badges); ?></div>
            ...
            <div class="admin-stagger lg:col-span-2 bg-gray-800 rounded-lg sm:rounded-xl border border-gray-700 overflow-hidden">
                ...
                <div class="divide-y divide-gray-700" id="signup-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="p-3 sm:p-4 hover:bg-gray-700/50 transition-colors" data-search="<?php echo e(strtolower($user->name . ' ' . $user->email)); ?>">
                            <div class="flex items-center space-x-2 sm:space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs sm:text-sm font-medium text-white truncate"><?php echo e($user->name); ?></p>
                                    <p class="text-xs text-gray-400 truncate"><?php echo e($user->email); ?></p>
                                </div>
                                <span class="text-xs text-gray-500 whitespace-nowrap ml-2"><?php echo e($user->created_at->diffForHumans()); ?></span>
                            </div>
                        </div>
...
function dashboardData() {
    return {
        ...
        collegeChart: null,
        chartData: {
            daily: { labels: <?php echo json_encode($dailyLabels ?? [], 15, 512) ?>, data: <?php echo json_encode($dailyData ?? [], 15, 512) ?> },
            weekly: { labels: <?php echo json_encode($weeklyLabels ?? [], 15, 512) ?>, data: <?php echo json_encode($weeklyData ?? [], 15, 512) ?> },
            monthly: { labels: <?php echo json_encode($monthlyLabels ?? [], 15, 512) ?>, data: <?php echo json_encode($monthlyData ?? [], 15, 512) ?> },
            yearly: { labels: <?php echo json_encode($yearlyLabels ?? [], 15, 512) ?>, data: <?php echo json_encode($yearlyData ?? [], 15, 512) ?> }
        },
        periodTexts: {
        ...
        initCollegeChart() {
            ...
            return new Chart(collegeCtx.getContext('2d'), {
                type: 'doughnut',
                data: {
                    labels: <?php echo json_encode($collegeLabels ?? ['Business', 'Sciences', 'Arts', 'Architecture']); ?>,
                    datasets: [{
                        data: <?php echo json_encode($collegeData ?? [120, 150, 90, 110]); ?>,
                        backgroundColor: [
                            'rgba(59, 130, 246, 0.8)',
                            'rgba(168, 85, 247, 0.8)',
                            'rgba(236, 72, 153, 0.8)',
        ...
        fetchLiveData() {
            fetch(<?php echo json_encode(route('admin.dashboard.liveData'), 15, 512) ?>, {
                headers: {
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\dashboard.blade.php ENDPATH**/ ?>