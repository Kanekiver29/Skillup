<?php $__env->startSection('title', 'Assign Teacher'); ?>
...
<div class="tsa-wrap">
    <div class="tsa-container">
        <a href="<?php echo e(route('staff.teacher-subjects.index')); ?>" class="tsa-back-link">
        ...
        <div class="tsa-card">
            <form action="<?php echo e(route('staff.teacher-subjects.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                
                <div class="tsa-form-group">
                    <label class="tsa-label" for="course_id">Class / Course</label>
                    <select name="course_id" id="course_id" class="tsa-select <?php $__errorArgs = ['course_id'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="tsa-error-msg"><?php echo e($message); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="tsa-form-group">
                    ...
                    <select name="subject_id" id="subject_id" class="tsa-select <?php $__errorArgs = ['subject_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $subjects->groupBy('course_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courseId => $courseSubjects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php
                                $course = $courses->firstWhere('id', $courseId);
                                $courseName = $course ? $course->title : 'Other Subjects';
                            ?>
                            <optgroup data-course-id="<?php echo e($courseId); ?>" label="<?php echo e($courseName); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $courseSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($subject->id); ?>" data-course-id="<?php echo e($courseId); ?>" <?php echo e(old('subject_id') == $subject->id ? 'selected' : ''); ?>>
                                        <?php echo e($subject->subject_code); ?> — <?php echo e($subject->title); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="tsa-form-group">
                    ...
                    <select name="teacher_id" id="teacher_id" class="tsa-select <?php $__errorArgs = ['teacher_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="tsa-actions">
                    <a href="<?php echo e(route('staff.teacher-subjects.index')); ?>" class="tsa-btn tsa-btn-cancel">Cancel</a>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (courseSelect && subjectSelect) {
      const filterSubjects = () => {
        ...
        if (!selectedCourse) {
          subjectSelect.value = '<?php echo e(old('subject_id') ?: ''); ?>';
          return;
        }
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\teacher and course\add.blade.php ENDPATH**/ ?>