...
<?php
    ...
    $gwa = isset($gwaIgnore) ? $gwaIgnore : $computedGwa;
?>

<div class="rs">
    <div class="rs-inner-header rs-anim" style="animation-delay:.05s;">
        <div>
            <h2>General Weighted Average <span style="font-size:.8em;font-weight:600;color:var(--muted);">(Ignore)</span></h2>
            <p>Raw weighted average — curriculum matching is ignored.</p>
        </div>
...
<?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\reports\sections\gwa-ignore.blade.php ENDPATH**/ ?>