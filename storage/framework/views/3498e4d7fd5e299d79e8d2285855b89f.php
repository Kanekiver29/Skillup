...
<div class="md-page">
    <header class="md-header">
        ...
        <div class="md-header-actions">
            <form method="GET" action="<?php echo e(route('staff.modules.index')); ?>" class="md-filter-form">
            ...
            <a href="<?php echo e(route('staff.modules.create', request('course_id') ? ['course_id' => request('course_id')] : [])); ?>" class="md-btn-new">
        ...
        <table class="md-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="md-row" style="animation-delay: <?php echo e(80 + ($loop->index * 40)); ?>ms;">
                        <td class="md-td-order"><?php echo e($module->order); ?></td>
                        <td>
                            <div class="md-module-title"><?php echo e($module->title); ?></div>
                            <?php if($module->description): ?>
                                <div class="md-module-desc"><?php echo e($module->description); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="md-td-course"><?php echo e($module->course->title ?? 'N/A'); ?></td>
                        <td>
                            <span class="md-badge-quiz">
                                <?php echo e($module->quizzes_count); ?> <?php echo e(\Illuminate\Support\Str::plural('quiz', $module->quizzes_count)); ?>

                            </span>
                        </td>
                        <td class="md-td-actions">
                            <a href="<?php echo e(route('staff.modules.edit', $module)); ?>" class="md-link-edit">Edit</a>
                            <form action="<?php echo e(route('staff.modules.destroy', $module)); ?>" method="POST" class="md-inline-form" onsubmit="return confirm('Archive module <?php echo e(addslashes($module->title)); ?>?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/modules/index.blade.php ENDPATH**/ ?>