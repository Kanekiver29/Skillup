...
<div class="tsa-wrap">
        ...
        <div class="tsa-card-info">
            <div class="tsa-subject-head">
                <div>
                    <h2 class="tsa-subject-title">
                        <span class="tsa-subject-code"><?php echo e($subject->subject_code); ?></span>
            ...
            <div class="tsa-subject-meta">
                <div class="tsa-meta-item">
                    ...
                    <?php echo e($subject->units); ?> Units
                </div>
                <div class="tsa-meta-item">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <?php echo e($subject->hours); ?> Hours
                </div>
            </div>
            ...
            <div class="tsa-current-teacher">
                ...
                <div class="tsa-current-teacher-info">
                    <span class="tsa-current-teacher-name">Currently assigned: <?php echo e($subject->teacher->name); ?></span>
                    <span class="tsa-current-teacher-email"><?php echo e($subject->teacher->email); ?></span>
                </div>
            </div>
            <?php else: ?>
            <div class="tsa-current-teacher">
    ...
    <div class="tsa-card tsa-form-card">
        <form action="<?php echo e(route('staff.teacher-subjects.update', $subject)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="tsa-form-actions">
                ...
                <a href="<?php echo e(route('staff.teacher-subjects.index')); ?>" class="tsa-btn tsa-btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
    ...
    <div class="tsa-card tsa-danger-card">
        ...
        <form action="<?php echo e(route('staff.teacher-subjects.destroy', $subject)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to unassign this teacher?');">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\teacher and course\edit.blade.php ENDPATH**/ ?>