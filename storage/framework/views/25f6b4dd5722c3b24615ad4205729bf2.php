...
<div class="ss-wrap">
    ...
    <div class="ss-card">
        ...
        <div class="ss-tabs" role="tablist" id="ss-tablist">
            ...
            ?>
            <?php $__currentLoopData = $ssTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                ...
                <div class="ss-sub-card">
                    <div class="ss-info-grid">
                        ...
                        <div class="ss-info-item">
                            ...
                            <div class="ss-info-item__value">
                                <?php if($settings['app_debug'] ?? config('app.debug')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/settings/index.blade.php ENDPATH**/ ?>