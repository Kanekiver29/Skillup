...
<?php $__env->startSection('title', 'My Learning Roadmap - SkillUp'); ?>
...
<div class="min-h-screen bg-slate-50/80">
    ...
    <section class="roadmap-hero pt-28 pb-12 px-4 text-white relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            <a href="<?php echo e(route('userpage.dashboard')); ?>" data-animate class="inline-flex items-center gap-2 text-slate-300 hover:text-white text-sm mb-6 transition-colors">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->count() > 0): ?>
                    <div class="text-left lg:text-right">
                        ...
                        <p class="text-4xl font-bold text-sky-200">
                            <span id="roadmap-progress-counter" data-target="<?php echo e($averageProgress); ?>">0</span>%
                        </p>
                        <p class="text-xs text-slate-400 mt-1"><?php echo e($totalCompleted); ?> of <?php echo e($totalEnrolled); ?> courses completed</p>
                    </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->count() > 0): ?>
                <div data-animate class="delay-150 mt-8">
                    <div class="flex justify-between text-xs text-slate-400 mb-2">
                        ...
                        <span id="roadmap-progress-label"><?php echo e($averageProgress); ?>%</span>
                    </div>
                    <div class="h-3 bg-white/10 rounded-full overflow-hidden border border-white/10">
                        <div id="roadmap-main-progress" class="roadmap-progress-bar h-full rounded-fullbg-gradient-to-r from-sky-400 to-blue-300" style="width: 0" data-width="<?php echo e($averageProgress); ?>"></div>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <div class="max-w-6xl mx-auto px-4 py-10 -mt-4 relative z-20">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->count() > 0): ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <div data-animate class="delay-100 roadmap-hover-lift bg-white rounded-2xl shadow-md border border-gray-100 p-5 text-center">
                    ...
                    <p class="text-3xl font-bold text-green-600" data-counter data-target="<?php echo e($totalCompleted); ?>">0</p>
                ...
                <div data-animate class="delay-150 roadmap-hover-lift bg-white rounded-2xl shadow-md border border-gray-100 p-5 text-center">
                    ...
                    <p class="text-3xl font-bold text-orange-600" data-counter data-target="<?php echo e($inProgressCourses->count()); ?>">0</p>
                ...
                <div data-animate class="delay-200 roadmap-hover-lift bg-white rounded-2xl shadow-md border border-gray-100 p-5 text-center">
                    ...
                    <p class="text-3xl font-bold text-[#003a8f]" data-counter data-target="<?php echo e($totalEnrolled); ?>">0</p>
                    <p class="text-sm text-gray-500 mt-1">Total Enrolled</p>
                </div>
            </div>

            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextEnrollment): ?>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <h2 class="text-lg font-bold text-gray-800 mt-0.5"><?php echo e($nextEnrollment->course->course_title); ?></h2>
                                <p class="text-sm text-gray-500 mt-1"><?php echo e($nextEnrollment->progress); ?>% complete</p>
                            </div>
                        </div>
                        <a href="<?php echo e(route('courses.show', $nextEnrollment->course->slug)); ?>" class="inline-flex items-center justify-center gap-2 bg-[#003a8f] text-white font-semibold px-6 py-3 rounded-xl hover:bg-[#0a2540] transition shadow-md shrink-0">
                            Resume Course <i class="fas fa-arrow-right text-sm"></i>
                        </a>
                    </div>
                    <div class="mt-4 h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div class="roadmap-progress-bar h-full rounded-fullbg-gradient-to-r from-[#003a8f] to-sky-500" style="width: 0" data-width="<?php echo e($nextEnrollment->progress); ?>"></div>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden h-full flex flex-col">
                        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3 bg-green-50/50">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($completedCourses->count()); ?> courses</p>
                            </div>
                        </div>
                        <div class="roadmap-column-card p-4 space-y-3 flex-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $completedCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="roadmap-course-card p-3 bg-green-50 border border-green-100 rounded-xl roadmap-hover-lift" data-search="<?php echo e(strtolower($enrollment->course->course_title)); ?>">
                                    <div class="flex items-start gap-3">
                                        <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center shrink-0">
                                            <i class="fas fa-check text-white text-xs"></i>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <h3 class="font-semibold text-gray-800 text-sm truncate"><?php echo e($enrollment->course->course_title); ?></h3>
                                            <p class="text-xs text-gray-500 mt-1">
                                                <i class="fas fa-calendar-alt mr-1"></i>
                                                <?php echo e($enrollment->completed_at ? $enrollment->completed_at->format('M d, Y') : 'Completed'); ?>

                                            </p>
                                            <a href="<?php echo e(route('certificates.show', $enrollment->course->slug)); ?>" class="text-xs text-green-700 font-semibold hover:underline mt-2 inline-flex items-center gap-1">
                    ...
                    <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden h-full flex flex-col">
                        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3 bg-orange-50/50">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($inProgressCourses->count()); ?> courses</p>
                            </div>
                        </div>
                        <div class="roadmap-column-card p-4 space-y-3 flex-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $inProgressCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="roadmap-course-card p-3 bg-orange-50 border border-orange-100 rounded-xl roadmap-hover-lift" data-search="<?php echo e(strtolower($enrollment->course->course_title)); ?>">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                                                    <div class="roadmap-progress-bar h-full rounded-full bg-orange-500" style="width: 0" data-width="<?php echo e($enrollment->progress); ?>"></div>
                                                </div>
                                            </div>
                                            <a href="<?php echo e(route('courses.show', $enrollment->course->slug)); ?>" class="text-xs text-orange-700 font-semibold hover:underline mt-2 inline-flex items-center gap-1">
                    ...
                    <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden h-full flex flex-col">
                        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3 bg-slate-50">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($notStartedCourses->count()); ?> courses</p>
                            </div>
                        </div>
                        <div class="roadmap-column-card p-4 space-y-3 flex-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $notStartedCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="roadmap-course-card p-3 bg-slate-50 border border-slate-200 rounded-xl roadmap-hover-lift" data-search="<?php echo e(strtolower($enrollment->course->course_title)); ?>">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h3 class="font-semibold text-gray-800 text-sm truncate"><?php echo e($enrollment->course->course_title); ?></h3>
                                            <p class="text-xs text-gray-500 mt-1"><?php echo e($enrollment->course->modules_count ?? 0); ?> modules</p>
                                            <a href="<?php echo e(route('courses.show', $enrollment->course->slug)); ?>" class="text-xs text-[#003a8f] font-semibold hover:underline mt-2 inline-flex items-center gap-1">
                ...
                <div class="relative pl-2 md:pl-4">
                    ...
                    <div id="roadmap-timeline" class="space-y-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            ?>
                            <div class="roadmap-timeline-item relative pl-12 md:pl-14" data-status="<?php echo e($status); ?>" data-search="<?php echo e(strtolower($enrollment->course->course_title)); ?>">
                                <div class="absolute left-0 top-1 w-8 h-8 md:w-9 md:h-9 rounded-full flex items-center justify-center shadow-md z-10
                                    <?php echo e($status === 'completed' ? 'bg-green-500' : ($status === 'in-progress' ? 'bg-orange-500' : 'bg-slate-300')); ?>">
                                ...
                                <a href="<?php echo e(route('courses.show', $enrollment->course->slug)); ?>" class="block roadmap-hover-lift">
                                    <div class="bg-slate-50 rounded-xl p-4 md:p-5 border border-gray-100 hover:border-blue-200">
                                        <div class="flex flex-wrap items-start justify-between gap-3">
                                            <div>
                                                <h3 class="font-bold text-gray-800"><?php echo e($enrollment->course->course_title); ?></h3>
                                                <p class="text-sm text-gray-500 mt-0.5"><?php echo e($enrollment->course->category ?? 'Uncategorized'); ?></p>
                                                <p class="text-xs text-gray-400 mt-1">Enrolled <?php echo e($enrollment->created_at->format('M d, Y')); ?></p>
                                            </div>
                                            <span class="px-3 py-1 rounded-full text-xs font-bold
                                                <?php echo e($status === 'completed' ? 'bg-green-100 text-green-700' : ($status === 'in-progress' ? 'bg-orange-100 text-orange-700' : 'bg-slate-100 text-slate-600')); ?>">
                                                <?php echo e($status === 'completed' ? 'Completed' : ($status === 'in-progress' ? $enrollment->progress . '%' : 'Not Started')); ?>

                                            </span>
                                        </div>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'in-progress'): ?>
                                            <div class="mt-4 h-2 bg-gray-200 rounded-full overflow-hidden">
                                                <div class="roadmap-progress-bar h-full rounded-fullbg-gradient-to-r from-[#003a8f] to-sky-500" style="width: 0" data-width="<?php echo e($enrollment->progress); ?>"></div>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                        <div class="mt-3 flex flex-wrap gap-4 text-xs text-gray-500">
                                            <span><i class="fas fa-layer-group mr-1"></i><?php echo e($enrollment->course->modules_count ?? 0); ?> modules</span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollment->course->duration_hours ?? null): ?>
                                                <span><i class="fas fa-clock mr-1"></i><?php echo e($enrollment->course->duration_hours); ?> hours</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollment->course->level ?? null): ?>
                                                <span><i class="fas fa-signal mr-1"></i><?php echo e($enrollment->course->level); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                </a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($userSkills) > 0): ?>
                <div data-animate class="delay-200 bg-white rounded-2xl shadow-md border border-gray-100 p-6 md:p-8 mb-10">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $userSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <span class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-rfrom-slate-100 to-blue-50 border border-blue-100 rounded-full text-sm font-medium text-gray-700 roadmap-hover-lift">
                                <i class="fas fa-star text-amber-400 text-xs"></i><?php echo e($skill); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($coursesByCategory && $coursesByCategory->count() > 0): ?>
                <div data-animate class="delay-250 bg-white rounded-2xl shadow-md border border-gray-100 p-6 md:p-8 mb-10">
                    <h2 class="text-xl font-bold text-gray-800 mb-4">Explore More Courses</h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $coursesByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $courses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('courses.index')); ?>?category=<?php echo e(urlencode($category)); ?>" class="roadmap-hover-lift block border border-gray-100 rounded-xl p-4 hover:border-blue-200">
                                <div class="flex items-center gap-3">
                                    <div class="w-11 h-11 rounded-xl gradient-primary flex items-center justify-center shrink-0">
                                        <i class="fas fa-folder text-white"></i>
                                    </div>
                                    <div>
                                        <h3 class="font-semibold text-gray-800"><?php echo e($category ?: 'General'); ?></h3>
                                        <p class="text-xs text-gray-500"><?php echo e($courses->count()); ?> courses</p>
                                    </div>
                                </div>
        ...
        <?php else: ?>
            ...
            <div data-animate class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 md:p-16 text-center max-w-2xl mx-auto">
                ...
                <a href="<?php echo e(route('courses.index')); ?>" class="inline-flex items-center gap-2 gradient-primary text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:opacity-95 transition">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 pb-12">
            <a href="<?php echo e(route('courses.index')); ?>" data-animate class="delay-100 roadmap-hover-lift bg-white rounded-2xl shadow-md border border-gray-100 p-5 flex items-center gap-4">
            ...
            <a href="<?php echo e(route('courses.my-learning')); ?>" data-animate class="delay-150 roadmap-hover-lift bg-white rounded-2xl shadow-md border border-gray-100 p-5 flex items-center gap-4">
            ...
            <a href="<?php echo e(route('userpage.profile-edit')); ?>" data-animate class="delay-200 roadmap-hover-lift bg-white rounded-2xl shadow-md border border-gray-100 p-5 flex items-center gap-4">
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Userpage\roadmap.blade.php ENDPATH**/ ?>