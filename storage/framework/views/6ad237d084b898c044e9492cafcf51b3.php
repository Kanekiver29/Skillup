...
<?php $__env->startSection('page_title', 'Create Schedule'); ?>
<?php $__env->startSection('subtitle', 'Assign a training session to a section and teacher'); ?>

<?php $__env->startSection('content'); ?>
<div class="admin-card" style="max-width:760px;margin:0 auto;">
    <form method="POST" action="<?php echo e(route('admin.schedules.store')); ?>" style="display:grid;gap:1.25rem;">
        <?php echo csrf_field(); ?>
            ...
            <label style="display:grid;gap:.45rem;font-weight:600;color:var(--text);">
                ...
                <select name="teacher_id" required style="width:100%;padding:12px 14px;border:1px solid var(--card-border);border-radius:10px;background:var(--card-bg);color:var(--text);font:inherit;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('teacher_id') == $teacher->id ? 'selected' : ''); ?>><?php echo e($teacher->name); ?></option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
            <label style="display:grid;gap:.45rem;font-weight:600;color:var(--text);">
                Building
                <input type="text" name="building" value="<?php echo e(old('building')); ?>" style="width:100%;padding:12px 14px;border:1px solid var(--card-border);border-radius:10px;background:var(--card-bg);color:var(--text);font:inherit;">
            </label>

            <label style="display:grid;gap:.45rem;font-weight:600;color:var(--text);">
                Room
                <input type="text" name="room_number" value="<?php echo e(old('room_number')); ?>" style="width:100%;padding:12px 14px;border:1px solid var(--card-border);border-radius:10px;background:var(--card-bg);color:var(--text);font:inherit;">
            </label>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
            <label style="display:grid;gap:.45rem;font-weight:600;color:var(--text);">
                Trainee count
                <input type="number" name="student_count" min="0" value="<?php echo e(old('student_count', 0)); ?>" style="width:100%;padding:12px 14px;border:1px solid var(--card-border);border-radius:10px;background:var(--card-bg);color:var(--text);font:inherit;">
            </label>
        ...
        <label style="display:grid;gap:.45rem;font-weight:600;color:var(--text);">
            Notes
            <textarea name="notes" rows="3" style="width:100%;padding:12px 14px;border:1px solid var(--card-border);border-radius:10px;background:var(--card-bg);color:var(--text);font:inherit;resize:vertical;"><?php echo e(old('notes')); ?></textarea>
        </label>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\schedules\create.blade.php ENDPATH**/ ?>