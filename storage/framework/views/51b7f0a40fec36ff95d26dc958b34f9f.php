        ...
        <div class="quiz-content-wrapper">
            ...
            <div class="quiz-page-header">
                <div class="quiz-header-content">
                    ...
                    <div class="quiz-header-buttons">
                        <a href="<?php echo e(route('staff.quizzes.questionnaire', $quiz)); ?>" class="quiz-btn btn-primary" title="Edit quiz questions and answers">
                            <i class="fas fa-list-check" aria-hidden="true"></i>
                            <span>Questions</span>
                        </a>
                        <a href="<?php echo e(route('staff.quizzes.list')); ?>" class="quiz-btn btn-secondary" title="Return to quiz list">
                        ...
                        <div class="flex-1">
                            ...
                            <ul class="quiz-alert-list">
                                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><span class="inline-block mr-2">→</span><?php echo e($error); ?></li>
            ...
            <div class="quiz-form-card">
                <div class="quiz-form-content">
                    <form method="POST" action="<?php echo e(route('staff.quizzes.update', $quiz)); ?>" novalidate id="quiz-edit-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="quiz-field-group">
                            <div class="quiz-field">
                                ...
                                <select name="course_id" required class="quiz-select <?php echo e($errors->has('course_id') ? 'has-error' : ''); ?>" aria-label="Select course">
                                    <option value="">Select a course...</option>
                                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($course->id); ?>" <?php echo e(old('course_id', optional($quiz->module)->course_id) == $course->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="quiz-field">
                                ...
                                <select name="module_id" required class="quiz-select <?php echo e($errors->has('module_id') ? 'has-error' : ''); ?>" aria-label="Select module">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="quiz-field">
                            ...
                            <input type="text" name="title" value="<?php echo e(old('title', $quiz->title)); ?>" required class="quiz-input <?php echo e($errors->has('title') ? 'has-error' : ''); ?>" placeholder="e.g. Advanced Module Assessment" aria-label="Quiz title">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="quiz-field">
                            ...
                            <textarea name="description" class="quiz-textarea <?php echo e($errors->has('description') ? 'has-error' : ''); ?>" placeholder="Provide clear instructions and context for learners..." aria-label="Quiz description"><?php echo e(old('description', $quiz->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="quiz-field-group">
                            <div class="quiz-field">
                                ...
                                <div class="relative">
                                    <input type="number" name="passing_score" value="<?php echo e(old('passing_score', $quiz->passing_score)); ?>" min="0" max="100" required class="quiz-input <?php echo e($errors->has('passing_score') ? 'has-error' : ''); ?>" placeholder="70" aria-label="Passing score percentage">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="quiz-field">
                                ...
                                <div class="relative">
                                    <input type="number" name="time_limit_minutes" value="<?php echo e(old('time_limit_minutes', $quiz->time_limit_minutes)); ?>" min="0" class="quiz-input <?php echo e($errors->has('time_limit_minutes') ? 'has-error' : ''); ?>" placeholder="Leave empty for no limit" aria-label="Time limit in minutes">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="quiz-actions">
                            ...
                            <a href="<?php echo e(route('staff.quizzes.list')); ?>" class="quiz-btn btn-secondary">
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/quizzes/edit.blade.php ENDPATH**/ ?>