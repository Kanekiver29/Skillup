...
<?php $__env->startSection('title', 'Video Resources'); ?>
...
<div class="vr-page">
    ...
    <div class="vr-card vr-form-card">
        ...
        <form action="<?php echo e(route('staff.videos.store')); ?>" method="POST" enctype="multipart/form-data" id="video_form" class="vr-form-grid">
            <?php echo csrf_field(); ?>
        ...
        <table class="vr-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="vr-row" style="animation-delay: <?php echo e(150 + ($loop->index * 40)); ?>ms;">
                        <td class="vr-td-module"><?php echo e($module->course->title ?? 'Course'); ?> · <?php echo e($module->title); ?></td>
                        <td>
                            <?php if($module->video_url): ?>
                                <a href="<?php echo e($module->video_url); ?>" target="_blank" rel="noopener" class="vr-badge-link">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        ...
                        <td class="vr-td-actions">
                            <a href="<?php echo e(route('staff.videos.edit', $module)); ?>" class="vr-link-edit">Edit</a>
                            <form action="<?php echo e(route('staff.videos.destroy', $module)); ?>" method="POST" onsubmit="return confirm('Remove this video resource?');" class="vr-inline-form">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/videos/list.blade.php ENDPATH**/ ?>