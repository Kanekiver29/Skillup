...
<div class="assessment-page">
    <div class="assessment-header">
        ...
        <a href="<?php echo e(route('staff.quizzes.create')); ?>" class="assessment-action">
    ...
    <div class="assessment-stats">
        <div class="assessment-stat">
            ...
            <div class="assessment-stat-value"><?php echo e($totalCount); ?></div>
        </div>
        <div class="assessment-stat">
            <div class="assessment-stat-label">Scheduled</div>
            <div class="assessment-stat-value"><?php echo e($scheduledCount); ?></div>
        </div>
        <div class="assessment-stat">
            <div class="assessment-stat-label">Published</div>
            <div class="assessment-stat-value"><?php echo e($publishedCount); ?></div>
        </div>
        <div class="assessment-stat">
            <div class="assessment-stat-label">Draft</div>
            <div class="assessment-stat-value"><?php echo e($draftCount); ?></div>
        </div>
    </div>
    ...
    <section class="assessment-panel" aria-labelledby="assessment-panel-heading">
        <div class="assessment-panel-head">
            ...
            <div class="assessment-panel-note"><?php echo e($totalCount); ?> total</div>
        </div>
                ...
                <table class="assessment-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td>
                                    <span class="assessment-name" title="<?php echo e($quiz->title); ?>"><?php echo e($quiz->title); ?></span>
                                </td>
                                <td class="assessment-muted">
                                    <?php echo e($quiz->module?->course?->title ?? $quiz->subject?->title ?? 'Unassigned'); ?>

                                </td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quiz->scheduled_at): ?>
                                        <?php echo e($quiz->scheduled_at->format('M j, Y g:i A')); ?>

                                    <?php else: ?>
                                        <span class="assessment-unscheduled">Not scheduled</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td><?php echo e($quiz->passing_score !== null ? $quiz->passing_score . '%' : '—'); ?></td>
                                <td>
                                    <span class="assessment-badge <?php echo e($quiz->is_published ? 'assessment-badge--published' : 'assessment-badge--draft'); ?>">
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\quizzes\schedule.blade.php ENDPATH**/ ?>