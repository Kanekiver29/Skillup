...
<div class="container mx-auto max-w-2xl px-6 py-8">
    ...
    <div class="bg-white rounded-lg shadow p-8">
        <form method="POST" action="<?php echo e(route('admin.majors.store')); ?>" novalidate>
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input 
                            ...
                            name="color" 
                            type="color" 
                            value="<?php echo e(old('color', '#3B82F6')); ?>" 
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\majors\create.blade.php ENDPATH**/ ?>