...
<?php $__env->startSection('title', 'Assessment Results'); ?>
    ...
    <div class="container">
        ...
        <div class="overview-panel reveal mb-8 rounded-[1.75rem] border border-slate-200 bg-white/90 p-6 shadow-[0_20px_45px_-25px_rgba(15,23,42,0.45)] backdrop-blur-sm" style="--reveal-delay: 0ms;">
            ...
            <div class="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
                <div class="stat-card reveal border border-slate-200 bg-slate-50/60 p-4 shadow-sm" style="--reveal-delay: 120ms;">
                    ...
                    <div class="text-3xl font-bold text-slate-900 stat-number" data-count="<?php echo e($attempts); ?>">0</div>
                ...
                <div class="stat-card reveal border border-emerald-200 bg-emerald-50/70 p-4 shadow-sm" style="--reveal-delay: 180ms;">
                    ...
                    <div class="text-3xl font-bold text-emerald-700 stat-number" data-count="<?php echo e($passedCount); ?>">0</div>
                ...
                <div class="stat-card reveal border border-violet-200 bg-violet-50/70 p-4 shadow-sm" style="--reveal-delay: 240ms;">
                    ...
                    <div class="text-3xl font-bold text-violet-700">
                        <span class="stat-number" data-count="<?php echo e($averageScore); ?>" data-decimals="1">0</span>%
                    </div>
        ...
        <div class="results-card reveal overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_18px_45px_-25px_rgba(15,23,42,0.45)]" style="--reveal-delay: 260ms;">
            ...
            <?php else: ?>
                        ...
                        <tbody id="resultsBody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <tr
                                    ...
                                    style="animation-delay: <?php echo e($loop->index * 60); ?>ms;"
                                    data-search="<?php echo e(Str::lower($traineeName . ' ' . $traineeEmail . ' ' . $assessmentTitle)); ?>"
                                >
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            <div class="avatar-badge flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 text-sm font-semibold text-white shadow-sm transition-transform duration-300">
                                                <?php echo e(Str::upper(Str::substr($traineeName, 0, 1))); ?>

                                            </div>
                                            <div>
                                                <div class="font-semibold text-slate-800"><?php echo e($traineeName); ?></div>
                                                <div class="text-xs text-slate-500"><?php echo e($traineeEmail); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <div class="font-medium text-slate-700"><?php echo e($assessmentTitle); ?></div>
                                    </td>
                                    <td class="p-4">
                                        <div class="flex flex-col gap-1.5">
                                            <div class="inline-flex w-fit items-center gap-2 rounded-full bg-slate-100 px-2.5 py-1.5 font-semibold text-slate-700">
                                                <span class="h-2 w-2 rounded-full bg-<?php echo e($scoreColor); ?>-500"></span>
                                                <?php echo e(number_format($scorePct, 1)); ?>%
                                            </div>
                                            <div class="score-track h-1.5 w-24 overflow-hidden rounded-full bg-slate-100">
                                                <div class="score-fill h-full rounded-full bg-<?php echo e($scoreColor); ?>-500" data-width="<?php echo e(min(100, max(0, $scorePct))); ?>" style="width: 0%;"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <span class="status-pill inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold <?php echo e($result->passed ? 'bg-emerald-100 text-emerald-700 ring-1 ring-inset ring-emerald-200' : 'bg-rose-100 text-rose-700 ring-1 ring-inset ring-rose-200'); ?>">
                                            <span class="h-1.5 w-1.5 rounded-full <?php echo e($result->passed ? 'bg-emerald-500 status-dot-pass' : 'bg-rose-500'); ?>"></span>
                                            <?php echo e($result->passed ? 'Passed' : 'Not passed'); ?>
                                    ...
                                    <td class="p-4 text-slate-600">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <div><?php echo e($result->completed_at?->format('M j, Y g:i A') ?? 'In progress'); ?></div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result->completed_at): ?>
                                                    <div class="text-xs text-slate-400"><?php echo e($result->completed_at->diffForHumans()); ?></div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(method_exists($results, 'links')): ?>
                    <div class="border-t border-slate-200 bg-slate-50/60 p-4">
                        <div class="flex items-center justify-between gap-3 text-sm text-slate-500">
                            <span>Showing <?php echo e($results->count()); ?> of <?php echo e($results->total()); ?> attempts</span>
                            <div class="rounded-full border border-slate-200 bg-white px-3 py-1.5 shadow-sm">
                                <?php echo e($passRate); ?>% pass rate
                            </div>
                        </div>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\quizzes\results.blade.php ENDPATH**/ ?>