...
<div class="page-card" style="padding:1.5rem;">
    ...
    <form method="POST" action="<?php echo e(route('sias.student.profile.personal_information.update')); ?>" class="section-card" style="display:grid;gap:1.5rem;max-width:860px;">
        <?php echo csrf_field(); ?>
            ...
            <div style="padding:1.5rem;display:grid;gap:1rem;animation:slideDown .3s var(--ease) forwards;">
                <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem;">
                    <label style="display:grid;gap:.35rem;">
                        First Name
                        <input name="first_name" class="form-input" placeholder="e.g. Juan" value="<?php echo e(auth()->user()->first_name ?? ''); ?>">
                    </label>
                    <label style="display:grid;gap:.35rem;">
                        Last Name
                        <input name="last_name" class="form-input" placeholder="e.g. Dela Cruz" value="<?php echo e(auth()->user()->last_name ?? ''); ?>">
                    </label>
                </div>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\profile\personal_information.blade.php ENDPATH**/ ?>