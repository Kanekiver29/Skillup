    ...
    >
        ...
        <div class="max-w-6xl mx-auto profile-hero-inner">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
                ...
                ?>
                <?php $__currentLoopData = $heroStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                ...
                <section data-page-animate class="page-delay-2 profile-section-card p-6 md:p-8">
                    ...
                    <?php if($completedCertificates->count()): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $completedCertificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <section data-page-animate class="page-delay-3 profile-section-card p-6 md:p-8">
                    ...
                    <?php if($earnedBadges->count()): ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <?php $__currentLoopData = $earnedBadges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userBadge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-6">
                <section data-page-animate class="page-delay-2 profile-section-card p-6">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <?php $__currentLoopData = ['🏃' => 'Quick Learner', '👣' => 'First Steps', '💻' => 'Code Master', '🤝' => 'Team Player', '🔥' => '30-Day Streak', '⭐' => 'Rising Star']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <section data-page-animate class="page-delay-3 profile-tint-indigo rounded-2xl p-6">
                    ...
                    <a href="<?php echo e(route('mentors')); ?>" class="profile-btn-primary w-full inline-flex items-center justify-center py-2.5 rounded-xl text-sm min-h-0">
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/Userpage/profile.blade.php ENDPATH**/ ?>