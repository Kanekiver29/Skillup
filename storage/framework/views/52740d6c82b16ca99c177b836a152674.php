...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Teacher Portal'); ?> | SkillUp</title>
    ...
    <aside class="sidebar" id="sidebar" aria-label="Teacher navigation">
        ...
        <div class="brand">
            <div class="brand-logo-wrap">
                <img
                    src="<?php echo e(asset('image/logo oif skillup(1).png')); ?>"
                    alt="SkillUp Logo"
                    class="brand-logo"
                >
            </div>
        ...
        <nav class="nav-links">
            ...
            <a class="nav-link <?php echo e(request()->routeIs('teacher.courses*') ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.courses.index')); ?>">
                <span class="nav-icon">▣</span> Courses
            </a>
            <a class="nav-link <?php echo e(request()->routeIs('teacher.modules*') ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.modules.index')); ?>">
                <span class="nav-icon">◫</span> Modules
            </a>

            <div class="nav-section-label">Content</div>

            <a class="nav-link <?php echo e(request()->routeIs('teacher.quizzes.create') ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.quizzes.create')); ?>">
                <span class="nav-icon">✚</span> Add Quiz
            </a>
            <a class="nav-link <?php echo e(request()->is('teacher/modules/upload-resource*') && request()->query('type') == 'word' ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.modules.upload-resource')); ?>?type=word">
                <span class="nav-icon">✎</span> Add Word
            </a>
            <a class="nav-link <?php echo e(request()->is('teacher/modules/upload-resource*') && request()->query('type') == 'video' ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.modules.upload-resource')); ?>?type=video">
                <span class="nav-icon">▶</span> Add Video
            </a>
            <a class="nav-link <?php echo e(request()->is('teacher/modules/upload-resource*') && request()->query('type') == 'image' ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.modules.upload-resource')); ?>?type=image">
                <span class="nav-icon">🖼</span> Add Image
            </a>
            <a class="nav-link <?php echo e(request()->is('teacher/modules/upload-resource*') && request()->query('type') == 'ppt' ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.modules.upload-resource')); ?>?type=ppt">
                <span class="nav-icon">📄</span> Add PPT
            </a>

            <div class="nav-section-label">People</div>

            <a class="nav-link <?php echo e(request()->routeIs('teacher.students*') ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.students.index')); ?>">
                <span class="nav-icon">◌</span> Students
            </a>
            <a class="nav-link <?php echo e(request()->routeIs('teacher.progress*') ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.progress.index')); ?>">
                <span class="nav-icon">◍</span> Progress
            </a>
            <a class="nav-link <?php echo e(request()->routeIs('teacher.profile*') ? 'active' : ''); ?>"
               href="<?php echo e(route('teacher.profile.edit')); ?>">
        ...
        <header class="topbar">
            ...
            <div class="avatar-wrap">
                <div class="topbar-user">
                    <div class="avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'I', 0, 1))); ?></div>
                    <span><?php echo e(auth()->user()->name ?? 'Instructor'); ?></span>
                </div>
            </div>
        </header>
...
</html><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/teacher/layouts/master.blade.php ENDPATH**/ ?>