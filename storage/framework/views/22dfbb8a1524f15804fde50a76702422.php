...
<div class="amc">
    <div class="flex items-start justify-between flex-wrap gap-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('staff.users.create')); ?>" class="amc-btn amc-btn--primary">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg>
                Add user
            </a>
            <a href="<?php echo e(route('staff.settings.index')); ?>" class="amc-btn amc-btn--ghost">
    ...
    <form method="GET" class="amc-filterbar">
        <div class="amc-input-wrap">
            ...
            <input name="q" value="<?php echo e($q ?? ''); ?>" placeholder="Search by name or email..." class="amc-input">
        </div>
        <select name="role" class="amc-select">
            ...
            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?php echo e((isset($role) && $role == $key) ? 'selected' : ''); ?>><?php echo e($label); ?></option>
            ...
            <table class="amc-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="p-3">
                            <div class="amc-user">
                                <div class="amc-avatar" style="background: linear-gradient(135deg, hsl(<?php echo e($hue); ?>,75%,68%), hsl(<?php echo e(($hue + 50) % 360); ?>,75%,60%));"><?php echo e(strtoupper($initials)); ?></div>
                                <span class="amc-name"><?php echo e($u->name); ?></span>
                            </div>
                        </td>
                        <td class="p-3"><span class="amc-email"><?php echo e($u->email); ?></span></td>
                        <td class="p-3"><span class="amc-badge"><?php echo e(ucfirst($u->role)); ?></span></td>
                        <td class="p-3">
                            <?php if($isActive): ?>
                        ...
                        <td class="p-3">
                            <div class="amc-actions">
                                <a href="<?php echo e(route('staff.users.edit', $u)); ?>" class="amc-icon-btn" title="Edit user">
                                ...
                                <form action="<?php echo e(route('staff.users.reset-password', $u)); ?>" method="POST" style="display:inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="amc-icon-btn" title="Reset password" onclick="return confirm('Reset password for <?php echo e($u->name); ?>?')">
                                ...
                                <form action="<?php echo e(route('staff.users.toggle-status', $u)); ?>" method="POST" style="display:inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="amc-icon-btn danger" title="Toggle status" onclick="return confirm('Toggle status for <?php echo e($u->name); ?>?')">
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/users/index.blade.php ENDPATH**/ ?>