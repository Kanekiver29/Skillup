...
<div class="em-page">
    ...
    <div class="em-header">
        ...
        <div class="em-header__actions">
            <a href="<?php echo e(route('staff.enrollments.export')); ?>" class="em-btn em-btn--outline">
    ...
    <div class="em-stats">
        <div class="em-stat em-stat--indigo">
            ...
            <div class="em-stat__value" data-count-to="<?php echo e($stats['total'] ?? '1,248'); ?>"><?php echo e($stats['total'] ?? '1,248'); ?></div>
        ...
        <div class="em-stat em-stat--green">
            ...
            <div class="em-stat__value" data-count-to="<?php echo e($stats['active'] ?? '984'); ?>"><?php echo e($stats['active'] ?? '984'); ?></div>
        ...
        <div class="em-stat em-stat--amber">
            ...
            <div class="em-stat__value" data-count-to="<?php echo e($stats['pending'] ?? '183'); ?>"><?php echo e($stats['pending'] ?? '183'); ?></div>
        ...
        <div class="em-stat em-stat--red">
            ...
            <div class="em-stat__value" data-count-to="<?php echo e($stats['dropped'] ?? '81'); ?>"><?php echo e($stats['dropped'] ?? '81'); ?></div>
    ...
    <form method="GET" action="<?php echo e(route('staff.enrollments.index')); ?>" class="em-toolbar">
        <div class="em-search">
        ...
        <select name="status" class="em-select" onchange="this.form.submit()" aria-label="Filter by status">
            ...
            <option value="complete" <?php echo e(request('status') === 'complete' ? 'selected' : ''); ?>>Completed</option>
        </select>
        ...
        <select name="year_level" class="em-select" onchange="this.form.submit()" aria-label="Filter by year level">
            ...
            <option value="1" <?php echo e(request('year_level') == '1' ? 'selected' : ''); ?>>Year 1</option>
            <option value="2" <?php echo e(request('year_level') == '2' ? 'selected' : ''); ?>>Year 2</option>
            <option value="3" <?php echo e(request('year_level') == '3' ? 'selected' : ''); ?>>Year 3</option>
            <option value="4" <?php echo e(request('year_level') == '4' ? 'selected' : ''); ?>>Year 4</option>
        </select>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search','status','course','year_level'])): ?>
            <a href="<?php echo e(route('staff.enrollments.index')); ?>" class="em-btn em-btn--outline em-btn--sm">
                Clear filters
            </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <span class="em-toolbar__count">
            <?php echo e($enrollments->total() ?? 0); ?> record<?php echo e(($enrollments->total() ?? 0) !== 1 ? 's' : ''); ?>
    ...
    <div class="em-card">
        ...
        <div class="em-table-wrap">
            <table class="em-table" aria-label="Enrollments">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="selected[]" value="<?php echo e($enrollment->id); ?>" aria-label="Select <?php echo e($enrollment->student->name); ?>">
                        </td>
                        <td>
                            <div class="em-student">
                                <div class="em-student__avatar" style="background: hsl(<?php echo e(crc32($enrollment->student->name ?? '') % 360); ?>, 72%, 62%)">
                                    <?php echo e(strtoupper(substr($enrollment->student->name ?? 'S', 0, 1))); ?>

                                </div>
                                <div>
                                    <div class="em-student__name"><?php echo e($enrollment->student->name ?? '—'); ?></div>
                                    <div class="em-student__id"><?php echo e($enrollment->student->email ?? ''); ?></div>
                                </div>
                            </div>
                        </td>
                        <td style="font-family: var(--em-font-mono); font-weight:600;color:var(--em-gray-900)">
                            <?php echo e($enrollment->student->student_id ?? '—'); ?>

                        </td>
                        <td>
                            <div style="font-weight:500;color:var(--em-gray-900)"><?php echo e($enrollment->course->name ?? '—'); ?></div>
                            <div style="font-family: var(--em-font-mono); font-size:11.5px;color:var(--em-gray-400)"><?php echo e($enrollment->course->code ?? ''); ?></div>
                        </td>
                        <td>Year <?php echo e($enrollment->year_level ?? '—'); ?></td>
                        <td style="font-family: var(--em-font-mono); white-space:nowrap">
                            <?php echo e($enrollment->enrolled_at ? \Carbon\Carbon::parse($enrollment->enrolled_at)->format('M d, Y') : '—'); ?>

                        </td>
                        <td>
                            <?php $s = $enrollment->status ?? 'active'; ?>
                            <span class="em-badge em-badge--<?php echo e($s); ?>">
                        ...
                        <td>
                            <div class="em-actions">
                                <a href="<?php echo e(route('staff.enrollments.show', $enrollment->id)); ?>"
                                ...
                                <a href="<?php echo e(route('staff.enrollments.edit', $enrollment->id)); ?>"
                                ...
                                <form method="POST" action="<?php echo e(route('staff.enrollments.destroy', $enrollment->id)); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($enrollments) && $enrollments->hasPages()): ?>
        <div class="em-pagination">
            <span class="em-pagination__info">
                Showing <?php echo e($enrollments->firstItem()); ?>–<?php echo e($enrollments->lastItem()); ?> of <?php echo e($enrollments->total()); ?>

            </span>
            <div class="em-pagination__pages">
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->onFirstPage()): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($enrollments->previousPageUrl()); ?>" class="em-page-btn">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M8.5 10.5l-3-3.5 3-3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $enrollments->getUrlRange(max(1, $enrollments->currentPage()-2), min($enrollments->lastPage(), $enrollments->currentPage()+2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e($url); ?>" class="em-page-btn <?php echo e($page == $enrollments->currentPage() ? 'is-active' : ''); ?>">
                        <?php echo e($page); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->hasMorePages()): ?>
                    <a href="<?php echo e($enrollments->nextPageUrl()); ?>" class="em-page-btn">
    ...
    <div id="enrollModal"
        ...
        <div class="em-modal" role="document">
            ...
            <form id="enrollForm" method="POST" action="<?php echo e(route('staff.enrollments.store')); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="em-field">
                            ...
                            <select id="student_id" name="student_id" class="em-input" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $students ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($student->id); ?>"><?php echo e($student->name); ?> (<?php echo e($student->student_id); ?>)</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                        </div>
                        <div class="em-field">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\enrollments\index.blade.php ENDPATH**/ ?>