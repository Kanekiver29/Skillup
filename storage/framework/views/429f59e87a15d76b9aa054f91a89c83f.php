...
<?php $__env->startSection('title', 'Notifications - SkillUp'); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-6">
        ...
        >
            ...
            <div class="notify-hero-inner flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-2xl">
                    <a href="<?php echo e(route('chats.index')); ?>" class="notify-back-link inline-flex items-center gap-2 text-sm font-medium mb-4 group">
                ...
                <div class="grid grid-cols-2 gap-3 sm:min-w-80">
                    <div data-page-animate class="page-delay-2 notify-glass rounded-2xl px-4 py-4">
                        ...
                        <p class="notify-stat-val mt-2 text-3xl tabular-nums" data-countup="<?php echo e($totalUnread); ?>"><?php echo e($totalUnread); ?></p>
                    </div>
                    <div data-page-animate class="page-delay-3 notify-glass rounded-2xl px-4 py-4">
                        ...
                        <p class="notify-stat-val mt-2 text-3xl tabular-nums" data-countup="<?php echo e(count($recentMessages)); ?>"><?php echo e(count($recentMessages)); ?></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div data-page-animate class="page-delay-2 flex flex-wrap gap-3">
            <a href="<?php echo e(route('chats.index')); ?>" class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-sky-200 hover:text-sky-700 min-h-0">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalUnread > 0): ?>
                <span class="inline-flex items-center gap-2 rounded-full bg-rose-50 border border-rose-100 px-4 py-2.5 text-sm font-semibold text-rose-700">
                    ...
                    <?php echo e($totalUnread); ?> unread across your threads
                </span>
            <?php else: ?>
        ...
        <section data-page-animate class="page-delay-3 chat-panel overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.08)]">
            <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($recentMessages)): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($recentMessages)): ?>
                <div class="divide-y divide-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a
                            href="<?php echo e(route('chats.show', $message['conversation_id'])); ?>"
                                ...
                                <div class="flex min-w-0 items-start gap-4">
                                    <div class="notify-avatar relative shrink-0">
                                        <div class="chat-avatar-lg bg-slate-900 text-white ring-2 ring-sky-100">
                                            <?php echo e(strtoupper(substr($message['sender'], 0, 1))); ?>
            ...
            <?php else: ?>
                <div data-page-animate class="notify-empty px-6 py-16 text-center">
                    ...
                    <a href="<?php echo e(route('chats.index')); ?>" class="chat-send-btn mt-8 inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-lg min-h-0" style="background: linear-gradient(135deg, #003a8f, #0a2540);">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\chats\notifications.blade.php ENDPATH**/ ?>