...
<style>
/* ═══════════════════════════════════════════════════════
   SUBJECTS EDIT — Ultra-polished console UI
   ═══════════════════════════════════════════════════════ */
.syl-wrap {
    --bg:      var(--body-bg);
    --surface: var(--surface);
...
<div class="syl-wrap" style="position:relative; min-height:100vh; padding:1.5rem 1.5rem 3rem;">
    ...
    <div style="max-width:760px; margin:0 auto; position:relative; z-index:2;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1.5rem;">
            <div>
                <h1 class="syl-heading">Edit Subject</h1>
                <p class="syl-sub">Update the details for <?php echo e($subject->title); ?>.</p>
            </div>
            <a href="<?php echo e(route('staff.subjects.index')); ?>" class="syl-back">
        ...
        <div class="syl-panel">
            ...
            <div class="syl-toolbar">
                <div style="display:flex; align-items:center;">
                    ...
                    <span class="syl-toolbar-title">subjects.edit</span>
                </div>
                <span style="font-size:0.68rem; color:rgba(251,191,36,0.7); font-family:monospace; letter-spacing:0.06em;">● EDIT</span>
            </div>

            <div class="syl-panel-content">
                <form action="<?php echo e(route('staff.subjects.update', $subject)); ?>" method="POST" id="subject-form" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;" class="responsive-grid">
                        <div class="syl-field" style="--fi:0;">
                            ...
                            <input type="text" name="subject_code" id="subject_code"
                                   value="<?php echo e(old('subject_code', $subject->subject_code)); ?>" placeholder="e.g. CS101"
                                   class="syl-input" />
                        </div>
                        <div class="syl-field" style="--fi:1;">
                            <label class="syl-label" for="title">Subject Name</label>
                            <input type="text" name="title" id="title"
                                   value="<?php echo e(old('title', $subject->title)); ?>" placeholder="Enter subject name…"
                    ...
                    <div class="syl-field" style="--fi:2; margin-top:1rem;">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  ...
                                  class="syl-textarea"><?php echo e(old('description', $subject->description)); ?></textarea>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:1rem; margin-top:1rem;" class="responsive-grid">
                        <div class="syl-field" style="--fi:3;">
                            ...
                            <input type="number" name="units" id="units"
                                   value="<?php echo e(old('units', $subject->units)); ?>" class="syl-input" min="0"/>
                        </div>
                        <div class="syl-field" style="--fi:4;">
                            <label class="syl-label" for="hours">Hours</label>
                            <input type="number" name="hours" id="hours"
                                   value="<?php echo e(old('hours', $subject->hours)); ?>" class="syl-input" min="0"/>
                        </div>
                            ...
                            <select name="course_id" id="course_id" class="syl-select" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($course->id); ?>"
                                        <?php echo e(old('course_id', $subject->course_id) == $course->id ? 'selected' : ''); ?>>
                    ...
                    <div class="syl-field" style="--fi:6; margin-top:1.1rem;">
                        <label class="syl-toggle">
                            <input type="checkbox" name="is_active" value="1" id="is_active"
                                   <?php echo e(old('is_active', $subject->is_active) ? 'checked' : ''); ?>/>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\subjects\edit.blade.php ENDPATH**/ ?>