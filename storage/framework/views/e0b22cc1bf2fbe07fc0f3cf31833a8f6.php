...
<?php $__env->startSection('title', $quiz->title . ' - ' . $module->title . ' - SkillUp'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pt-6 quiz-hero">
        ...
        <div class="quiz-hero-inner max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="mb-4">
                <a href="<?php echo e(route('modules.show', [$course->slug, $module->slug])); ?>" class="quiz-back-link flex items-center group">
                    <i class="fas fa-arrow-left mr-2 text-xs transition-transform group-hover:-translate-x-1"></i>
                    Back to <?php echo e($module->title); ?>
            ...
            <h1 class="quiz-display text-4xl md:text-5xl font-bold mb-4"><?php echo e($quiz->title); ?></h1>
            <p class="text-lg text-purple-100/90"><?php echo e($quiz->description); ?></p>
            <?php if($quiz->media_type && $quiz->media_url): ?>
                <div class="mt-8">
                    <?php if($quiz->media_type === 'video'): ?>
                        <?php if(str_contains($quiz->media_url, 'youtube.com') || str_contains($quiz->media_url, 'youtu.be')): ?>
                            <div class="quiz-media-frame aspect-w-16 aspect-h-9">
                                <iframe src="<?php echo e($quiz->media_url); ?>" frameborder="0" allowfullscreen class="w-full h-full"></iframe>
                            </div>
                        <?php else: ?>
                            <div class="quiz-media-frame aspect-w-16 aspect-h-9 bg-black">
                                <video controls class="w-full h-full object-cover">
                                    <source src="<?php echo e($quiz->media_url); ?>" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video>
                            </div>
                        <?php endif; ?>
                    <?php elseif($quiz->media_type === 'image'): ?>
                        <div class="quiz-media-frame">
                            <img src="<?php echo e($quiz->media_url); ?>" alt="<?php echo e($quiz->title); ?> media" class="w-full">
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <div class="lg:col-span-2">
                ...
                <section class="quiz-card rounded-lg shadow-lg p-8 mb-8">
                    ...
                    <div class="prose prose-sm max-w-none text-gray-600 mb-6">
                        <p><?php echo e($quiz->description ?? 'Test your knowledge on this module topic.'); ?></p>
                    </div>
                            ...
                            <div class="quiz-stat-tile bg-gradient-to-br from-emerald-50 to-emerald-100">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="quiz-stat-val mt-1 text-3xl font-bold text-emerald-600"><?php echo e($bestScore); ?>%</p>
                                    </div>
                            ...
                            <div class="quiz-stat-tile bg-gradient-to-br from-sky-50 to-sky-100">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="quiz-stat-val mt-1 text-3xl font-bold text-sky-600"><?php echo e($attemptCount); ?>/<?php echo e($quiz->attempt_limit); ?></p>
                                    </div>
                ...
                <?php if($userAttempts->count() > 0): ?>
                    <section class="quiz-card rounded-lg shadow-lg p-8 mb-8">
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $userAttempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="quiz-attempt-row <?php echo e($attempt->passed ? 'is-pass' : 'is-fail'); ?> border border-gray-200 rounded-lg p-4"
                                     style="animation-delay: <?php echo e(min($index * 70, 350)); ?>ms">
                                    <div class="flex items-start justify-between">
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Attempt #<?php echo e($attempt->attempt_number); ?></h4>
                                            <p class="quiz-mono text-xs text-gray-500"><?php echo e($attempt->completed_at?->format('M d, Y H:i A')); ?></p>
                                        </div>
                                        <div class="text-right">
                                            <p class="quiz-stat-val text-2xl font-bold <?php if($attempt->passed): ?> text-emerald-600 <?php else: ?> text-rose-600 <?php endif; ?>">
                                                <?php echo e($attempt->score_percentage); ?>%
                                            </p>
                                            <p class="text-sm text-gray-600"><?php echo e($attempt->correct_answers); ?>/<?php echo e($attempt->total_questions); ?> correct</p>
                                        </div>
                                    </div>
                                    <div class="flex gap-4 mt-4 text-sm">
                                        <span class="flex items-center text-gray-600">
                                            <i class="fas fa-clock mr-2"></i>
                                            <?php echo e($attempt->getFormattedTimeSpent()); ?>

                                        </span>
                                        <?php if($attempt->passed): ?>
                                            <span class="flex items-center text-emerald-600">
                                                <i class="fas fa-check-circle mr-2"></i>
                                                Passed (<?php echo e($quiz->passing_score); ?>% required)
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="mt-4">
                                        <a href="<?php echo e(route('quizzes.results', [$course->slug, $module->slug, $quiz->slug, $attempt->id])); ?>"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="quiz-detail-row flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e($quiz->questions()->count()); ?> questions in this quiz</p>
                            </div>
                        </div>
                        ...
                        <div class="quiz-detail-row flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e($quiz->passing_score); ?>% required to pass</p>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    <?php if($quiz->time_limit_minutes): ?>
                                        <?php echo e($quiz->time_limit_minutes); ?> minutes
                                    <?php else: ?>
                                        No time limit
                                    <?php endif; ?>
                                </p>
                        ...
                        <div class="quiz-detail-row flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600"><?php echo e($quiz->attempt_limit); ?> attempts allowed</p>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="quiz-action-card bg-white rounded-lg shadow-lg p-6 mb-6 sticky top-24">
                    ...
                    <?php if($canRetry || $attemptCount === 0): ?>
                        ...
                        <p class="text-gray-600 text-sm mb-2">
                            ...
                            <?php else: ?>
                                You can still retry this quiz. <?php echo e($quiz->attempt_limit - $attemptCount); ?> attempt(s) remaining.
                            <?php endif; ?>
                        </p>
                        <div class="quiz-attempt-meter">
                            <div class="quiz-attempt-meter-fill" style="width: <?php echo e($quiz->attempt_limit > 0 ? min(100, ($attemptCount / $quiz->attempt_limit) * 100) : 0); ?>%"></div>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="quiz-locked-card rounded-lg p-6 text-center">
                            ...
                            <p class="text-rose-600 text-sm">You've used all <?php echo e($quiz->attempt_limit); ?> attempts for this quiz.</p>
                            <?php if(!$hasUserPassed): ?>
                ...
                <div class="quiz-tips-card rounded-lg p-6">
                    ...
                    <ul class="text-sm text-gray-700 space-y-2">
                        ...
                        <?php if($quiz->show_correct_answers): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/courses/quizzes/show.blade.php ENDPATH**/ ?>