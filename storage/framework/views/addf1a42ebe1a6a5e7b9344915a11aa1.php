...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIAS Student'); ?></title>
    ...
    <script>
        (function () {
            var configured = <?php echo json_encode(data_get(auth()->user()?->settings, 'appearance.theme'), 512) ?>;
            var configuredFontSize = <?php echo json_encode(data_get(auth()->user()?->settings, 'appearance.font_size'), 512) ?>;
...
<div class="layout-shell">
    ...
    <aside class="nav-panel" role="navigation" aria-label="Main navigation">
        <div class="nav-inner">
            ...
            <div class="brand">
                <div class="brand-logos">
                    <div class="brand-logo" title="SIAS">
                        <img src="<?php echo e(asset('image/logo new.jpg')); ?>" alt="SIAS Logo" width="32" height="32" loading="eager" decoding="async">
                    </div>
                    <div class="brand-logo" title="Institution">
                        <img src="<?php echo e(asset('image/hello.png')); ?>" alt="Institution Logo" width="32" height="32" loading="lazy" decoding="async">
                    </div>
                    <div class="brand-logo" title="Bagong Pilipinas">
                        <img src="<?php echo e(asset('image/bagong-pilipinas-logo-png_seeklogo-534301.png')); ?>" alt="Bagong Pilipinas" width="32" height="32" loading="lazy" decoding="async">
                    </div>
                </div>
            ...
            <!-- Nav title -->
            <div class="nav-title">
                <span data-i18n="navigation"><?php echo e(__('sias.navigation')); ?></span>
            ...
            <div class="nav-scroll">
                <nav>
                    ...
                    <a style="--i:1"
                       href="<?php echo e(route('sias.student.dashboard')); ?>"
                       class="<?php echo e(request()->routeIs('sias.student.dashboard') ? 'active' : ''); ?>"
                       aria-current="<?php echo e(request()->routeIs('sias.student.dashboard') ? 'page' : 'false'); ?>">
                    ...
                    <details class="nav-collapse"
                             <?php echo e(request()->routeIs('sias.student.profile','sias.student.enrollment','sias.student.subjects','sias.student.schedule') ? 'open' : ''); ?>
                        ...
                        <div class="nav-subitems">
                            <a href="<?php echo e(route('sias.student.profile')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.profile') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-user" aria-hidden="true"></i>
                                <span data-i18n="profile">Profile</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.enrollment')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.enrollment') ? 'active' : ''); ?>">
                            ...
                            <a href="<?php echo e(route('sias.student.subjects')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.subjects') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-book" aria-hidden="true"></i>
                                <span data-i18n="subjects">Subjects</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.schedule')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.schedule') ? 'active' : ''); ?>">
                    ...
                    <!-- Academics group -->
                    <details class="nav-collapse"
                             <?php echo e(request()->routeIs('sias.student.assessment','sias.student.grades','sias.student.attendance','sias.student.teacher_evaluation') ? 'open' : ''); ?>
                        ...
                        <div class="nav-subitems">
                            <a href="<?php echo e(route('sias.student.assessment')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.assessment') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-file-circle-check" aria-hidden="true"></i>
                                <span data-i18n="assessment">Assessment</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.grades')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.grades') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-clipboard-list" aria-hidden="true"></i>
                                <span data-i18n="grades">Grades</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.attendance')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.attendance') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-clipboard-check" aria-hidden="true"></i>
                                <span data-i18n="attendance">Attendance</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.teacher_evaluation')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.teacher_evaluation') ? 'active' : ''); ?>">
                    ...
                    <details class="nav-collapse"
                             data-report-nav
                             <?php echo e(request()->routeIs('sias.student.reports.*') ? 'open' : ''); ?>
                        ...
                        <div class="nav-subitems">
                            <a href="<?php echo e(route('sias.student.reports.class-offerings')); ?>"
                               class="report-subitem <?php echo e(request()->routeIs('sias.student.reports.class-offerings') ? 'active' : ''); ?>"
                            ...
                            <a href="<?php echo e(route('sias.student.reports.enrolled-subjects')); ?>"
                               class="report-subitem <?php echo e(request()->routeIs('sias.student.reports.enrolled-subjects') ? 'active' : ''); ?>"
                               data-report-section="enrolled-subjects">
                                <i class="fa-solid fa-book-open" aria-hidden="true"></i>
                                <span data-i18n="subjects_report">Subjects</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.reports.final-grades-match')); ?>"
                               class="report-subitem <?php echo e(request()->routeIs('sias.student.reports.final-grades-match') ? 'active' : ''); ?>"
                               data-report-section="final-grades-match">
                                <i class="fa-solid fa-graduation-cap" aria-hidden="true"></i>
                                <span data-i18n="final_grades">Final Grades</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.reports.gwa-match')); ?>"
                               class="report-subitem <?php echo e(request()->routeIs('sias.student.reports.gwa-match') ? 'active' : ''); ?>"
                               data-report-section="gwa-match">
                                <i class="fa-solid fa-percent" aria-hidden="true"></i>
                                <span data-i18n="gwa">GWA</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.reports.term-grades-match')); ?>"
                               class="report-subitem <?php echo e(request()->routeIs('sias.student.reports.term-grades-match') ? 'active' : ''); ?>"
                    ...
                    <a href="<?php echo e(route('sias.student.announcements')); ?>"
                       class="<?php echo e(request()->routeIs('sias.student.announcements') ? 'active' : ''); ?>">
                        <i class="fa-solid fa-bullhorn" aria-hidden="true"></i>
                        <span class="nav-label">Announcements</span>
                    </a>
                    <a href="<?php echo e(route('sias.student.notifications')); ?>"
                       class="<?php echo e(request()->routeIs('sias.student.notifications') ? 'active' : ''); ?>">
                    ...
                    <!-- Account & Security -->
                    <details class="nav-collapse"
                             <?php echo e(request()->routeIs('sias.student.account.*') ? 'open' : ''); ?>
                        ...
                        <div class="nav-subitems">
                            <a href="<?php echo e(route('sias.student.settings')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.settings') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-sliders" aria-hidden="true"></i>
                                <span data-i18n="settings"><?php echo e(__('sias.settings')); ?></span>
                            </a>
                            <a href="<?php echo e(route('sias.student.account.password')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.account.password') ? 'active' : ''); ?>">
                                <i class="fa-solid fa-key" aria-hidden="true"></i>
                                <span data-i18n="password">Password</span>
                            </a>
                            <a href="<?php echo e(route('sias.student.account.mfa')); ?>"
                               class="<?php echo e(request()->routeIs('sias.student.account.mfa') ? 'active' : ''); ?>">
                    ...
                    <a style="--i:6"
                       href="<?php echo e(route('sias.student.help')); ?>"
                       class="<?php echo e(request()->routeIs('sias.student.help') ? 'active' : ''); ?>">
                        <i class="fa-solid fa-circle-question" aria-hidden="true"></i>
                        <span class="nav-label" data-i18n="help"><?php echo e(__('sias.help')); ?></span>
                    </a>
                </nav>
            </div>
            ...
            <!-- Footer: user + logout -->
            <div class="nav-foot">
                <div class="user-pill" aria-label="Logged in as <?php echo e(Auth::user()->name ?? 'Student'); ?>">
                    <div class="user-avatar" aria-hidden="true">
                        <?php echo e(strtoupper(substr(Auth::user()->name ?? 'S', 0, 1))); ?>

                    </div>
                    <div class="user-info">
                        <div class="user-name"><?php echo e(Auth::user()->name ?? 'Student'); ?></div>
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    ...
                    <button type="submit" class="btn-logout">
                        ...
                        <span data-i18n="sign_out"><?php echo e(__('sias.sign_out')); ?></span>
                    </button>
                </form>
            </div>
        ...
        <div class="page-card">
            ...
            <div class="page-header">
                <div class="page-header-title">
                    <h2><?php echo $__env->yieldContent('page_title', 'Student Portal'); ?></h2>
                    <div class="page-header-meta">
                        <span class="welcome">
                            <span data-i18n="welcome"><?php echo e(__('sias.welcome')); ?></span>,
                            <strong><?php echo e(Auth::user()->name ?? 'Student'); ?></strong>
                        </span>
                        <span class="meta-dot" aria-hidden="true"></span>
                        <span class="version-chip" title="System version">
                            <i class="fa-solid fa-code-branch" aria-hidden="true"></i>
                            v<?php echo e(config('sias.version', '3.7.8.7')); ?>
                ...
                <div class="page-header-actions">
                    ...
                    <!-- Language Switcher -->
                    <div class="lang-switcher" role="group" aria-label="<?php echo e(__('sias.language')); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['en' => 'EN', 'tl' => 'TL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <form method="GET" action="<?php echo e(route('language.switch', $code)); ?>" style="margin:0;display:inline-flex;">
                                <button type="submit"
                                        class="lang-btn <?php echo e(app()->getLocale() === $code ? 'active' : ''); ?>"
                                        aria-pressed="<?php echo e(app()->getLocale() === $code ? 'true' : 'false'); ?>"
                                        aria-label="Switch to <?php echo e($label); ?>"><?php echo e($label); ?></button>
                            </form>
...
<script>
    (function () {
        var translations = <?php echo json_encode(__('sias'), 15, 512) ?>;
        var english = <?php echo json_encode(__('sias', [], 'en')) ?>;
...
</html><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\layout\master.blade.php ENDPATH**/ ?>