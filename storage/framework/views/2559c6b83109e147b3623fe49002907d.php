    ...
    <div class="rs-grid">
        ...
        <div class="rs-sidebar rs-anim" style="animation-delay:.14s;">
            <div class="rs-sidebar-card">
                ...
                <?php $gwa = isset($gwaIgnore) ? $gwaIgnore : (isset($gwa) ? $gwa : null); $gwaClass = $gwa >= 75 ? 'pass' : ($gwa !== null ? 'fail' : ''); ?>
...
<?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\reports\sections\final-grades-ignore.blade.php ENDPATH**/ ?>