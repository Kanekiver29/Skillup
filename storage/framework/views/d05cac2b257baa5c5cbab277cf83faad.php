...
<?php $__env->startSection('title', 'Privacy Policy - SkillUp'); ?>
		...
		<div class="max-w-4xl mx-auto space-y-14">
			...
			<div id="cookies" class="scroll-mt-24">
				...
				<div class="pl-14 text-gray-700 leading-relaxed space-y-3">
					...
					<p>
						For details, review our <a href="<?php echo e(route('cookie-policy')); ?>" class="text-purple-600 hover:underline font-medium">Cookie Policy</a>.
					</p>
				</div>
			</div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Userpage\Legal\privacy.blade.php ENDPATH**/ ?>