...
<?php $__env->startSection('title', $module->title . ' - ' . $course->title . ' - SkillUp'); ?>
    ...
    <section class="mod-hero text-white relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14 relative z-10">
            <div data-animate class="flex flex-wrap items-center justify-between gap-3 mb-6">
                <a href="<?php echo e(route('courses.show', $course->slug)); ?>" class="inline-flex items-center gap-2 text-slate-300 hover:text-white text-sm transition-colors">
                    <i class="fas fa-arrow-left"></i>
                    <span>Back to <?php echo e($course->title); ?></span>
                </a>
                <div class="hidden sm:flex items-center gap-2 text-[11px] uppercase tracking-[0.28em] text-slate-400">
                    ...
                    <span class="text-slate-300"><?php echo e($module->title); ?></span>
                </div>
            </div>
            ...
            <div data-animate class="delay-75 grid gap-8 xl:grid-cols-[1.2fr_0.8fr] xl:items-start">
                <div class="space-y-6">
                    ...
                    <div>
                        <h1 class="font-display mod-title-shimmer text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight"><?php echo e($module->title); ?></h1>
                        <?php if($module->description): ?>
                            <p class="text-slate-300 mt-4 max-w-2xl leading-relaxed text-base md:text-lg"><?php echo e($module->description); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="grid gap-3 sm:grid-cols-3">
                        <div class="mod-glass-card rounded-2xl p-4">
                            <p class="font-display text-2xl font-bold text-white"><?php echo e($lessons->count()); ?></p>
                            <p class="text-sm text-slate-300">Learning assets</p>
                        </div>
                        <div class="mod-glass-card rounded-2xl p-4">
                            <p class="font-display text-2xl font-bold text-white"><?php echo e($quizzes->count()); ?></p>
                            <p class="text-sm text-slate-300">Knowledge checks</p>
                        </div>
                        <div class="mod-glass-card rounded-2xl p-4">
                            <p class="font-display text-2xl font-bold text-emerald-300"><?php echo e($passedQuizzes); ?></p>
                    ...
                    <div class="mt-6 flex items-center gap-5">
                        ...
                        <div class="mod-orbit-wrap">
                            ...
                            <svg class="mod-orbit-progress" width="108" height="108" viewBox="0 0 108 108">
                                <circle cx="54" cy="54" r="<?php echo e($radius); ?>" fill="none" stroke="rgba(255,255,255,0.08)" stroke-width="6"></circle>
                                <circle
                                    id="mod-ring-fill"
                                    class="mod-ring-fill"
                                    cx="54" cy="54" r="<?php echo e($radius); ?>"
                                    fill="none"
                                    stroke="url(#mod-ring-gradient)"
                                    stroke-width="6"
                                    stroke-linecap="round"
                                    stroke-dasharray="<?php echo e($circumference); ?>"
                                    stroke-dashoffset="<?php echo e($circumference); ?>"
                                    data-circumference="<?php echo e($circumference); ?>"
                                    data-target="<?php echo e($userProgress); ?>"
                                    style="--ring-circumference: <?php echo e($circumference); ?>px;"
                                ></circle>
                                <defs>
                            ...
                            <div class="mod-orbit-center">
                                <span class="font-display text-xl font-bold text-white"><span id="mod-progress-counter" data-target="<?php echo e($userProgress); ?>">0</span>%</span>
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <button
                                ...
                                data-complete-url="<?php echo e(route('modules.markComplete', [$course->slug, $module->slug])); ?>"
                                <?php echo e($isModuleCompleted ? 'disabled' : ''); ?>

                            >
                                <i class="fas <?php echo e($isModuleCompleted ? 'fa-circle-check' : 'fa-flag-checkered'); ?>"></i>
                                <span id="mod-complete-btn-label"><?php echo e($isModuleCompleted ? 'Module Completed' : 'Mark Module as Complete'); ?></span>
                            </button>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="mod-complete-btn" style="background: rgba(255,255,255,0.1); box-shadow:none;">
            ...
            <?php if(!empty($course->image_url)): ?>
                <div data-animate class="delay-150 mt-8 overflow-hidden rounded-3xl border border-white/15 shadow-2xl shadow-slate-950/20">
                    <img src="<?php echo e(asset($course->image_url)); ?>" alt="<?php echo e($course->title); ?>" class="w-full h-48 md:h-64 object-cover">
                </div>
            <?php endif; ?>

            <?php if($module->definition || $module->example): ?>
                <div data-animate class="delay-200 grid gap-4 md:grid-cols-2 mt-8">
                    <?php if($module->definition): ?>
                        <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-sm shadow-lg shadow-slate-950/10 mod-glass-card">
                            ...
                            <p class="text-slate-200 text-sm leading-relaxed"><?php echo nl2br(e($module->definition)); ?></p>
                        </div>
                    <?php endif; ?>
                    <?php if($module->example): ?>
                        <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-sm shadow-lg shadow-slate-950/10 mod-glass-card">
                            <h2 class="text-sm font-bold uppercase tracking-[0.28em] text-sky-200 mb-2">Practical Example</h2>
                            <p class="text-slate-200 text-sm leading-relaxed"><?php echo nl2br(e($module->example)); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div class="lg:col-span-2 space-y-10">
                ...
                <?php if($moduleVideoUrl || $moduleImageUrl || $modulePptUrl || $modulePdfUrl): ?>
                    <div class="mod-attachments-grid" data-animate>
                        <?php if($moduleVideoUrl): ?>
                            <section class="mod-attachment-card mod-border-glow mod-hud-corners rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                                <div class="mod-attachment-body">
                                    ...
                                    <video controls class="w-full rounded-xl border border-gray-100 bg-black" preload="metadata">
                                        <source src="<?php echo e($moduleVideoUrl); ?>" type="video/mp4">
                                        Your browser does not support the video tag.
                                    </video>
                                </div>
                                <a href="<?php echo e($moduleVideoUrl); ?>" target="_blank" rel="noopener" class="mt-3 inline-flex items-center text-sm font-semibold text-[#003a8f] hover:underline">
                                    <i class="fas fa-external-link-alt mr-2"></i>Open video in a new tab
                                </a>
                            </section>
                        <?php endif; ?>

                        <?php if($moduleImageUrl): ?>
                            <section class="mod-attachment-card mod-border-glow mod-hud-corners rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                                <div class="mod-attachment-body">
                                    <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <img src="<?php echo e($moduleImageUrl); ?>" alt="Module image" class="w-full rounded-xl border border-gray-100 object-cover h-52">
                                </div>
                            </section>
                        <?php endif; ?>
                        ...
                        <?php if($modulePptUrl): ?>
                            <section class="mod-attachment-card mod-border-glow mod-hud-corners rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                                ...
                                <a href="<?php echo e($modulePptUrl); ?>" target="_blank" rel="noopener" class="mod-sheen inline-flex items-center rounded-lg bg-[#003a8f] px-4 py-2 text-sm font-semibold text-white hover:bg-[#002d6b] self-start">
                        ...
                        <?php if($modulePdfUrl): ?>
                            <section class="mod-attachment-card mod-border-glow mod-hud-corners rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                                ...
                                <a href="<?php echo e($modulePdfUrl); ?>" target="_blank" rel="noopener" class="mod-sheen inline-flex items-center rounded-lg bg-slate-800 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-700 self-start">
                    ...
                    <div data-animate class="delay-100 mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($lessons->count()); ?> lessons &middot; videos, docs &amp; presentations</p>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-6 sm:grid-cols-2 items-stretch" id="lessons-grid">
                            <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <article
                                    ...
                                    data-lesson-type="<?php echo e($typeSlug); ?>"
                                    data-search="<?php echo e(strtolower($lesson->title)); ?>"
                                    style="animation-delay: <?php echo e(min($index * 60, 300)); ?>ms"
                                >
                                    <div class="relative h-48 sm:h-52 bg-slate-100 overflow-hidden group shrink-0">
                                        <?php if($hasImage && $resourceUrl): ?>
                                            <img src="<?php echo e($resourceUrl); ?>" alt="<?php echo e($lesson->title); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                                        <?php elseif($hasVideo): ?>
                                        ...
                                        <span class="absolute top-3 left-3 text-[10px] font-bold uppercase tracking-[0.24em] px-2.5 py-1 rounded-full bg-white/90 text-[#003a8f] shadow-sm"><?php echo e($contentLabel); ?></span>
                                    ...
                                    <div class="p-5 sm:p-6 flex flex-col flex-1">
                                        <div class="flex items-center justify-between gap-2 mb-3">
                                            <span class="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-semibold text-slate-600">
                                                <i class="fas fa-clock"></i><?php echo e($lesson->duration_minutes ? $lesson->duration_minutes . ' min' : 'Flexible'); ?>

                                            </span>
                                            <span class="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400">Lesson</span>
                                        </div>
                                        <h3 class="font-display text-lg font-bold text-slate-900 mb-2"><?php echo e($lesson->title); ?></h3>
                                        <p class="text-sm text-slate-600 mb-5 line-clamp-2"><?php echo e($lesson->description ?? 'Open this lesson to access the full learning material.'); ?></p>

                                        <div class="flex flex-wrap gap-2 mt-auto">
                                            <?php if($hasVideo && $resourceUrl): ?>
                                                <a href="<?php echo e($resourceUrl); ?>" target="_blank" rel="noopener" class="mod-sheen inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#003a8f] text-white text-sm font-semibold hover:bg-[#0a2540] transition shadow-sm">
                                                    <i class="fas fa-play"></i> Watch
                                                </a>
                                            <?php endif; ?>
                                            <?php if(($hasPresentation || $hasDocument || $hasImage) && $resourceUrl): ?>
                                                <a href="<?php echo e($resourceUrl); ?>" target="_blank" rel="noopener" class="mod-sheen inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-100 text-slate-800 text-sm font-semibold hover:bg-slate-200 transition">
                    ...
                    <div data-animate class="delay-100 mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Test your knowledge &middot; <?php echo e($quizzes->count()); ?> available</p>
                            </div>
                        </div>
                        <div class="mod-section-divider"></div>
                    </div>
                    ...
                    <?php if($quizzes->count() > 0): ?>
                        <div class="grid gap-4 sm:grid-cols-2 items-stretch" id="quizzes-grid">
                            <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <article
                                    class="quiz-card mod-hover-lift mod-border-glow js-tilt rounded-2xl border overflow-hidden shadow-sm flex flex-col h-full <?php echo e($hasUserPassed ? 'border-green-200 bg-green-50/30' : 'border-gray-100 bg-white'); ?>"
                                    data-animate
                                    data-card-type="quiz"
                                    data-search="<?php echo e(strtolower($quiz->title)); ?>"
                                    style="animation-delay: <?php echo e(min($index * 60, 300)); ?>ms"
                                >
                                    <div class="p-5 sm:p-6 flex flex-col flex-1">
                                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                                            <div>
                                                <div class="flex items-center gap-2 mb-2">
                                                    ...
                                                    <div>
                                                        <h3 class="font-display text-lg font-bold text-gray-800"><?php echo e($quiz->title); ?></h3>
                                                        <p class="text-[11px] uppercase tracking-[0.24em] text-slate-400">Assessment</p>
                                                    </div>
                                                </div>
                                                <?php if($quiz->description): ?>
                                                    <p class="text-gray-600 text-sm mt-1"><?php echo e($quiz->description); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <?php if($hasUserPassed): ?>
                                            ...
                                            <div class="rounded-xl bg-white/80 border border-gray-100 p-3 text-center">
                                                ...
                                                <div class="relative w-11 h-11 mx-auto">
                                                    <svg class="mod-mini-ring" width="44" height="44" viewBox="0 0 44 44">
                                                        <circle cx="22" cy="22" r="<?php echo e($miniRadius); ?>" fill="none" stroke="#e2e8f0" stroke-width="4"></circle>
                                                        <circle class="mod-mini-ring-fill" cx="22" cy="22" r="<?php echo e($miniRadius); ?>" fill="none" stroke="<?php echo e($hasUserPassed ? '#22c55e' : '#003a8f'); ?>" stroke-width="4" stroke-linecap="round" stroke-dasharray="<?php echo e($miniCircumference); ?>" stroke-dashoffset="<?php echo e($miniOffset); ?>"></circle>
                                                    </svg>
                                                    <span class="absolute inset-0 flex items-center justify-center font-display text-[11px] font-bold text-gray-800"><?php echo e($bestScore); ?>%</span>
                                                </div>
                                            </div>
                                            <div class="rounded-xl bg-white/80 border border-gray-100 p-3 text-center">
                                                <p class="text-[10px] uppercase tracking-wider text-gray-500">Tries</p>
                                                <p class="font-display text-xl font-bold text-gray-800"><?php echo e($attemptCount); ?>/<?php echo e($quiz->attempt_limit); ?></p>
                                            </div>
                                            <div class="rounded-xl bg-white/80 border border-gray-100 p-3 text-center">
                                                <p class="text-[10px] uppercase tracking-wider text-gray-500">Pass</p>
                                                <p class="font-display text-xl font-bold text-gray-800"><?php echo e($quiz->passing_score); ?>%</p>
                                            </div>
                                        </div>

                                        <div class="flex flex-wrap gap-3 text-xs text-gray-500 mb-4">
                                            <span><i class="fas fa-list mr-1"></i><?php echo e($quiz->questions()->count()); ?> questions</span>
                                            <?php if($quiz->time_limit_minutes): ?>
                                                <span><i class="fas fa-clock mr-1"></i><?php echo e($quiz->time_limit_minutes); ?> min</span>
                                            <?php endif; ?>
                                        </div>

                                        <div class="flex flex-col sm:flex-row gap-2 mt-auto">
                                            <?php if($canRetry || $attemptCount === 0): ?>
                                                <a href="<?php echo e(route('quizzes.start', [$course->slug, $module->slug, $quiz->slug])); ?>" class="mod-sheen flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-linear-to-r from-[#003a8f] to-[#1e4976] text-white text-sm font-bold hover:shadow-lg transition text-center">
                                                    <?php echo e($attemptCount > 0 ? 'Retry Quiz' : 'Start Quiz'); ?>
                                            ...
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('quizzes.show', [$course->slug, $module->slug, $quiz->slug])); ?>" class="mod-sheen flex-1 inline-flex items-center justify-center px-4 py-3 rounded-xl bg-slate-100 text-slate-800 text-sm font-semibold hover:bg-slate-200 transition text-center">
                                                Details
                                            </a>
                                        </div>
                                    </div>
                ...
                <div data-animate class="delay-150 sticky top-24 space-y-6">
                    ...
                    <div class="mod-sidebar-card rounded-2xl border border-gray-100 overflow-hidden">
                        <div class="px-5 py-4 border-b border-gray-100 bg-slate-50">
                            ...
                            <p class="text-xs text-gray-500 mt-0.5"><?php echo e($totalItems); ?> items in order</p>
                        </div>
                        <nav class="mod-scroll p-2 max-h-80 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = $orderedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="mod-sidebar-card rounded-2xl border border-gray-100 overflow-hidden">
                        ...
                        <nav class="mod-scroll p-2 max-h-64 overflow-y-auto">
                            <?php $__currentLoopData = $course->modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courseModule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a
                                    href="<?php echo e(route('modules.show', [$course->slug, $courseModule->slug])); ?>"
                                    class="mod-sidebar-link flex items-center justify-between gap-2 px-3 py-2.5 rounded-xl text-sm <?php echo e($courseModule->id === $module->id ? 'is-current' : 'text-gray-600'); ?>"
                                >
                                    <span class="truncate"><?php echo e($courseModule->title); ?></span>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (function () {
        ...
        const trackUrl = "<?php echo e(route('modules.trackTime', [$course->slug, $module->slug])); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/courses/modules/show.blade.php ENDPATH**/ ?>