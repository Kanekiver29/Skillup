...
<?php $__env->startSection('title', 'SIAS Login'); ?>
    ...
    <div class="sias-card" id="siasCard">
        ...
        <div class="sias-crest-row">
            <span class="sias-crest">
                <img src="<?php echo e(asset('image/bagong-pilipinas-logo-png_seeklogo-534301.png')); ?>" alt="Bagong Pilipinas" width="34" height="34" loading="eager" decoding="async">
            </span>
            <span class="sias-crest sias-crest--lg">
                <img src="<?php echo e(asset('image/logo new.jpg')); ?>" alt="SkillUp logo" width="42" height="42" loading="eager" decoding="async">
            </span>
            <span class="sias-crest">
                <img src="<?php echo e(asset('image/hello.png')); ?>" alt="TESDA partner logo" width="34" height="34" loading="eager" decoding="async">
            </span>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div class="sias-alert sias-alert--ok" role="status"><?php echo e(session('success')); ?></div>
        ...
        <form method="POST" action="<?php echo e(route('sias.login.submit')); ?>" novalidate id="siasLoginForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="sias-group">
                ...
                <div class="sias-roles" role="tablist" aria-labelledby="roleGroupLabel">
                    ...
                    <button type="button" class="sias-role <?php echo e(old('login_as', $defaultRole ?? 'student') === 'student' ? 'is-active' : ''); ?>" data-role="student" role="tab" aria-selected="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'student' ? 'true' : 'false'); ?>">Student</button>
                    <button type="button" class="sias-role <?php echo e(old('login_as', $defaultRole ?? 'student') === 'teacher' ? 'is-active' : ''); ?>" data-role="teacher" role="tab" aria-selected="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'teacher' ? 'true' : 'false'); ?>">Teacher</button>
                    <button type="button" class="sias-role <?php echo e(old('login_as', $defaultRole ?? 'student') === 'admin' ? 'is-active' : ''); ?>" data-role="admin" role="tab" aria-selected="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'admin' ? 'true' : 'false'); ?>">Admin</button>
                </div>
                <input type="hidden" name="login_as" id="login_as" value="<?php echo e(old('login_as', $defaultRole ?? 'student')); ?>">
            </div>
            ...
            <div class="sias-group">
                ...
                <input
                    id="email"
                    name="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'student' ? 'student_id' : 'email'); ?>"
                    type="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'student' ? 'text' : 'email'); ?>"
                    class="sias-input"
                    value="<?php echo e(old('student_id', old('email'))); ?>"
                    placeholder="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'student' ? 'Enter your Student ID' : 'you@example.com'); ?>"
                    required
                    autocomplete="<?php echo e(old('login_as', $defaultRole ?? 'student') === 'student' ? 'username' : 'email'); ?>"
                >
            </div>
            ...
            <button type="submit" class="sias-submit" id="siasSubmit">
                <span class="sias-submit__label">Sign in as <span id="selectedRoleLabel"><?php echo e(ucfirst(old('login_as', $defaultRole ?? 'student'))); ?></span></span>
        ...
        <div class="sias-foot">
            ...
            <a href="<?php echo e(route('login')); ?>">Refresh</a>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('sias.login.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\login\login.blade.php ENDPATH**/ ?>