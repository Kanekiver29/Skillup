...
<div class="page-card" style="padding:1.5rem;">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:1rem;margin-bottom:2rem;flex-wrap:wrap;">
        ...
        <a href="<?php echo e(route('sias.admin.course.add')); ?>" style="display:inline-flex;align-items:center;gap:.6rem;padding:.85rem 1.2rem;background:#1d4ed8;color:#fff;border-radius:14px;text-decoration:none;font-weight:700;transition:all .2s ease;"><i class="fa-solid fa-plus"></i> New Course</a>
    </div>
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr style="border-bottom:1px solid var(--block-border);transition:background .2s ease;">
                        <td style="padding:1rem;"><strong><?php echo e($course->title); ?></strong></td>
                        <td style="padding:1rem;color:var(--text-muted);"><?php echo e($course->code); ?></td>
                        <td style="padding:1rem;color:var(--text-muted);"><?php echo e($course->department); ?></td>
                        <td style="padding:1rem;"><span style="display:inline-block;background:rgba(29,78,216,.1);color:#1d4ed8;padding:.35rem .75rem;border-radius:6px;font-size:.85rem;font-weight:600;"><?php echo e($course->subjects_count ?? 0); ?></span></td>
                        <td style="padding:1rem;text-align:center;">
                            <div style="display:flex;gap:.5rem;justify-content:center;">
                                <a href="<?php echo e(route('sias.admin.course.edit', $course->id)); ?>" style="display:inline-flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:8px;background:rgba(29,78,216,.1);color:#1d4ed8;text-decoration:none;transition:all .2s ease;font-size:.85rem;" title="Edit"><i class="fa-solid fa-pen"></i></a>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\course\course\course.blade.php ENDPATH**/ ?>