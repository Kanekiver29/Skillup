...
<div class="cr-page">
    ...
    <?php if($courses->count()): ?>
        <div class="cr-card cr-animate cr-hud" style="animation-delay:110ms">
            ...
            <?php if(method_exists($courses, 'hasPages') && $courses->hasPages()): ?>
            <div class="cr-pagination">
                <span class="cr-pagination__info">
                    <?php if(method_exists($courses,'firstItem')): ?>
                ...
                <div class="cr-pagination__pages">
                    ...
                    <?php if(method_exists($courses,'getUrlRange')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/courses/index.blade.php ENDPATH**/ ?>