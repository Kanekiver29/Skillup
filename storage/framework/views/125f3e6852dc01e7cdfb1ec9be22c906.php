<?php $__env->startSection('title', 'Syllabi Management'); ?>

<?php $__env->startSection('content'); ?>
<style>
/* ═══════════════════════════════════════════════════════
   SYLLABI INDEX — Ultra-polished console UI
...
<div class="syl-wrap" style="position:relative; min-height:100vh; padding: 1.5rem 1.5rem 3rem;">
    ...
    <div class="syl-page-header">
        <div>
            <h1 class="syl-heading">Syllabi Management</h1>
            <p class="syl-sub">Create, publish, and maintain course syllabi in one place.</p>
        </div>
        <a href="<?php echo e(route('staff.syllabi.create')); ?>" class="syl-new-btn">
    ...
    <!-- Stats strip -->
    <?php
        $total     = $syllabi->total() ?? $syllabi->count();
        $published = $syllabi->getCollection()->where('is_published', true)->count();
        $drafts    = $syllabi->getCollection()->where('is_published', false)->count();
    ?>
    <div class="syl-stats">
        <div class="syl-stat-card">
            ...
            <div>
                <div class="syl-stat-val" style="color:#818CF8;"><?php echo e($total); ?></div>
        ...
        <div class="syl-stat-card">
            ...
            <div>
                <div class="syl-stat-val" style="color:#34D399;"><?php echo e($published); ?></div>
                <div class="syl-stat-lbl">Published</div>
            </div>
        </div>
        <div class="syl-stat-card">
            ...
            <div>
                <div class="syl-stat-val" style="color:#94A3B8;"><?php echo e($drafts); ?></div>
                <div class="syl-stat-lbl">Drafts</div>
            </div>
        </div>
    </div>
        ...
        <div class="syl-panel-content">
            ...
            <div class="syl-toolbar">
                <div class="syl-toolbar-left">
                    ...
                    <span class="syl-toolbar-title">syllabi.index — <?php echo e($total); ?> <?php echo e(Str::plural('record', $total)); ?></span>
                </div>
            ...
            <div style="overflow-x:auto;">
                <table class="syl-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $syllabi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $syllabus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="syl-row" style="--i:<?php echo e($loop->index); ?>;">
                                <td>
                                    <span class="syl-course-pill">
                                        <?php echo e($syllabus->course->title ?? '—'); ?>

                                    </span>
                                </td>
                                <td style="color:#CBD5E1; font-weight:500;"><?php echo e($syllabus->title); ?></td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syllabus->is_published): ?>
                                        <span class="syl-badge syl-badge-live">
                                            <span class="syl-status-dot"></span> Published
                                        </span>
                                    <?php else: ?>
                                        <span class="syl-badge syl-badge-draft">
                                            <span class="syl-status-dot"></span> Draft
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syllabus->effective_start): ?>
                                        <span class="syl-date">
                                            <?php echo e($syllabus->effective_start->format('M d, Y')); ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syllabus->effective_end): ?>
                                                <span class="syl-date-arrow">→</span><?php echo e($syllabus->effective_end->format('M d, Y')); ?>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; justify-content:center; gap:4px;">
                                        ...
                                        <a href="<?php echo e(route('staff.syllabi.edit', $syllabus)); ?>"
                                        ...
                                        <form action="<?php echo e(route('staff.syllabi.publish', $syllabus)); ?>"
                                              method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
                                                    class="syl-act <?php echo e($syllabus->is_published ? 'syl-act-unpub' : 'syl-act-pub'); ?>"
                                                    data-tip="<?php echo e($syllabus->is_published ? 'Unpublish' : 'Publish'); ?>">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syllabus->is_published): ?>
                                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <form action="<?php echo e(route('staff.syllabi.destroy', $syllabus)); ?>"
                                              method="POST" style="display:inline;"
                                              onsubmit="return confirm('Permanently delete this syllabus?');">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <tr>
                                <td colspan="5" class="syl-empty">
                                    ...
                                    <p style="font-weight:600; color:#94A3B8; margin-bottom:4px;">No syllabi yet</p>
                                    <p style="font-size:0.78rem; color:#4B5563;">Get started by creating your first syllabus.</p>
                                </td>
                            </tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tbody>
    ...
    <!-- Pagination -->
    <div><?php echo e($syllabi->links()); ?></div>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\sysllabus\index.blade.php ENDPATH**/ ?>