...
<div class="dr-wrapper">
    ...
    <div class="dr-header">
        ...
        <div class="dr-header__actions">
            ...
            <a href="<?php echo e(route('staff.reports.daily')); ?>"
    ...
    <div class="stat-grid">
        <div class="stat-card stat-card--blue">
            ...
            <div class="stat-card__value" data-count="<?php echo e($daily['present'] ?? 0); ?>"><?php echo e($daily['present'] ?? 0); ?></div>
        ...
        <div class="stat-card stat-card--red">
            ...
            <div class="stat-card__value" data-count="<?php echo e($daily['absent'] ?? 0); ?>"><?php echo e($daily['absent'] ?? 0); ?></div>
        ...
        <div class="stat-card stat-card--green">
            ...
            <div class="stat-card__value" data-count="<?php echo e($daily['new_registrations'] ?? 0); ?>"><?php echo e($daily['new_registrations'] ?? 0); ?></div>
        ...
        <div class="stat-card stat-card--blue">
            ...
            <div class="stat-card__value" data-count="<?php echo e($daily['classes_conducted'] ?? 0); ?>"><?php echo e($daily['classes_conducted'] ?? 0); ?></div>
        ...
        <div class="stat-card stat-card--warn">
            ...
            <div class="stat-card__value"><?php echo e(round($daily['training_hours'] ?? 0, 1)); ?><span style="font-size:14px;font-weight:600;color:var(--ink-faint)">h</span></div>
        ...
        <div class="stat-card stat-card--green">
            ...
            <div class="stat-card__value" data-count="<?php echo e($daily['practical_completed'] ?? 0); ?>"><?php echo e($daily['practical_completed'] ?? 0); ?></div>
            <div class="stat-card__sub">Completed today</div>
        </div>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($daily['concerns']) && count($daily['concerns'])): ?>
    <div class="section-card delay-1" style="margin-bottom:16px;">
        <div class="section-card__head">
            ...
            <span style="margin-left:auto;font-size:11px;font-weight:700;background:#fee2e2;color:#dc2626;border-radius:999px;padding:2px 10px;">
                <?php echo e(count($daily['concerns'])); ?>

            </span>
        </div>
        <div class="section-card__body">
            <ul class="dr-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $daily['concerns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <li>
                        <span class="dr-list__dot" style="background:#dc2626;"></span>
                        <span><?php echo e(is_object($c) ? ($c->issue ?? json_encode($c)) : $c); ?></span>
                    </li>
        ...
        <div class="section-card delay-2">
            ...
            <div class="section-card__body">
                <div class="data-row">
                    ...
                    <span class="data-row__value"><?php echo e($daily['classes_conducted'] ?? 0); ?></span>
                </div>
                <div class="data-row">
                    <span class="data-row__label">Training hours</span>
                    <span class="data-row__value"><?php echo e(round($daily['training_hours'] ?? 0, 2)); ?>h</span>
                </div>
                <div class="data-row">
                    <span class="data-row__label">Practical activities</span>
                    <span class="data-row__value"><?php echo e($daily['practical_completed'] ?? 0); ?></span>
                </div>

                <?php $modules = $daily['modules_discussed'] ?? collect(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($modules)): ?>
                        ...
                        <ul class="dr-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <li>
                                    ...
                                    <span><?php echo e(is_object($m) ? ($m->module ?? json_encode($m)) : (is_array($m) ? json_encode($m) : $m)); ?></span>
                                </li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </ul>
                    </div>
        ...
        <div class="section-card delay-3">
            ...
            <div class="section-card__body">
                <div class="data-row">
                    ...
                    <span class="data-row__value"><?php echo e($daily['assessments_conducted'] ?? 0); ?></span>
                </div>
                <div class="data-row">
                    <span class="data-row__label">Trainees assessed</span>
                    <span class="data-row__value"><?php echo e($daily['trainees_assessed'] ?? 0); ?></span>
                </div>
                ...
                <div class="pass-fail-bar">
                    ...
                    <div class="pass-fail-bar__track">
                        <div class="pass-fail-bar__fill" style="width:<?php echo e($passRate); ?>%" data-width="<?php echo e($passRate); ?>"></div>
                    </div>
                    <div class="pass-fail-labels">
                        <span class="pass">✓ Passed: <?php echo e($passed); ?>  (<?php echo e($passRate); ?>%)</span>
                        <span class="fail">✗ Failed: <?php echo e($failed); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="section-card__body">
                <div class="cert-progress">
                    <div class="cert-block cert-block--processed">
                        <div class="cert-block__num"><?php echo e($daily['certificates_processed'] ?? 0); ?></div>
                        <div class="cert-block__label">Processed</div>
                    </div>
                    <div class="cert-block cert-block--released">
                        <div class="cert-block__num"><?php echo e($daily['certificates_released'] ?? 0); ?></div>
                        <div class="cert-block__label">Released</div>
                    </div>
                    <div class="cert-block cert-block--pending">
                        <div class="cert-block__num"><?php echo e($daily['certificates_pending'] ?? 0); ?></div>
        ...
        <div class="section-card delay-4">
            ...
            <div class="section-card__body">
                <div class="data-row">
                    ...
                    <span class="data-row__value"><?php echo e($daily['trainers_present'] ?? 0); ?></span>
                </div>

                <?php $schedules = $daily['trainer_schedules'] ?? collect(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($schedules)): ?>
                        ...
                        <ul class="dr-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <li>
                                    ...
                                    <span><?php echo e(is_object($s) ? ($s->summary ?? json_encode($s)) : (is_array($s) ? json_encode($s) : $s)); ?></span>
                                </li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </ul>
                    </div>
        ...
        <div class="section-card delay-5">
            ...
            <div class="section-card__body">
                <div class="data-row">
                    ...
                    <span class="data-row__value"><?php echo e($daily['documents_processed'] ?? 0); ?></span>
                </div>
                <div class="data-row">
                    <span class="data-row__label">Reports submitted</span>
                    <span class="data-row__value"><?php echo e($daily['reports_submitted'] ?? 0); ?></span>
                </div>
                <div class="data-row">
                    <span class="data-row__label">Meetings attended</span>
                    <span class="data-row__value"><?php echo e($daily['meetings_attended'] ?? 0); ?></span>
                </div>
                <div class="data-row">
                    <span class="data-row__label">Inventory updates</span>
                    <span class="data-row__value"><?php echo e($daily['inventory_updates'] ?? 0); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-card delay-5" style="margin-bottom:16px;">
        <div class="section-card__head">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($daily['issues']) && count($daily['issues'])): ?>
                <span style="margin-left:auto;font-size:11px;font-weight:700;background:var(--danger-lt);color:var(--danger);border-radius:999px;padding:2px 10px;">
                    <?php echo e(count($daily['issues'])); ?> issue<?php echo e(count($daily['issues']) !== 1 ? 's' : ''); ?>
        ...
        <div class="section-card__body">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($daily['issues']) && count($daily['issues'])): ?>
                <div class="space-y">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $daily['issues']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="issue-item">
                            <span style="flex-shrink:0;margin-top:1px;">⚠️</span>
                            <span><?php echo e(is_object($i) ? ($i->issue ?? json_encode($i)) : $i); ?></span>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            <?php else: ?>
        ...
        <div class="section-card__body">
            ...
            <div style="display:flex;gap:24px;flex-wrap:wrap;padding-bottom:16px;margin-bottom:16px;border-bottom:1px solid var(--border);">
                <div>
                    ...
                    <div style="font-size:26px;font-weight:800;letter-spacing:-.04em;"><?php echo e($daily['total_present'] ?? 0); ?></div>
                </div>
                <div>
                    ...
                    <div style="font-size:26px;font-weight:800;letter-spacing:-.04em;"><?php echo e($daily['total_activities'] ?? 0); ?></div>
                </div>
            </div>
            ...
            <div class="summary-footer">
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($daily['accomplishments']) && count($daily['accomplishments'])): ?>
                        <div class="ach-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $daily['accomplishments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($daily['recommendations']) && count($daily['recommendations'])): ?>
                        <div class="ach-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $daily['recommendations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\reports\daily.blade.php ENDPATH**/ ?>