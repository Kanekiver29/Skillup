...
<div class="dash-wrap">
    ...
    <section class="hero-card" aria-label="Welcome hero">
        <div>
            ...
            <h2>Welcome back, <?php echo e(auth()->user()->name ?? 'Instructor'); ?></h2>
            <p>Manage your courses, modules, and student progress from one polished workspace.</p>
        </div>
        <div class="hero-actions">
            <a href="<?php echo e(route('teacher.courses.index')); ?>" class="btn-primary">
                Manage courses <span class="btn-icon">→</span>
            </a>
            <a href="<?php echo e(route('teacher.modules.index')); ?>" class="btn-secondary">
        ...
        <div class="panel" aria-label="Quick actions">
            ...
            <ul class="action-list">
                <li class="action-item">
                    <a href="<?php echo e(route('teacher.courses.index')); ?>" class="action-link">
                ...
                <li class="action-item">
                    <a href="<?php echo e(route('teacher.modules.index')); ?>" class="action-link">
...
<?php echo $__env->make('teacher.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>