    ...
    <div style="max-width:760px; margin:0 auto; position:relative; z-index:2;">
        ...
        <div style="display:flex; align-items:flex-start; justify-content:space-between; margin-bottom:1.5rem; gap:1rem;">
            <div>
                ...
                <p class="syl-sub">Editing: <strong style="color:#CBD5E1;"><?php echo e($syllabus->title); ?></strong></p>
            </div>
            <a href="<?php echo e(route('staff.syllabi.index')); ?>" class="syl-back" style="flex-shrink:0;">
        ...
        <div class="syl-panel">
            ...
            <div class="syl-toolbar">
                <div style="display:flex; align-items:center;">
                    ...
                    <span class="syl-toolbar-title">syllabi.edit — #<?php echo e($syllabus->id); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($syllabus->is_published): ?>
            ...
            <div class="syl-panel-content">
                <form action="<?php echo e(route('staff.syllabi.update', $syllabus)); ?>" method="POST"
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;" class="responsive-grid">
                            ...
                            <select name="course_id" id="course_id" class="syl-select" required>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($course->id); ?>"
                                        <?php echo e((old('course_id') ?? $syllabus->course_id) == $course->id ? 'selected' : ''); ?>>
                        ...
                        <div class="syl-field" style="--fi:1;">
                            ...
                            <input type="text" name="title" id="title"
                                   value="<?php echo e(old('title') ?? $syllabus->title); ?>"
                    ...
                    <div class="syl-field" style="--fi:2; margin-top:1rem;">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="syl-textarea"><?php echo e(old('description') ?? $syllabus->description); ?></textarea>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-top:1rem;" class="responsive-grid">
                        <div class="syl-field" style="--fi:3;">
                            ...
                            <input type="date" name="effective_start" id="effective_start"
                                   value="<?php echo e(old('effective_start') ?? ($syllabus->effective_start ? $syllabus->effective_start->format('Y-m-d') : '')); ?>"
                                   class="syl-input"/>
                        </div>
                        <div class="syl-field" style="--fi:4;">
                            ...
                            <input type="date" name="effective_end" id="effective_end"
                                   value="<?php echo e(old('effective_end') ?? ($syllabus->effective_end ? $syllabus->effective_end->format('Y-m-d') : '')); ?>"
                                   class="syl-input"/>
                        </div>
                    </div>
                    ...
                    <div class="syl-field" style="--fi:5; margin-top:1.1rem;">
                        <label class="syl-toggle">
                            <input type="checkbox" name="is_published" value="1" id="is_published"
                                   <?php echo e((old('is_published') ?? $syllabus->is_published) ? 'checked' : ''); ?>/>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(old('sections')): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = old('sections'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="section-card" data-index="<?php echo e($i); ?>">
                                    <input type="hidden" name="sections[<?php echo e($i); ?>][id]" value="<?php echo e($section['id'] ?? ''); ?>"/>
                                    ...
                                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem;" class="responsive-grid">
                                        <div>
                                            ...
                                            <input type="text" name="sections[<?php echo e($i); ?>][section_title]"
                                                   value="<?php echo e($section['section_title'] ?? ''); ?>" class="syl-input" required/>
                                        </div>
                                        <div>
                                            <label class="syl-label">Content</label>
                                            <textarea name="sections[<?php echo e($i); ?>][content]" rows="2"
                                                      class="syl-textarea"><?php echo e($section['content'] ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <?php else: ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $syllabus->sections()->orderBy('order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="section-card" data-index="<?php echo e($i); ?>">
                                    <input type="hidden" name="sections[<?php echo e($i); ?>][id]" value="<?php echo e($section->id); ?>"/>
                                    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:0.65rem;">
                                        <div style="display:flex; align-items:center; gap:6px;">
                        ...
                        <div class="syl-field" style="--fi:6;">
                            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:0.5rem;">
                                ...
                                <span class="media-counter" id="photo-counter">
                                    ...
                                    <?php echo e(count($syllabus->photos ?? [])); ?> / 25
                                </span>
                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($syllabus->photos)): ?>
                                <input type="hidden" name="existing_photos" id="existing-photos-field"
                                       value="<?php echo e(json_encode($syllabus->photos)); ?>"/>
                                <div class="media-grid" id="existing-photo-grid">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $syllabus->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pi => $pPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="media-tile" id="ep-<?php echo e($pi); ?>">
                                            <img src="<?php echo e(Storage::url($pPath)); ?>" alt="Photo <?php echo e($pi + 1); ?>">
                                            <div class="tile-label">existing</div>
                                            <button type="button" class="media-rm existing-photo-rm"
                                                    data-index="<?php echo e($pi); ?>" title="Remove">×</button>
                                        </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="syl-field" style="--fi:7;">
                            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:0.5rem;">
                                ...
                                <span class="media-counter" id="video-counter">
                                    ...
                                    <?php echo e(count($syllabus->videos ?? [])); ?> / 3
                                </span>
                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($syllabus->videos)): ?>
                                <input type="hidden" name="existing_videos" id="existing-videos-field"
                                       value="<?php echo e(json_encode($syllabus->videos)); ?>"/>
                                <div class="media-grid" id="existing-video-grid">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $syllabus->videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vi => $vPath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="media-tile" id="ev-<?php echo e($vi); ?>">
                                            <div class="media-tile-video">
                                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                          d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                                </svg>
                                                <span>Video <?php echo e($vi + 1); ?></span>
                                            </div>
                                            <div class="tile-label">existing</div>
                                            <button type="button" class="media-rm existing-video-rm"
                                                    data-index="<?php echo e($vi); ?>" title="Remove">×</button>
                                        </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                            <?php else: ?>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\sysllabus\edit.blade.php ENDPATH**/ ?>