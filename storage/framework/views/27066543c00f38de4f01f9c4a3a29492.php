...
<div class="dash-scope">
  ...
  <div class="dash-stat-grid">
    ...
    <div class="admin-panel dash-stat-card dash-stat-hero" style="--i: 0">
      <div class="dash-stat-hero-sparkline" aria-hidden="true">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $monthlyEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <span style="--h: <?php echo e(max(6, ($count / (max($monthlyEnrollments) ?: 1)) * 100)); ?>%; --i: <?php echo e($i); ?>;"></span>
      ...
      <div class="dash-stat-head">
        <div>
          ...
          <h3 class="dash-stat-value dash-stat-value-lg" data-countup="<?php echo e($userCount); ?>">0</h3>
        </div>
        <div class="dash-stat-icon">👥</div>
      </div>
      <p class="dash-stat-foot">
        <strong class="dash-text-ok">+<?php echo e($newSignupsToday); ?></strong> new today
      </p>
    </div>
    ...
    <div class="admin-panel dash-stat-card" style="--i: 1">
      <div class="dash-stat-head">
        <div>
          ...
          <h3 class="dash-stat-value" data-countup="<?php echo e($activeCourses); ?>">0</h3>
        </div>
        <div class="dash-stat-icon">📚</div>
      </div>
      <a href="<?php echo e(route('sias.admin.course')); ?>" class="dash-stat-link">View all courses <span class="dash-arrow">→</span></a>
    </div>
    ...
    <div class="admin-panel dash-stat-card" style="--i: 2">
      <div class="dash-stat-head">
        <div>
          ...
          <h3 class="dash-stat-value" data-countup="<?php echo e($enrollmentCount); ?>">0</h3>
        </div>
        <div class="dash-stat-icon">✅</div>
      </div>
      <a href="<?php echo e(route('sias.admin.enrollments')); ?>" class="dash-stat-link">Manage enrollments <span class="dash-arrow">→</span></a>
    </div>
    ...
    <div class="admin-panel dash-stat-card" style="--i: 3">
      <div>
        ...
        <h3 class="dash-stat-value" data-countup="<?php echo e($progress); ?>" data-suffix="%">0%</h3>
      </div>
      <div class="dash-track dash-track-lg" role="progressbar" aria-valuenow="<?php echo e($progress); ?>" aria-valuemin="0" aria-valuemax="100" aria-label="System progress">
        <div class="dash-fill" style="--w: <?php echo e($progress); ?>%;"></div>
      </div>
    </div>
  </div>
  ...
  <div class="dash-chart-grid">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $monthlyEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="dash-bar-col">
            <div class="dash-bar dash-bar-accent"
                 style="height: <?php echo e(max(10, ($count / (max($monthlyEnrollments) ?: 1)) * 150)); ?>px; --i: <?php echo e($i); ?>;"
                 title="<?php echo e($count); ?> enrollments"></div>
            <small class="dash-bar-label"><?php echo e($chartLabels[$i]); ?></small>
          </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
      </div>
    </div>
    ...
    <div class="admin-card" style="--i: 5">
      ...
      <div class="dash-bars">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dailyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="dash-bar-col">
            <div class="dash-bar dash-bar-green"
                 style="height: <?php echo e(max(10, ($count / (max($dailyData) ?: 1)) * 150)); ?>px; --i: <?php echo e($i); ?>;"
                 title="<?php echo e($count); ?> enrollments"></div>
            <small class="dash-bar-label"><?php echo e($dailyLabels[$i]); ?></small>
          </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
      </div>
    </div>
    ...
    <div class="admin-card" style="--i: 6">
      ...
      <div class="dash-bars">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $weeklyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="dash-bar-col">
            <div class="dash-bar dash-bar-amber"
                 style="height: <?php echo e(max(10, ($count / (max($weeklyData) ?: 1)) * 150)); ?>px; --i: <?php echo e($i); ?>;"
                 title="<?php echo e($count); ?> enrollments"></div>
            <small class="dash-bar-label"><?php echo e($weeklyLabels[$i]); ?></small>
          </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
      </div>
    </div>
    ...
    <div class="admin-card" style="--i: 7">
      ...
      <div class="dash-category-list">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $collegeLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="dash-category-row" style="--i: <?php echo e($i); ?>;">
            <div class="dash-category-head">
              <span class="dash-category-name"><?php echo e($label); ?></span>
              <span class="dash-category-count"><?php echo e($collegeData[$i]); ?></span>
            </div>
            <div class="dash-track">
              <div class="dash-fill" style="--w: <?php echo e(max(0, ($collegeData[$i] / (max($collegeData) ?: 1)) * 100)); ?>%;"></div>
            </div>
          </div>
    ...
    <div class="admin-card" style="--i: 8">
      ...
      <div class="dash-bars dash-bars-wide">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $yearlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="dash-bar-col">
            <div class="dash-bar dash-bar-violet"
                 style="height: <?php echo e(max(10, ($count / (max($yearlyData) ?: 1)) * 150)); ?>px; --i: <?php echo e($i); ?>;"
                 title="<?php echo e($count); ?> enrollments"></div>
            <small class="dash-bar-label"><?php echo e($yearlyLabels[$i]); ?></small>
          </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
      </div>
    </div>
  ...
  <div class="dash-split-grid">
    ...
    <div class="admin-card" style="--i: 9">
      ...
      <div class="dash-activity-list">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <div class="dash-activity-item" style="--i: <?php echo e($i); ?>;">
            <div class="dash-avatar-wrap">
              <div class="dash-avatar"><?php echo e(strtoupper(substr($user->name ?? '?', 0, 1))); ?></div>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$loop->last): ?><span class="dash-timeline-line"></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="dash-activity-info">
              <p class="dash-activity-name"><?php echo e($user->name); ?></p>
              <p class="dash-activity-email"><?php echo e($user->email); ?></p>
            </div>
            <div class="dash-activity-time"><?php echo e($user->created_at->diffForHumans()); ?></div>
          </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
  ...
  <div class="admin-card" style="--i: 11">
    ...
    <div class="dash-bars dash-bars-tall">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $monthlySignups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $signups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="dash-bar-col">
          <div class="dash-bar-pair">
            <div class="dash-bar dash-bar-thin dash-bar-cyan"
                 style="height: <?php echo e(max(5, ($signups / (max($monthlySignups) ?: 1)) * 150)); ?>px; --i: <?php echo e($i); ?>;"
                 title="Signups: <?php echo e($signups); ?>"></div>
            <div class="dash-bar dash-bar-thin dash-bar-purple"
                 style="height: <?php echo e(max(5, ($monthlyEnrollments[$i] / (max($monthlyEnrollments) ?: 1)) * 150)); ?>px; --i: <?php echo e($i); ?>;"
                 title="Enrollments: <?php echo e($monthlyEnrollments[$i]); ?>"></div>
          </div>
          <small class="dash-bar-label"><?php echo e($chartLabels[$i]); ?></small>
        </div>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<script>
  ...
  function refreshDashboardData() {
    fetch('<?php echo e(route("admin.liveData")); ?>', {
      method: 'GET',
      headers: {
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\dashboard.blade.php ENDPATH**/ ?>