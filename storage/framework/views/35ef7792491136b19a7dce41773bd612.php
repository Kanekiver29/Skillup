...
<?php $__env->startSection('title', 'Excel Reports – SkillUp Admin'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
            ...
            <div class="bg-white rounded-lg border border-gray-100 shadow-sm p-5 hover:shadow-md transition-all">
                ...
                <p class="text-2xl font-bold text-gray-900 stat-total-users"><?php echo e($stats['total_users']); ?></p>
            ...
            <div class="bg-white rounded-lg border border-gray-100 shadow-sm p-5 hover:shadow-md transition-all">
                ...
                <p class="text-2xl font-bold text-gray-900 stat-total-courses"><?php echo e($stats['total_courses']); ?></p>
                <p class="text-xs text-gray-400 mt-1">Live count</p>
            </div>
            ...
            <div class="bg-white rounded-lg border border-gray-100 shadow-sm p-5 hover:shadow-md transition-all">
                ...
                <p class="text-2xl font-bold text-gray-900 stat-total-enrollments"><?php echo e($stats['total_enrollments']); ?></p>
                <p class="text-xs text-gray-400 mt-1">Live count</p>
            </div>
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden hover:shadow-lg transition-all">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <button onclick="window.location.href='<?php echo e(route('admin.excel.export-users')); ?>'"
            ...
            <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden hover:shadow-lg transition-all">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <button onclick="window.location.href='<?php echo e(route('admin.excel.export-users-courses')); ?>'"
            ...
            <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden hover:shadow-lg transition-all">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <button onclick="window.location.href='<?php echo e(route('admin.excel.export-enrollment')); ?>'"
...
function loadRealTimeData() {
    ...
    fetch('<?php echo e(route("admin.excel.realtime-data")); ?>')
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\users\excel-reports.blade.php ENDPATH**/ ?>