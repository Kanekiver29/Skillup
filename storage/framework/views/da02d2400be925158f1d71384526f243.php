            ...
            <tr class="border-b hover:bg-gray-50 transition <?php echo e($user->trashed() ? 'bg-red-50 opacity-75' : ''); ?>">
              ...
              <td class="px-6 py-4 text-right text-sm space-x-2">
                ...
                <?php else: ?>
                  ...
                  <form action="<?php echo e(route('admin.users.archive', $user)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure? This will archive the user account.');">
                 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\dashboard1.blade.php ENDPATH**/ ?>