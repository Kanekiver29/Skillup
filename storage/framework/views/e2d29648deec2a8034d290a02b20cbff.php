...
<?php $__env->startSection('title', 'Privacy Policy - SkillUp Admin'); ?>
        ...
        <div class="space-y-10">
            ...
            <div id="your-rights" class="scroll-mt-24 bg-white border border-gray-100 rounded-xl shadow-sm p-7">
                ...
                <div class="text-sm text-gray-600 leading-relaxed space-y-2 pl-13">
                    ...
                    <ul class="space-y-2 mt-2">
                        <li class="flex items-start gap-3"><i class="fas fa-check text-cyan-500 mt-0.5 shrink-0"></i><span>Access and update your own profile information via <a href="<?php echo e(route('admin.profile')); ?>" class="text-cyan-600 underline">Admin Profile</a>.</span></li>
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\Legal\privacy.blade.php ENDPATH**/ ?>