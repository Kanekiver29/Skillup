...
<?php $__env->startSection('title', 'Student Enrollment'); ?>
<?php $__env->startSection('page_title', 'Student Enrollment'); ?>
<?php $__env->startSection('subtitle', 'Overview of student subject assignments.'); ?>

<?php $__env->startSection('content'); ?>
<div class="admin-card">
    <div class="admin-actions" style="margin-top:0; margin-bottom:1.25rem;">
        <a href="<?php echo e(route('sias.admin.enrollment.add')); ?>" class="btn-black"><span data-i18n="add_subject">Add Subject</span></a>
        <a href="<?php echo e(route('sias.admin.enrollments')); ?>" class="btn-white"><span data-i18n="back_to_list">Back to List</span></a>
    </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding:.85rem .75rem;">
                            <a href="<?php echo e(route('sias.admin.enrollment.edit', 1)); ?>" class="btn-white" style="padding:.55rem .8rem; font-size:.85rem;" data-i18n="edit">Edit</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding:.85rem .75rem;">
                            <a href="<?php echo e(route('sias.admin.enrollment.edit', 2)); ?>" class="btn-white" style="padding:.55rem .8rem; font-size:.85rem;" data-i18n="edit">Edit</a>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\enrollment\enrollement.blade.php ENDPATH**/ ?>