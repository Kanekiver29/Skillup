...
<div class="page-card" style="padding:1.5rem;">
    ...
    <form method="POST" action="<?php echo e(route('sias.admin.subject.update', $subject->id)); ?>" class="section-card" style="display:grid;gap:1.5rem;max-width:800px;">
        <?php echo csrf_field(); ?>
        ...
        <details class="form-section-toggle" open>
            ...
            <div style="padding:1.5rem;display:grid;gap:1rem;animation:slideDown .3s var(--ease) forwards;">
                <div style="display:grid;gap:.35rem;">
                    ...
                    <select name="course_id" class="form-input" required>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($course->id); ?>" <?php echo e(old('course_id', $subject->course_id) == $course->id ? 'selected' : ''); ?>><?php echo e($course->title); ?> (<?php echo e($course->code); ?>)</option>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </select>
                </div>
                ...
                <div style="display:grid;gap:.35rem;">
                    ...
                    <input name="title" type="text" class="form-input" placeholder="" data-i18n-placeholder="e_g_introduction_programming" value="<?php echo e(old('title', $subject->title)); ?>" required>
                </div>
                ...
                <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem;">
                    <div style="display:grid;gap:.35rem;">
                        ...
                        <input name="code" type="text" class="form-input" placeholder="" data-i18n-placeholder="e_g_cs101" value="<?php echo e(old('code', $subject->code)); ?>" required>
                    </div>
                    <div style="display:grid;gap:.35rem;">
                        <label style="font-weight:600;color:var(--text);">
                            <span data-i18n="credit_units">Credit Units</span> <span style="color:#dc2626;">*</span>
                        </label>
                        <input name="units" type="number" class="form-input" placeholder="" data-i18n-placeholder="e_g_3" min="1" max="6" value="<?php echo e(old('units', $subject->units ?? 3)); ?>" required>
                    </div>
                </div>

                <div style="display:grid;gap:.35rem;">
                    <label style="font-weight:600;color:var(--text);" data-i18n="description">Description</label>
                    <textarea name="description" rows="4" class="form-input" placeholder="" data-i18n-placeholder="subject_description_objectives"><?php echo e(old('description', $subject->description)); ?></textarea>
                </div>
            </div>
        </details>
            ...
            <div style="padding:1.5rem;display:grid;gap:1rem;animation:slideDown .3s var(--ease) forwards;">
                <div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem;">
                    <div style="display:grid;gap:.35rem;">
                        ...
                        <select name="year_level" class="form-input" required>
                            ...
                            <option value="1" <?php echo e(old('year_level', $subject->year_level) == 1 ? 'selected' : ''); ?>>1st Year</option>
                            <option value="2" <?php echo e(old('year_level', $subject->year_level) == 2 ? 'selected' : ''); ?>>2nd Year</option>
                            <option value="3" <?php echo e(old('year_level', $subject->year_level) == 3 ? 'selected' : ''); ?>>3rd Year</option>
                            <option value="4" <?php echo e(old('year_level', $subject->year_level) == 4 ? 'selected' : ''); ?>>4th Year</option>
                        </select>
                    </div>
                    <div style="display:grid;gap:.35rem;">
                        ...
                        <select name="semester" class="form-input">
                            ...
                            <option value="1" <?php echo e(old('semester', $subject->semester) == 1 ? 'selected' : ''); ?>>1st Semester</option>
                            <option value="2" <?php echo e(old('semester', $subject->semester) == 2 ? 'selected' : ''); ?>>2nd Semester</option>
                            <option value="3" <?php echo e(old('semester', $subject->semester) == 3 ? 'selected' : ''); ?>>Summer</option>
                        </select>
                    </div>
                    <div style="display:grid;gap:.35rem;">
                        <label style="font-weight:600;color:var(--text);">Lecture Hours</label>
                        <input name="lecture_hours" type="number" class="form-input" placeholder="e.g. 3" min="0" value="<?php echo e(old('lecture_hours', $subject->lecture_hours ?? 3)); ?>">
                    </div>
                </div>
                ...
                <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem;">
                    <div style="display:grid;gap:.35rem;">
                        ...
                        <input name="lab_hours" type="number" class="form-input" placeholder="e.g. 2" min="0" value="<?php echo e(old('lab_hours', $subject->lab_hours ?? 0)); ?>">
                    </div>
                    <div style="display:grid;gap:.35rem;">
                        <label style="font-weight:600;color:var(--text);">
                            <input type="checkbox" name="is_required" value="1" <?php echo e(old('is_required', $subject->is_required) ? 'checked' : ''); ?> style="width:1rem;height:1rem;margin-right:.5rem;cursor:pointer;">
                            Required Subject
                        </label>
                    </div>
                </div>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\course\subject\edit.blade.php ENDPATH**/ ?>