<?php $__env->startSection('title', 'Create Teacher — SIAS Admin'); ?>
<?php $__env->startSection('page_title', 'Add New Teacher'); ?>
<?php $__env->startSection('subtitle', 'Create a new faculty account or promote an existing student to the teaching staff.'); ?>
...
<div class="tm-form-card">
  ...
  <form action="<?php echo e(route('sias.admin.teachers.store')); ?>" method="POST" id="teacherForm">
    <?php echo csrf_field(); ?>
      ...
      <div class="tm-form-group" style="margin-bottom: 20px;">
        ...
        <select name="user_id" id="userIdSelect" class="tm-select">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <option value="<?php echo e($student->id); ?>" <?php echo e(old('user_id') == $student->id ? 'selected' : ''); ?>>
    ...
    <div id="newAccountSection">
      ...
      <div class="tm-form-grid">
        <div class="tm-form-group">
          ...
          <input type="text" name="name" id="inputName" value="<?php echo e(old('name')); ?>" class="tm-input" placeholder="e.g. Dr. Maria Santos" />
        </div>

        <div class="tm-form-group">
          <label class="tm-label">Email Address <span class="req">*</span></label>
          <input type="email" name="email" id="inputEmail" value="<?php echo e(old('email')); ?>" class="tm-input" placeholder="e.g. maria.santos@skillup.edu" />
        </div>
    ...
    <div class="tm-form-group" style="max-width: 380px;">
      ...
      <select name="staff_type" class="tm-select">
        <option value="teacher" <?php echo e(old('staff_type', 'teacher') === 'teacher' ? 'selected' : ''); ?>>Teacher (Regular Faculty)</option>
        <option value="instructor" <?php echo e(old('staff_type') === 'instructor' ? 'selected' : ''); ?>>Instructor (Course Trainer)</option>
      </select>
    </div>
    ...
    <div class="tm-check-grid">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <label class="tm-check-item">
          <input type="checkbox" name="subject_ids[]" value="<?php echo e($subject->id); ?>" <?php echo e(in_array($subject->id, old('subject_ids', [])) ? 'selected' : ''); ?> />
          <div>
    ...
    <div class="tm-check-grid">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <label class="tm-check-item">
          <input type="checkbox" name="course_ids[]" value="<?php echo e($course->id); ?>" <?php echo e(in_array($course->id, old('course_ids', [])) ? 'selected' : ''); ?> />
          <div>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\teachers\create.blade.php ENDPATH**/ ?>