...
<?php $__env->startSection('title', 'Educational Background'); ?>
<?php $__env->startSection('page_title', 'Educational Background'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-card" style="padding:1.5rem;">
    <h2 style="margin:0 0 1rem;">Educational Background</h2>
    <p style="margin:0 0 1.5rem;color:var(--text-muted);">Record your most recent education and certification details.</p>
    ...
    <form method="POST" action="<?php echo e(route('sias.student.profile.educational_background.update')); ?>" class="section-card" style="display:grid;gap:1.5rem;max-width:860px;">
        <?php echo csrf_field(); ?>
        ...
        <details class="form-section-toggle" open>
            <summary style="display:flex;align-items:center;gap:.75rem;padding:1rem 1.25rem;background:var(--block-bg);border:1px solid var(--block-border);border-radius:14px;cursor:pointer;user-select:none;transition:all .2s var(--ease);font-weight:600;font-size:1rem;margin:0;">
                <i class="fa-solid fa-school" style="color:var(--accent-strong);font-size:1.2rem;"></i>
            ...
            <div style="padding:1.5rem;display:grid;gap:1rem;animation:slideDown .3s var(--ease) forwards;">
                <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem;">
                    <label style="display:grid;gap:.35rem;">
                        ...
                        <input name="school_name" class="form-input" placeholder="School or institution name">
                    </label>
                    <label style="display:grid;gap:.35rem;">
                        Year Graduated
                        <input name="graduation_year" type="number" class="form-input" placeholder="e.g. 2024">
                    </label>
                </div>
            </div>
        </details>
        ...
        <details class="form-section-toggle" open>
            <summary style="display:flex;align-items:center;gap:.75rem;padding:1rem 1.25rem;background:var(--block-bg);border:1px solid var(--block-border);border-radius:14px;cursor:pointer;user-select:none;transition:all .2s var(--ease);font-weight:600;font-size:1rem;margin:0;">
                <i class="fa-solid fa-star" style="color:var(--accent-strong);font-size:1.2rem;"></i>
            ...
            <div style="padding:1.5rem;display:grid;gap:1rem;animation:slideDown .3s var(--ease) forwards;">
                <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem;">
                    <label style="display:grid;gap:.35rem;">
                        Course / Strand
                        <input name="course_strand" class="form-input" placeholder="e.g. STEM, ABM, ICT">
                    </label>
                    <label style="display:grid;gap:.35rem;">
                        Honors / Awards
                        <input name="honors" class="form-input" placeholder="e.g. Cum Laude">
                    </label>
                </div>
            </div>
        </details>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\profile\educational_background.blade.php ENDPATH**/ ?>