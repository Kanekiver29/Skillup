...
<div class="teacher-dashboard">
    <section class="dashboard-intro" aria-label="Dashboard introduction">
        <div><div class="dashboard-kicker">Instructor workspace</div><h2>Good afternoon, <?php echo e($teacherName); ?></h2><p>Here is the pulse of your training programs today.</p></div>
        <div class="date-chip"><span aria-hidden="true"></span><?php echo e($today); ?></div>
    </section>
    ...
    <section class="dashboard-hero" aria-label="Dashboard welcome">
        ...
        <div class="hero-actions"><a href="<?php echo e(route('teacher.courses.index')); ?>" class="dashboard-button primary">Manage courses <span aria-hidden="true">&#8594;</span></a><a href="<?php echo e(route('teacher.modules.index')); ?>" class="dashboard-button secondary">View modules <span aria-hidden="true">&#8594;</span></a></div>
    </section>

    <section class="dashboard-section" aria-labelledby="overview-heading">
        <div class="section-heading"><h3 id="overview-heading">Training overview</h3><a href="<?php echo e(route('teacher.reports.index')); ?>">View reports &#8594;</a></div>
        <div class="kpi-grid">
            <article class="kpi-card"><div class="kpi-top"><span class="kpi-icon">P</span><span class="kpi-badge">Live</span></div><strong><?php echo e($stats['programs'] ?? 0); ?></strong><p>Assigned programs</p></article>
            <article class="kpi-card"><div class="kpi-top"><span class="kpi-icon">S</span><span class="kpi-badge">7 days</span></div><strong><?php echo e($stats['active_sessions'] ?? 0); ?></strong><p>Upcoming sessions</p></article>
            <article class="kpi-card"><div class="kpi-top"><span class="kpi-icon">T</span><span class="kpi-badge">Active</span></div><strong><?php echo e($stats['trainees'] ?? 0); ?></strong><p>Total trainees</p></article>
            <article class="kpi-card"><div class="kpi-top"><span class="kpi-icon">A</span><span class="kpi-badge">Published</span></div><strong><?php echo e($stats['upcoming_assessments'] ?? 0); ?></strong><p>Published assessments</p></article>
            <article class="kpi-card"><div class="kpi-top"><span class="kpi-icon">&#10003;</span><span class="kpi-badge">Today</span></div><strong><?php echo e($stats['attendance_present'] ?? 0); ?></strong><p>Present today</p></article>
        </div>
    </section>
    ...
    <section class="dashboard-section dashboard-columns" aria-label="Dashboard activity and actions">
        <div class="dashboard-panel"><div class="panel-title-row"><h3>Quick actions</h3><span>Common tasks</span></div><div class="action-grid">
            <a href="<?php echo e(route('teacher.courses.index')); ?>" class="action-card"><i>P</i><span>Browse programs</span></a>
            <a href="<?php echo e(route('teacher.modules.index')); ?>" class="action-card"><i>M</i><span>Manage modules</span></a>
            <a href="<?php echo e(route('teacher.progress.index')); ?>" class="action-card"><i>G</i><span>Track progress</span></a>
            <a href="<?php echo e(route('teacher.schedule.index')); ?>" class="action-card"><i>S</i><span>Schedule training</span></a>
            <a href="<?php echo e(route('teacher.quizzes.create')); ?>" class="action-card"><i>Q</i><span>Create a quiz</span></a>
            <a href="<?php echo e(route('teacher.announcements.index')); ?>" class="action-card"><i>N</i><span>Post announcement</span></a>
        </div></div>
        <div class="dashboard-panel"><div class="panel-title-row"><h3>Attendance today</h3><span><?php echo e($stats['attendance_present'] ?? 0); ?> present</span></div><div class="attendance-row"><div class="attendance-box"><strong><?php echo e($stats['attendance_present'] ?? 0); ?></strong><span>Present</span></div><div class="attendance-box"><strong><?php echo e($stats['attendance_late'] ?? 0); ?></strong><span>Late</span></div><div class="attendance-box"><strong><?php echo e($stats['attendance_absent'] ?? 0); ?></strong><span>Absent</span></div></div><div class="panel-title-row" style="margin-top:1.1rem;margin-bottom:.35rem"><h3>Recent activity</h3><a href="<?php echo e(route('teacher.students.index')); ?>">Trainees &#8594;</a></div><ul class="activity-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><li class="activity-item"><span class="activity-avatar"><?php echo e($activity['initials']); ?></span><div class="activity-copy"><p><?php echo e($activity['text']); ?></p><time><?php echo e($activity['time']); ?></time></div><span class="activity-status"></span></li><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?><li class="activity-item"><div class="activity-copy"><p>No recent trainee activity.</p><time>New enrollments will appear here.</time></div></li><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </ul></div>
    </section>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('teacher.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>