...
<?php $__env->startSection('title', 'Mentors - SkillUp'); ?>
		...
		<div class="max-w-6xl mx-auto text-center relative z-10">
			...
			<div class="flex flex-col sm:flex-row gap-4 justify-center fade-up" style="animation-delay:.16s">
				...
				<?php if(auth()->guard()->guest()): ?>
					<a href="<?php echo e(route('register')); ?>" class="cta-btn border-2 border-white px-8 py-3 rounded-xl font-semibold hover:bg-white hover:text-purple-700 transition">
						Join SkillUp
					</a>
				<?php endif; ?>
				<?php if(auth()->guard()->check()): ?>
					<a href="<?php echo e(route('courses.index')); ?>" class="cta-btn border-2 border-white px-8 py-3 rounded-xl font-semibold hover:bg-white hover:text-purple-700 transition">
						Continue Learning
					</a>
				<?php endif; ?>
			</div>
	...
	<section class="py-20 px-4 cta-hero text-white text-center relative overflow-hidden">
		...
		<div class="max-w-3xl mx-auto relative z-10 fade-up">
			...
			<div class="flex flex-col sm:flex-row gap-4 justify-center">
				...
				<?php endif; ?>
				<?php if(auth()->guard()->check()): ?>
					<a href="<?php echo e(route('userpage.dashboard')); ?>" class="cta-btn border-2 border-white px-8 py-3 rounded-xl font-semibold hover:bg-white hover:text-purple-700 transition">
						Go to Dashboard
					</a>
				<?php endif; ?>
			</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/Userpage/Product/mentors.blade.php ENDPATH**/ ?>