<?php $__env->startSection('title', 'Multi-Factor Authentication'); ?>
<?php $__env->startSection('page_title', 'Multi-Factor Authentication'); ?>
...
<div class="mfa-page">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mfaEnabled): ?>
        <!-- ENABLED STATE -->
        ...
        <div class="mfa-card anim" style="animation-delay:.08s;">
            ...
            <p>You are currently using <strong><?php echo e($mfaMethod === 'app' ? 'Authenticator App' : 'SMS / Text Message'); ?></strong> to verify your identity.</p>
            
            <form method="POST" action="<?php echo e(route('sias.student.account.mfa.toggle')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        ...
        <form method="POST" action="<?php echo e(route('sias.student.account.mfa.toggle')); ?>" id="mfaSetupForm">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\account\mfa.blade.php ENDPATH**/ ?>