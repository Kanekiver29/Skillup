...
<?php $__env->startSection('title', 'Assessment Questionnaire'); ?>
...
<div style="max-width: 1100px; margin: 0 auto; padding: 1rem 0 2rem;">
    <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:1rem; margin-bottom:1.25rem; flex-wrap:wrap;">
        <div>
            ...
            <h1 style="margin:0; font-size:2rem; font-weight:800; color:#0b1526;"><?php echo e($quiz->title); ?></h1>
        ...
        <div style="display:flex; gap:0.75rem; flex-wrap:wrap;">
            ...
            <a href="<?php echo e(route('staff.quizzes.edit', $quiz)); ?>" style="display:inline-flex; align-items:center; justify-content:center; padding:0.7rem 1rem; border-radius:0.75rem; background:#f8fafc; color:#0f172a; font-weight:600; text-decoration:none; border:1px solid #dfe7f3;">Edit details</a>
        </div>
    </div>
    ...
    <div style="background:#fff; border:1px solid #e5edf9; border-radius:1rem; padding:1.5rem; box-shadow:0 12px 30px rgba(30,64,175,0.06);">
        <form action="<?php echo e(route('staff.quizzes.questionnaire.store', $quiz)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div style="display:grid; gap:1.25rem;">
                <div style="padding:1rem 1.1rem; border:1px solid #e2e8f0; border-radius:0.8rem; background:#f8fafc;">
                    ...
                    <div style="display:flex; gap:1rem; flex-wrap:wrap; color:#0f172a; font-size:0.95rem;">
                        <span><strong>Passing score:</strong> <?php echo e($quiz->passing_score ?? 0); ?>%</span>
                        <span><strong>Time limit:</strong> <?php echo e($quiz->time_limit_minutes ?? 0); ?> min</span>
                        <span><strong>Module:</strong> <?php echo e($quiz->module?->title ?? 'Unassigned'); ?></span>
                    </div>
                </div>
                ...
                <div style="border:1px dashed #cbd5e1; border-radius:0.8rem; padding:1.25rem; background:#fff;">
                    ...
                    <textarea name="questions[0][question_text]" rows="3" placeholder="Enter your first question here..." style="width:100%; padding:0.8rem 0.9rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a; resize:vertical;"><?php echo e(old('questions.0.question_text')); ?></textarea>
                    <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:0.75rem; margin-top:0.85rem;">
                        <input type="text" name="questions[0][answers][0][answer_text]" value="<?php echo e(old('questions.0.answers.0.answer_text')); ?>" placeholder="Answer 1" style="padding:0.75rem 0.8rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;" />
                        <input type="text" name="questions[0][answers][1][answer_text]" value="<?php echo e(old('questions.0.answers.1.answer_text')); ?>" placeholder="Answer 2" style="padding:0.75rem 0.8rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;" />
                        <input type="text" name="questions[0][answers][2][answer_text]" value="<?php echo e(old('questions.0.answers.2.answer_text')); ?>" placeholder="Answer 3" style="padding:0.75rem 0.8rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;" />
                        <input type="text" name="questions[0][answers][3][answer_text]" value="<?php echo e(old('questions.0.answers.3.answer_text')); ?>" placeholder="Answer 4" style="padding:0.75rem 0.8rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;" />
                    </div>
                    <div style="margin-top:0.75rem;">
                        ...
                        <select id="questions_0_correct" name="questions[0][correct]" style="padding:0.7rem 0.8rem; border:1px solid #d9e2f5; border-radius:0.7rem; background:#f8fbff; color:#0f172a;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 4; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(old('questions.0.correct') == (string) $i ? 'selected' : ''); ?>>Answer <?php echo e($i + 1); ?></option>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\quizzes\questionnaire.blade.php ENDPATH**/ ?>