...
<?php $__env->startSection('subtitle', 'Manage faculty members, assign instructors, and configure teaching loads.'); ?>

<?php $__env->startSection('header_actions'); ?>
  <a href="<?php echo e(route('sias.admin.teachers.create')); ?>" class="btn" title="Add a new teacher or promote student">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
  <div class="tm-alert tm-alert-success" role="alert">
    ...
    <div style="flex: 1;"><?php echo e(session('success')); ?></div>
  </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
  <div class="tm-alert tm-alert-error" role="alert">
    ...
    <div style="flex: 1;"><?php echo e(session('error')); ?></div>
  </div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<div class="tm-stats-grid">
  <div class="tm-stat-card">
    ...
    <div>
      <div class="tm-stat-val"><?php echo e($stats['total'] ?? 0); ?></div>
  ...
  <div class="tm-stat-card">
    ...
    <div>
      <div class="tm-stat-val"><?php echo e($stats['instructors'] ?? 0); ?></div>
  ...
  <div class="tm-stat-card">
    ...
    <div>
      <div class="tm-stat-val"><?php echo e($stats['teachers'] ?? 0); ?></div>
  ...
  <div class="tm-stat-card">
    ...
    <div>
      <div class="tm-stat-val"><?php echo e($stats['assigned_subjects'] ?? 0); ?></div>
...
<div class="tm-toolbar">
  <form method="GET" action="<?php echo e(route('sias.admin.teachers')); ?>" class="tm-search-form">
    <div class="tm-input-wrap">
      ...
      <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search teacher name, email..." class="tm-input" />
    </div>

    <select name="type" class="tm-select" onchange="this.form.submit()">
      <option value="">All Staff Roles</option>
      <option value="teacher" <?php echo e(request('type') === 'teacher' ? 'selected' : ''); ?>>Teachers</option>
      <option value="instructor" <?php echo e(request('type') === 'instructor' ? 'selected' : ''); ?>>Instructors</option>
    </select>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search', 'type'])): ?>
      <a href="<?php echo e(route('sias.admin.teachers')); ?>" class="tm-btn-sm tm-btn-ghost">Clear</a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  </form>

  <div style="font-family: var(--font-mono); font-size: 0.8rem; color: var(--text-muted);">
    Showing <strong><?php echo e($teachers->count()); ?></strong> of <strong><?php echo e($teachers->total()); ?></strong> faculty
  </div>
</div>
...
<div class="tm-table-card">
          ...
          <tr>
            <td>
              <div class="tm-user-cell">
                <div class="tm-avatar" aria-hidden="true"><?php echo e($initials ?: 'T'); ?></div>
                <div>
                  <div class="tm-user-name"><?php echo e($teacher->name); ?></div>
                  <div class="tm-user-email"><?php echo e($teacher->email); ?></div>
                </div>
              </div>
            </td>
            <td>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($staffType === 'instructor'): ?>
            ...
            <td style="text-align: center;">
              <span class="tm-count-pill" title="<?php echo e($teacher->subjects_count); ?> subjects assigned">
                <?php echo e($teacher->subjects_count ?? 0); ?>

              </span>
            </td>
            <td style="text-align: center;">
              <span class="tm-count-pill" title="<?php echo e($teacher->courses_count); ?> courses assigned">
                <?php echo e($teacher->courses_count ?? 0); ?>

              </span>
            </td>
            <td>
              <span style="font-family: var(--font-mono); font-size: 0.8rem; color: var(--text-muted);">
                <?php echo e($teacher->created_at ? $teacher->created_at->format('M d, Y') : '—'); ?>

              </span>
            </td>
            <td>
              <div class="tm-actions">
                <a href="<?php echo e(route('sias.admin.teachers.edit', $teacher)); ?>" class="tm-action-btn" title="Edit Teacher">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                  </svg>
                </a>
                <form action="<?php echo e(route('sias.admin.teachers.demote', $teacher)); ?>" method="POST" style="margin: 0;" onsubmit="return confirm('Are you sure you want to demote/remove <?php echo e(addslashes($teacher->name)); ?> from the teacher role?');">
                  <?php echo csrf_field(); ?>
          ...
          <tr>
            <td colspan="6">
              <div class="tm-empty">
                ...
                <a href="<?php echo e(route('sias.admin.teachers.create')); ?>" class="btn" style="display: inline-flex; width: auto; font-size: 0.85rem; padding: 0.65rem 1.1rem;">
                  Add New Teacher
                </a>
              </div>
            </td>
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teachers->hasPages()): ?>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\teachers\index.blade.php ENDPATH**/ ?>