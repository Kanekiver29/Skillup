<?php $__env->startSection('title', 'Edit News Post'); ?>
...
<div class="mx-auto max-w-6xl px-4 pb-16 pt-10 sm:px-6 lg:px-8">
    ...
    <form action="<?php echo e(route('admin.news.update', $item->id)); ?>" method="POST" enctype="multipart/form-data" class="rounded-[28px] border border-slate-700/80 bg-slate-900/60 p-6 sm:p-8">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <?php echo $__env->make('admin.news._form', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <form action="<?php echo e(route('admin.news.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Delete “<?php echo e($item->title); ?>”? This can’t be undone.');" class="mt-4">
        <?php echo csrf_field(); ?>
