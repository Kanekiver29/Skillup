...
<?php $__env->startSection('title', 'Quiz: ' . $quiz->title . ' - SkillUp'); ?>
...
<div class="qz-root">
    ...
    <header class="qz-hero">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="qz-hero-top">
                <a href="<?php echo e(route('quizzes.show', [$course->slug, $module->slug, $quiz->slug])); ?>" class="qz-exit">
                ...
                <?php if($quiz->time_limit_minutes): ?>
                    <div class="qz-main-timer" id="mainTimerWrap">
                        ...
                        <div class="qz-main-timer-inner">
                            <span id="timer" class="qz-timer-value"><?php echo e($quiz->time_limit_minutes); ?>:00</span>
            ...
            <div class="qz-hero-title-row">
                <div class="qz-hero-eyebrow">
                    ...
                    Attempt <?php echo e($attempt->attempt_number); ?> / <?php echo e($quiz->attempt_limit); ?>

                </div>
                <h1 class="qz-title" data-text="<?php echo e($quiz->title); ?>"><?php echo e($quiz->title); ?></h1>
            </div>
        </div>
    </header>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 qz-body">
        <form id="quizForm" action="<?php echo e(route('quizzes.submit', [$course->slug, $module->slug, $quiz->slug])); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="qz-progress-wrap" role="group" aria-label="Quiz progress">
                <div class="qz-progress-labels">
                    ...
                    <span class="qz-progress-count" id="progressText" aria-live="polite">1 of <?php echo e($quiz->questions()->count()); ?></span>
                </div>
            ...
            <div id="questionsContainer" class="qz-questions">
                <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="qz-card qz-question-item hidden" id="question-<?php echo e($question->id); ?>" data-question-index="<?php echo e($index); ?>">
                        ...
                        <div class="qz-question-head">
                            <div class="qz-question-head-row">
                                <div class="qz-question-number">
                                    ...
                                    <span class="qz-question-number-value"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></span>
                                </div>
                                <div class="qz-question-meta">
                                    ...
                                    <?php if($quiz->time_limit_minutes): ?>
                                        <div class="qz-qtimer" id="questionTimerContainer-<?php echo e($question->id); ?>">
                                            <svg class="qz-qring" viewBox="0 0 40 40" aria-hidden="true">
                                                <circle class="qz-qring-track" cx="20" cy="20" r="16"></circle>
                                                <circle class="qz-qring-progress" id="qringProgress-<?php echo e($question->id); ?>" cx="20" cy="20" r="16"></circle>
                                            </svg>
                                            <span class="qz-qtimer-value" id="qtimerValue-<?php echo e($question->id); ?>">2:00</span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <p class="qz-question-text"><?php echo e($question->question_text); ?></p>
                        </div>

                        <!-- Answer Options -->
                        <div class="qz-options" role="group" aria-label="Answer options">
                            <?php if($question->type === 'multiple_choice' || $question->type === 'true_false'): ?>
                                <?php $__currentLoopData = $question->answers()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="qz-option" id="answer-label-<?php echo e($answer->id); ?>" style="--stagger: <?php echo e($loop->index); ?>">
                                        <input type="radio"
                                               ...
                                               data-is-correct="<?php echo e($answer->is_correct ? 1 : 0); ?>"
                                               onchange="updateQuestionStatus(<?php echo e($question->id); ?>, this)">
                                        <span class="qz-option-shell">
                                            <span class="qz-option-marker" aria-hidden="true">
                                                <span class="qz-option-marker-dot"></span>
                                            </span>
                                            <span class="qz-option-text"><?php echo e($answer->answer_text); ?></span>
                            ...
                            <?php elseif($question->type === 'short_answer'): ?>
                                <div class="qz-textarea-wrap">
                                    <textarea name="responses[<?php echo e($question->id); ?>]"
                                              class="qz-textarea"
                                              rows="4"
                                              placeholder="Type your answer here..."
                                              onchange="updateQuestionStatus(<?php echo e($question->id); ?>)"></textarea>
                        ...
                        <?php if($question->explanation): ?>
                            <div id="explanation-<?php echo e($question->id); ?>" class="qz-explanation hidden">
                                <h4 class="qz-explanation-title">
                                    <i class="fas fa-lightbulb"></i>Explanation
                                </h4>
                                <p class="qz-explanation-text"><?php echo e($question->explanation); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="qz-navbar">
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 qz-navbar-inner">
                    ...
                    <div class="qz-answered-pill" aria-live="polite">
                        <span id="answeredNumber">0</span><span class="qz-answered-sep">/</span><span id="totalNumber"><?php echo e($quiz->questions()->count()); ?></span>
                ...
                <div class="qz-indicators-grid" id="questionIndicators" role="group" aria-label="Jump to question">
                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button"
                                ...
                                id="indicator-<?php echo e($index); ?>"
                                data-question-index="<?php echo e($index); ?>"
                                title="Question <?php echo e($index + 1); ?>"
                                aria-label="Go to question <?php echo e($index + 1); ?>">
                            <?php echo e($index + 1); ?>
...
<script>
    (function () {
        ...
        const timeLimit = <?php echo e($quiz->time_limit_minutes ? $quiz->time_limit_minutes * 60 : 'null'); ?>;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/courses/quizzes/attempt.blade.php ENDPATH**/ ?>