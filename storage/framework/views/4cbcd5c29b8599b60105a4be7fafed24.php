...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Trainer Portal'); ?> | SkillUp</title>

    <link rel="icon" href="<?php echo e(asset('image/hello.png')); ?>" type="image/png">
...
<div class="app-shell">
    ...
    <aside class="sidebar" id="sidebar" aria-label="Trainer navigation">
        <div class="brand">
            <div class="brand-logo-wrap">
                <img src="<?php echo e(asset('image/hello.png')); ?>" alt="SkillUp Logo" class="brand-logo">
            </div>
        ...
        <nav class="nav-links" id="navLinks">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="nav-section-label"><?php echo e($group); ?></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $routeName, $pattern, $icon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $isActive = request()->routeIs($pattern); ?>
                    <a class="nav-link <?php echo e($isActive ? 'active' : ''); ?>"
                       href="<?php echo e(route($routeName)); ?>"
                       <?php if($isActive): ?> aria-current="page" <?php endif; ?>>
                        <span class="nav-icon"><svg class="icon"><use href="#icon-<?php echo e($icon); ?>"/></svg></span>
                        <span class="nav-link-label"><?php echo e($label); ?></span>
                    </a>
    ...
    <div class="main-panel">
        <header class="topbar">
            ...
            <div class="topbar-user" title="<?php echo e($userName); ?>">
                <div class="avatar-wrap">
                    <div class="avatar"><?php echo e(strtoupper(substr($userName, 0, 1))); ?></div>
                    <span class="avatar-dot" aria-hidden="true"></span>
                </div>
                <div class="topbar-user-text">
                    <span class="topbar-user-name"><?php echo e($userName); ?></span>
...
</html><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views/teacher/layouts/master.blade.php ENDPATH**/ ?>