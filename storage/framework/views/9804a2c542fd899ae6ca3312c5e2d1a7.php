                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <div class="relative inline-flex items-center">
                        ...
                        <div id="currency-menu" class="footer-currency-menu absolute left-0 top-full mt-2 hidden min-w-[10rem] overflow-hidden rounded-2xl border border-slate-700 bg-[#0c2d4a] shadow-xl shadow-black/40 z-20">
                            <?php $__currentLoopData = ['EUR','USD','GBP','PHP','JPY','AUD','CAD']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/layout/app.blade.php ENDPATH**/ ?>