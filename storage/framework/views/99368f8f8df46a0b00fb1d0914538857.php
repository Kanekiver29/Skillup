...
<?php $__env->startSection('title', 'Family Background'); ?>
<?php $__env->startSection('page_title', 'Family Background'); ?>
...
<div class="page-card" style="padding:1.5rem;">
    ...
    <form method="POST" action="<?php echo e(route('sias.student.profile.family_background.update')); ?>" class="section-card" style="display:grid;gap:1.5rem;max-width:860px;">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\profile\family_background.blade.php ENDPATH**/ ?>