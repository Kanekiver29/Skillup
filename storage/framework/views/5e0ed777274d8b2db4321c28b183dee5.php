...
<div class="am-page">
    ...
    <!-- Archived Modules -->
    <?php if($archivedModules->count() > 0): ?>
    <div class="am-archived-section">
        ...
        <div class="am-card am-table-card am-archived-card">
            <table class="am-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $archivedModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archived): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="am-row">
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/Admin/modules/index.blade.php ENDPATH**/ ?>