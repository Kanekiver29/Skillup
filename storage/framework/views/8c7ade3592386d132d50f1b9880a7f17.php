        ...
        <form method="POST" action="<?php echo e(route('staff.enrollments.update', $enrollment->id)); ?>" id="fxEnrollForm" novalidate>
            ...
            <div class="em-fx__row">
                <div class="em-fx__field">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['year_level'];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\enrollments\edit.blade.php ENDPATH**/ ?>