...
<div class="lf-page">
    ...
    <div class="lf-wrap">
        ...
        <div class="lf-shell">
            ...
            <form method="POST" action="<?php echo e(route('staff.lessons.store')); ?>" class="lf-panel" id="lfForm" enctype="multipart/form-data" novalidate>
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/lessons/create.blade.php ENDPATH**/ ?>