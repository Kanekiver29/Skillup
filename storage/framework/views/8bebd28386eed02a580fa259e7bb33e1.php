...
<div class="app-shell" x-data="staffLayout()">
    ...
    <aside class="sidebar"
        ...
        <nav class="sb-nav-scroll" aria-label="Sidebar menu">
            ...
            <a href="<?php echo e(route('staff.lessons.list')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.lessons.list') ? 'is-active' : ''); ?>"
               title="Lessons">
                <span class="sb-icon-wrap">
                    <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                         stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('staff.quizzes.list')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.quizzes.list') ? 'is-active' : ''); ?>"
               title="Quizzes">
                <span class="sb-icon-wrap">
                    <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                         stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('staff.videos.index')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.videos.*') ? 'is-active' : ''); ?>"
            ...
            <a href="<?php echo e(route('staff.images.index')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.images.*') ? 'is-active' : ''); ?>"
            ...
            <a href="<?php echo e(route('staff.powerpoints.index')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.powerpoints.*') ? 'is-active' : ''); ?>"
            ...
            <a href="<?php echo e(route('staff.reports.daily')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.reports.daily*') ? 'is-active' : ''); ?>"
               title="Daily Reports">
                <span class="sb-icon-wrap">
                    <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                         stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('staff.reports.staff')); ?>"
               class="sb-nav-item <?php echo e(request()->routeIs('staff.reports.staff*') ? 'is-active' : ''); ?>"
               title="Staff Reports">
                <span class="sb-icon-wrap">
                    <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                         stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
</html><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/staff/layouts/masters.blade.php ENDPATH**/ ?>