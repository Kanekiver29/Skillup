    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
            ...
            <div class="p-6 pt-0 space-y-4">
                ...
                <!-- Scopes / Permissions -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($scopes) > 0): ?>
                    <div class="space-y-2">
...
<?php /**PATH C:\xampp\htdocs\skillupv2\vendor\laravel\mcp\resources\views\mcp\authorize.blade.php ENDPATH**/ ?>