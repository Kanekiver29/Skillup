...
<div class="courses-page">
    ...
    <header class="cp-header">
        ...
        <a href="<?php echo e(route('admin.courses.create')); ?>" class="cp-btn-primary">
            ...
            <table class="cp-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td class="cp-course-title"><?php echo e($c->title); ?></td>
                            <td class="cp-cell-muted">
                                <span class="cp-pill"><i class="fas fa-tag"></i><?php echo e($c->category); ?></span>
                            </td>
                            <td class="cp-cell-muted">
                                <span class="cp-pill cp-pill-gold"><i class="fas fa-layer-group"></i><?php echo e($c->level); ?></span>
                            </td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->is_published): ?>
                            ...
                            <td class="cp-td-actions">
                                <a href="<?php echo e(route('admin.courses.enrollments', $c)); ?>" class="cp-action cp-action-enroll">Enrollments</a>
                                <a href="<?php echo e(route('admin.courses.edit', $c)); ?>" class="cp-action cp-action-edit">Edit</a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layout.Admin.system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Admin\courses\index.blade.php ENDPATH**/ ?>