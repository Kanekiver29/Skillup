...
<?php $__env->startSection('title', 'My Profile - SkillUp'); ?>
...
<div class="profile-page min-h-screen">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
        <div class="max-w-6xl mx-auto px-4 pt-4">
            <div class="profile-toast rounded-xl border border-emerald-400/30 bg-emerald-400/10 px-4 py-3 flex items-center gap-3 shadow-sm backdrop-blur">
                ...
                <p class="text-sm text-emerald-200 font-medium"><?php echo e(session('success')); ?></p>
            </div>
        </div>
    ...
    >
        ...
        <div class="max-w-6xl mx-auto profile-hero-inner">
            <a href="<?php echo e(route('courses.index')); ?>" class="profile-back-link profile-hero-enter inline-flex items-center gap-2 mb-6 transition group font-medium">
            ...
            <div class="profile-hero-enter profile-hero-enter-delay-1 flex flex-col md:flex-row items-start md:items-end gap-6 mb-10">
                <div class="profile-avatar-wrap shrink-0">
                    ...
                    <div class="profile-avatar-ring w-32 h-32 md:w-36 md:h-36 bg-white rounded-full border-4 border-white/40 flex items-center justify-center overflow-hidden relative">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->profile_image): ?>
                            <img src="<?php echo e(asset('uploads/profiles/' . $user->profile_image)); ?>" alt="<?php echo e($user->name); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                            <span class="text-5xl font-black" style="color: #003a8f;"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <a href="<?php echo e(route('userpage.profile-edit')); ?>" class="absolute bottom-0 right-0 flex h-11 w-11 items-center justify-center rounded-full text-white shadow-lg transition hover:scale-110 z-10" style="background: #0284c7; min-height: 0; box-shadow: 0 0 18px rgba(2,132,199,0.6);" aria-label="Edit photo">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="text-4xl md:text-5xl font-black tracking-tight mb-2"><?php echo e($user->name); ?></h1>
                    <p class="profile-subtitle text-xl font-medium mb-4"><?php echo e($user->location ?? 'Career in Progress'); ?></p>
                    <div class="flex flex-wrap gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->location): ?>
                            <span class="profile-badge-pill inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm">
                                <i class="fas fa-map-marker-alt profile-label-tag"></i> <?php echo e($user->location); ?>

                            </span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <span class="profile-badge-pill inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm">
                            <i class="fas fa-calendar profile-label-tag"></i> Joined <?php echo e($user->created_at->format('M Y')); ?>

                        </span>
                    </div>
                </div>

                <a href="<?php echo e(route('userpage.profile-edit')); ?>" class="profile-btn-primary shrink-0 inline-flex items-center gap-2 px-6 py-3 font-bold rounded-xl" style="min-height: 0;">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $heroStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="profile-hero-enter profile-hero-enter-delay-<?php echo e(min($i + 2, 5)); ?> profile-stat-glass p-4 md:p-5 rounded-2xl text-center <?php echo e(!empty($stat['wide']) ? 'col-span-2 md:col-span-1' : ''); ?>">
                        <div
                            class="profile-stat-value text-2xl md:text-3xl tabular-nums"
                            data-countup="<?php echo e($stat['value']); ?>"
                            <?php if(!empty($stat['suffix'])): ?> data-countup-suffix="<?php echo e($stat['suffix']); ?>" <?php endif; ?>
                        ><?php echo e($stat['value']); ?><?php echo e($stat['suffix'] ?? ''); ?></div>
                        <p class="profile-stat-label text-xs md:text-sm mt-1.5"><?php echo e($stat['label']); ?></p>
                    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <section data-page-animate class="profile-section-card p-6 md:p-8">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->bio): ?>
                        <p class="profile-text-body leading-relaxed mb-4"><?php echo e($user->bio); ?></p>
                    <?php else: ?>
                        <p class="profile-text-dim italic">No bio yet. <a href="<?php echo e(route('userpage.profile-edit')); ?>" class="profile-link font-semibold hover:underline">Add one</a></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="flex gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->github_url): ?>
                            <a href="<?php echo e($user->github_url); ?>" target="_blank" rel="noopener" class="profile-icon-link flex h-11 w-11 items-center justify-center rounded-xl min-h-0">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->portfolio_url): ?>
                            <a href="<?php echo e($user->portfolio_url); ?>" target="_blank" rel="noopener" class="profile-icon-link flex h-11 w-11 items-center justify-center rounded-xl min-h-0">
                ...
                <section data-page-animate class="page-delay-1 profile-section-card p-6 md:p-8">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->count()): ?>
                        <div class="space-y-3" id="courses-list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div id="enroll-<?php echo e($enrollment->id); ?>" class="profile-course-row rounded-xl p-4 flex items-start justify-between gap-4">
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-semibold profile-text-strong"><?php echo e($enrollment->course->course_title); ?></h3>
                                        <p class="text-sm profile-text-dim mt-1"><?php echo e(Str::limit($enrollment->course->description, 100)); ?></p>
                                        <div class="mt-3 flex flex-wrap gap-4 text-xs profile-text-dim">
                                            <span>Progress: <strong class="profile-text-strong progress-text"><?php echo e($enrollment->progress ?? 0); ?>%</strong></span>
                                            <span>Status: <strong class="profile-text-strong status-text"><?php echo e($enrollment->completed ? 'Completed' : 'In Progress'); ?></strong></span>
                                        </div>
                                        <div class="profile-progress-track w-full rounded-full h-2 mt-3">
                                            <div class="profile-progress-fill h-2 rounded-full progress-bar" style="width: <?php echo e($enrollment->progress ?? 0); ?>%"></div>
                                        </div>
                                    </div>
                                    <div class="profile-percent-chip shrink-0 w-12 h-12 rounded-full flex items-center justify-center">
                                        <span class="text-sm font-bold progress-text"><?php echo e($enrollment->progress ?? 0); ?>%</span>
                                    </div>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    ...
                    <?php else: ?>
                        <p class="profile-text-dim italic">You haven't enrolled in any courses yet. <a href="<?php echo e(route('courses.index')); ?>" class="profile-link font-semibold hover:underline">Browse courses</a></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </section>
                ...
                <section data-page-animate class="page-delay-2 profile-section-card p-6 md:p-8">
                    <div class="flex items-center justify-between mb-4 gap-4">
                        ...
                        <a href="<?php echo e(route('certificates.index')); ?>" class="profile-link hover:text-white text-sm font-semibold whitespace-nowrap">View All</a>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($completedCertificates->count()): ?>
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $completedCertificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="profile-course-row rounded-xl p-4">
                                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                        <div>
                                            <p class="text-sm profile-text-dim profile-mono">Completed <?php echo e($enrollment->completed_at ? $enrollment->completed_at->format('M d, Y') : 'Recently'); ?></p>
                                            <h3 class="text-lg font-semibold profile-text-strong mt-1"><?php echo e($enrollment->course->course_title); ?></h3>
                                        </div>
                                        <div class="flex flex-wrap gap-2">
                                            <a href="<?php echo e(route('certificates.show', $enrollment->course->slug)); ?>" class="profile-btn-amber inline-flex items-center px-4 py-2 rounded-lg text-sm min-h-0">
                                                <i class="fas fa-eye mr-2"></i>View
                                            </a>
                                            <button type="button" onclick="window.open('<?php echo e(route('certificates.show', $enrollment->course->slug)); ?>?print=1', '_blank')" class="profile-btn-primary inline-flex items-center px-4 py-2 rounded-lg text-sm min-h-0">
                                                <i class="fas fa-file-download mr-2"></i>PDF
                                            </button>
                                            <a href="<?php echo e(route('courses.show', $enrollment->course->slug)); ?>" class="profile-btn-ghost inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold min-h-0">
                ...
                <section data-page-animate class="page-delay-3 profile-section-card p-6 md:p-8">
                    <div class="flex items-center justify-between mb-4 gap-4">
                        ...
                        <a href="<?php echo e(route('badges.index')); ?>" class="profile-link hover:text-white text-sm font-semibold">View All</a>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($earnedBadges->count()): ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $earnedBadges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userBadge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="profile-course-row rounded-xl p-4 group">
                                    <div class="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            <h3 class="font-semibold profile-text-strong"><?php echo e($userBadge->badge->name); ?></h3>
                                            <p class="text-xs uppercase profile-text-dim profile-mono">Earned <?php echo e($userBadge->earned_at ? $userBadge->earned_at->format('M d, Y') : 'Recently'); ?></p>
                                        </div>
                                    </div>
                                    <p class="profile-text-body text-sm"><?php echo e($userBadge->badge->description); ?></p>
                                    <div class="mt-4 flex flex-wrap gap-2">
                                        <button type="button" onclick="copyBadgeDetails(<?php echo e(json_encode($userBadge->badge->name)); ?>, <?php echo e(json_encode($userBadge->badge->description)); ?>)" class="profile-btn-primary inline-flex items-center px-3 py-2 rounded-lg text-xs min-h-0">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $user->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="profile-skill-chip p-3 rounded-xl text-center cursor-default">
                                    <p class="font-semibold profile-text-strong text-sm"><?php echo e($skill); ?></p>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    <?php else: ?>
                        <p class="profile-text-dim italic">No skills added yet. <a href="<?php echo e(route('userpage.profile-edit')); ?>" class="profile-link font-semibold hover:underline">Add your skills</a></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </section>
            ...
            <div class="space-y-6">
                <section data-page-animate class="page-delay-2 profile-section-card p-6">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['🏃' => 'Quick Learner', '👣' => 'First Steps', '💻' => 'Code Master', '🤝' => 'Team Player', '🔥' => '30-Day Streak', '⭐' => 'Rising Star']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="profile-badge-tile text-center cursor-default" title="<?php echo e($label); ?>">
                                <div class="text-3xl mb-1"><?php echo e($emoji); ?></div>
                                <p class="text-[10px] font-semibold profile-text-dim leading-tight"><?php echo e($label); ?></p>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </section>
                ...
                <section data-page-animate class="profile-section-card p-6">
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="profile-timeline-item pb-1">
                                <p class="profile-text-body"><strong class="profile-text-strong"><?php echo e($activity['action']); ?>:</strong> <?php echo e($activity['detail']); ?></p>
                                <p class="profile-text-dim text-xs mt-0.5 profile-mono"><?php echo e($activity['time']); ?></p>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </section>
...
<script>
    function refreshCourseStats() {
        fetch("<?php echo e(route('userpage.enrollments.stats')); ?>")
            .then(r => r.json())
            .then(data => {
                data.forEach(en => {
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\Userpage\profile.blade.php ENDPATH**/ ?>