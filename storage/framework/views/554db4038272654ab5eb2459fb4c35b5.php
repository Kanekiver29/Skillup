        ...
        <div class="auth-body">
            ...
            <form method="POST" action="<?php echo e(url('/password/email')); ?>">
                ...
                <div class="auth-field">
                    ...
                    <input type="email" id="email" name="email" required value="<?php echo e(old('email')); ?>" class="auth-input" placeholder="you@example.com">
                </div>
...
<?php echo $__env->make('auth.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skilluplastest\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>