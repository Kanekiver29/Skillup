...
<?php $__env->startSection('title', 'Assessment Form'); ?>
<?php $__env->startSection('page_title', 'Assessment Form'); ?>
...
<div class="print-shell">
    ...
    <div class="doc-box">
        ...
        <div class="student-meta">
            ...
            <div><span>Course</span><strong><?php echo e($course?->title ?? 'Not selected'); ?></strong></div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subjects->count()): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td><?php echo e(82 + $index * 3); ?></td>
                            <td><?php echo e($index % 2 === 0 ? 'Passed' : 'Good Performance'); ?></td>
                        </tr>
...
<?php echo $__env->make('sias.students.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\students\registration\assessment_form.blade.php ENDPATH**/ ?>