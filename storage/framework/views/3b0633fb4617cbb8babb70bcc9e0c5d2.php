...
<?php $__env->startSection('page_title', 'Subject Directory'); ?>
...
<div class="subj-header">
    ...
    <a href="<?php echo e(route('teacher.subjects.create')); ?>" class="btn-create">
...
<div class="subj-stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="num"><?php echo e($subjects->total() ?? $subjects->count()); ?></div>
    ...
    <div class="stat-card">
        <div class="stat-icon">🔗</div>
        <div class="stat-info">
            <div class="num"><?php echo e($coursesCount ?? 0); ?></div>
    ...
    <div class="stat-card">
        <div class="stat-icon">✅</div>
        <div class="stat-info">
            <div class="num"><?php echo e($activeCount ?? 0); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="num"><?php echo e($totalUnits ?? 0); ?></div>
...
<div class="filter-card">
    <form method="GET" action="<?php echo e(route('teacher.subjects.index')); ?>" class="search-box">
        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search subject code, title or details..." onchange="this.form.submit()">
    </form>

    <a href="<?php echo e(route('subjects')); ?>" target="_blank" class="btn-preview-userpage" title="Open student-facing subject view">
...
<div class="subject-grid">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="subject-box">
            <div>
                <div class="subj-top">
                    <span class="subj-code-tag"><?php echo e($subject->subject_code ?: 'SUBJ-' . $subject->id); ?></span>
                    <span class="status-badge <?php echo e($subject->is_active ? 'active' : 'inactive'); ?>">
                        <span style="width:6px; height:6px; border-radius:50%; background:currentColor;"></span>
                        <?php echo e($subject->is_active ? 'Active' : 'Draft'); ?>

                    </span>
                </div>

                <h2 class="subj-title"><?php echo e($subject->title); ?></h2>
                <p class="subj-desc"><?php echo e($subject->description ?: 'No detailed description specified for this subject.'); ?></p>
                ...
                <div class="connection-pill">
                    ...
                    <span>
                        Connected Course:
                        <strong><?php echo e($subject->course?->title ?? 'Unlinked / Standalone'); ?></strong>
                    </span>
                </div>

                <div class="subj-meta-row">
                    <div class="subj-meta-item">
                        <span>🎓</span> <?php echo e($subject->units ?: 3); ?> Units
                    </div>
                    <div class="subj-meta-item">
                        <span>⏱️</span> <?php echo e($subject->hours ?: 54); ?> Hours
                    </div>
                    <div class="subj-meta-item">
                        <span>👨‍🏫</span> <?php echo e($subject->teacher?->name ?: auth()->user()->name); ?>
            ...
            <div class="subj-actions">
                <a href="<?php echo e(route('teacher.subjects.lesson', $subject->id)); ?>" class="action-btn btn-lessons">
                ...
                <a href="<?php echo e(route('teacher.subjects.edit', $subject->id)); ?>" class="action-btn btn-edit-subj" title="Edit Subject">
                    <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                    Edit
                </a>
                <form method="POST" action="<?php echo e(route('teacher.subjects.destroy', $subject->id)); ?>" onsubmit="return confirm('Are you sure you want to delete subject <?php echo e($subject->title); ?>?');" style="display:inline;">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('teacher.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\teacher\SUBJECT\index.blade.php ENDPATH**/ ?>