...
<div class="admin-card student-profile-shell">
  <div class="student-profile-header">
    <div class="student-identity">
      <div class="student-avatar"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></div>
      <div class="student-name-wrap">
        <h3><?php echo e($user->name); ?></h3>
        <span class="student-role-badge"><?php echo e($user->role ?? 'student'); ?></span>
      </div>
    </div>
  </div>
  ...
  <div class="student-summary-grid">
    <div class="student-summary-item">
      ...
      <span class="student-stat-value"><?php echo e($user->lrn ?? $user->id); ?></span>
    </div>
    <div class="student-summary-item">
      <span class="student-stat-label">Email</span>
      <span class="student-stat-value"><?php echo e($user->email ?? '—'); ?></span>
    </div>
    <div class="student-summary-item">
      <span class="student-stat-label">Created</span>
      <span class="student-stat-value"><?php echo e($user->created_at ? $user->created_at->toDayDateTimeString() : '—'); ?></span>
    </div>
  </div>
  ...
  <div class="student-detail-grid">
    ...
    <div class="student-info-block">
      ...
      <span class="student-info-value"><?php echo e($user->updated_at ? $user->updated_at->toDayDateTimeString() : '—'); ?></span>
      <small>Most recent profile modification</small>
    </div>
  </div>

  <div class="student-actions">
    <a href="<?php echo e(route('sias.admin.students.edit', $user->id)); ?>" class="admin-actions student-action-btn">Edit</a>
    <a href="<?php echo e(route('sias.admin.students.enrollment-certificate', $user->id)); ?>" class="admin-actions student-action-btn" target="_blank" rel="noopener">Print Enrollment Certificate</a>
    <a href="<?php echo e(route('sias.admin.students.grade-certificate', $user->id)); ?>" class="admin-actions student-action-btn" target="_blank" rel="noopener">Print Grade Certificate</a>
    <a href="<?php echo e(route('sias.admin.students.index')); ?>" class="admin-actions secondary student-action-btn">Back to list</a>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\students\show.blade.php ENDPATH**/ ?>