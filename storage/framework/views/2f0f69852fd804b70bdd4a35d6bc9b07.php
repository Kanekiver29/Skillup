<?php $__env->startSection('title', 'Edit Teacher — ' . $user->name . ' — SIAS Admin'); ?>
<?php $__env->startSection('page_title', 'Edit Teacher Profile'); ?>
<?php $__env->startSection('subtitle', 'Update teacher credentials, assign subjects, or adjust faculty designation.'); ?>

<?php $__env->startSection('header_actions'); ?>
  <a href="<?php echo e(route('sias.admin.teachers')); ?>" class="btn btn-secondary" title="Return to teacher list">
...
<div class="tm-edit-container">
  ...
  <div class="tm-profile-header">
    <div class="tm-profile-info">
      <div class="tm-avatar-lg" aria-hidden="true"><?php echo e($initials ?: 'T'); ?></div>
      <div>
        <h2 class="tm-profile-name"><?php echo e($user->name); ?></h2>
        <div class="tm-profile-email"><?php echo e($user->email); ?></div>
      </div>
    </div>
    <div class="tm-profile-stats">
      <div class="tm-mini-stat">
        <div class="tm-mini-val"><?php echo e($user->subjects->count()); ?></div>
        <div class="tm-mini-lbl">Subjects</div>
      </div>
      <div class="tm-mini-stat">
        <div class="tm-mini-val"><?php echo e($user->courses->count()); ?></div>
  ...
  <div class="tm-form-card">
    <form action="<?php echo e(route('sias.admin.teachers.update', $user)); ?>" method="POST">
      <?php echo csrf_field(); ?>
      ...
      <div class="tm-form-grid">
        <div class="tm-form-group">
          ...
          <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" class="tm-input" required />
        </div>

        <div class="tm-form-group">
          <label class="tm-label">Email Address <span class="req">*</span></label>
          <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="tm-input" required />
        </div>

        <div class="tm-form-group">
          <label class="tm-label">Staff Designation</label>
          <select name="staff_type" class="tm-select">
            <option value="teacher" <?php echo e(old('staff_type', $user->staff_type) === 'teacher' ? 'selected' : ''); ?>>Teacher (Regular Faculty)</option>
            <option value="instructor" <?php echo e(old('staff_type', $user->staff_type) === 'instructor' ? 'selected' : ''); ?>>Instructor (Course Trainer)</option>
          </select>
        </div>
      ...
      <div class="tm-check-grid">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <label class="tm-check-item">
            <input type="checkbox" name="subject_ids[]" value="<?php echo e($subject->id); ?>" <?php echo e(in_array($subject->id, $assignedSubjectIds) ? 'selected' : ''); ?> <?php echo e(in_array($subject->id, $assignedSubjectIds) ? 'checked' : ''); ?> />
            <div>
              <div class="tm-check-text"><?php echo e($subject->title); ?></div>
              <div class="tm-check-meta">
                <?php echo e($subject->subject_code ? '[' . $subject->subject_code . '] ' : ''); ?><?php echo e($subject->course->title ?? 'General'); ?>
      ...
      <div class="tm-check-grid">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <label class="tm-check-item">
            <input type="checkbox" name="course_ids[]" value="<?php echo e($course->id); ?>" <?php echo e(in_array($course->id, $assignedCourseIds) ? 'selected' : ''); ?> <?php echo e(in_array($course->id, $assignedCourseIds) ? 'checked' : ''); ?> />
            <div>
              <div class="tm-check-text"><?php echo e($course->title); ?></div>
              <div class="tm-check-meta"><?php echo e($course->category ?? 'Course Program'); ?></div>
            </div>
          </label>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
      ...
      <div class="tm-form-actions">
        ...
        <a href="<?php echo e(route('sias.admin.teachers')); ?>" class="btn btn-secondary" style="width: auto; padding: 0.75rem 1.4rem;">Cancel</a>
      </div>
    </form>
  </div>
  ...
  <div class="tm-danger-card">
    <div class="tm-danger-header">
      <div>
        ...
        <p class="tm-danger-desc">This will revert <?php echo e($user->name); ?> back to a regular student account and unassign all teaching duties.</p>
      </div>
      <form action="<?php echo e(route('sias.admin.teachers.demote', $user)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to demote <?php echo e(addslashes($user->name)); ?> back to a student?');">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('sias.admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\sias\admin\teachers\edit.blade.php ENDPATH**/ ?>