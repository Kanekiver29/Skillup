        ...
        <div class="auth-body">
            ...
            <form method="POST" action="<?php echo e(url('/password/reset')); ?>">
                ...
                <div class="auth-field">
                    ...
                    <input id="email" type="email" name="email" value="<?php echo e(old('email', $email ?? '')); ?>" required autofocus class="auth-input">
                </div>
                <div class="auth-field">
...
<?php echo $__env->make('auth.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\auth\passwords\reset.blade.php ENDPATH**/ ?>