<?php $__env->startSection('title', 'Create New Subject'); ?>
    ...
    <div style="max-width:760px; margin:0 auto; position:relative; z-index:2;">
        ...
        <div class="syl-panel">
            ...
            <div class="syl-panel-content">
                <form action="<?php echo e(route('staff.subjects.store')); ?>" method="POST" id="subject-form" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;" class="responsive-grid">
                        <div class="syl-field" style="--fi:0;">
                            ...
                            <input type="text" name="subject_code" id="subject_code"
                                   value="<?php echo e(old('subject_code')); ?>" placeholder="e.g. CS101"
                                   class="syl-input" />
                        </div>
                        <div class="syl-field" style="--fi:1;">
                            <label class="syl-label" for="title">Subject Name</label>
                            <input type="text" name="title" id="title"
                                   value="<?php echo e(old('title')); ?>" placeholder="Enter subject name…"
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:1rem; margin-top:1rem;" class="responsive-grid">
                        <div class="syl-field" style="--fi:3;">
                            ...
                            <input type="number" name="units" id="units"
                                   value="<?php echo e(old('units')); ?>" class="syl-input" min="0"/>
                        </div>
                        <div class="syl-field" style="--fi:4;">
                            <label class="syl-label" for="hours">Hours</label>
                            <input type="number" name="hours" id="hours"
                                   value="<?php echo e(old('hours')); ?>" class="syl-input" min="0"/>
                        </div>
...
<?php echo $__env->make('staff.layouts.masters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillupv2\resources\views\staff\subjects\create.blade.php ENDPATH**/ ?>