    ...
    <aside class="sidebar"
        ...
        <nav class="sb-nav-scroll" aria-label="Sidebar menu">
            ...
            <a href="{{ route('staff.subjects.index') }}"
               class="sb-nav-item {{ request()->routeIs('staff.subjects.*') ? 'is-active' : '' }}"
               title="Subjects">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                     stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('staff.teacher-subjects.index') }}" class="sb-nav-item {{ request()->routeIs('staff.teacher-subjects.*') ? 'is-active' : '' }}" title="Trainer Assignment">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
                    <path d="M3 4h12M3 9h8M3 14h6"/><path d="M13 11v5M10.5 13.5h5"/>
                </svg>
                <span class="sb-label">Trainer Assignment</span>
            </a>
            <a href="{{ route('staff.schedule.index') }}" class="sb-nav-item {{ request()->routeIs('staff.schedule.*') ? 'is-active' : '' }}" title="Trainer Schedule">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="{{ route('staff.attendance.index') }}" class="sb-nav-item {{ request()->routeIs('staff.attendance.*') ? 'is-active' : '' }}" title="Daily Attendance">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="{{ route('staff.assessments.schedule') }}" class="sb-nav-item {{ request()->routeIs('staff.assessments.schedule') ? 'is-active' : '' }}" title="Assessment Schedule">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="{{ route('staff.assessments.results') }}" class="sb-nav-item {{ request()->routeIs('staff.assessments.results') ? 'is-active' : '' }}" title="Assessment Results">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
            ...
            <a href="{{ route('staff.syllabi.index') }}"
               class="sb-nav-item {{ request()->routeIs('staff.syllabi.*') ? 'is-active' : '' }}"
               title="Syllabus">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                     stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('staff.news.index') }}"
               class="sb-nav-item {{ request()->routeIs('staff.news.*') ? 'is-active' : '' }}"
               title="News & Alerts">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor"
                     stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('staff.reports.daily') }}" class="sb-nav-item {{ request()->routeIs('staff.reports.daily') ? 'is-active' : '' }}" title="Trainee Reports">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
                    <path d="M3 15V3h12v12M6 12V8M9 12V5M12 12V9"/>
                </svg>
                <span class="sb-label">Trainee Reports</span>
            </a>
            <a href="{{ route('staff.reports.staff') }}" class="sb-nav-item {{ request()->routeIs('staff.reports.staff') ? 'is-active' : '' }}" title="Training Reports">
                <svg class="sb-icon" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5">
