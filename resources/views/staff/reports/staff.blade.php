...
<div class="rp-wrap">
    ...
    <div class="rp-header">
        ...
        <div class="rp-header__actions">
            <a href="{{ route('staff.enrollments.export') }}" class="rp-btn rp-btn--primary">
            ...
            <a href="{{ route('staff.settings.index') }}" class="rp-btn rp-btn--outline">
    ...
    <div class="rp-card">
        ...
        <div class="rp-tabs" role="tablist" id="rp-tablist">
            ...
            @foreach($tabs as $key => $meta)
                <button
                    class="rp-tab{{ $loop->first ? ' is-active' : '' }}"
                    role="tab"
                    data-target="{{ $key }}"
            ...
            <div class="rp-panel is-active" id="panel-enrollments" role="tabpanel">
                <div class="rp-stats">
                    <div class="rp-stat">
                        ...
                        <div class="rp-stat__value">{{ $reports['total_enrollees'] ?? 0 }}</div>
                    </div>
                    <div class="rp-stat rp-stat--success">
                        <div class="rp-stat__icon">🆕</div>
                        <div class="rp-stat__label">New (Last 30 days)</div>
                        <div class="rp-stat__value">{{ $reports['new_enrollees_30d'] ?? 0 }}</div>
                    </div>
                    <div class="rp-stat rp-stat--warning">
                        ...
                        <div class="rp-stat__value" style="font-size:1.1rem;padding-top:.25rem">
                            @php $months = $reports['enrollment_by_month'] ?? collect(); @endphp
                            <ul class="rp-month-list">
                                @forelse($months as $m)
                                    <li><span>{{ $m->month }}</span> <strong>{{ $m->total }}</strong></li>
                                @empty
                ...
                <div class="rp-table-wrap">
                    <table class="rp-table">
                        ...
                        <tbody>
                            @forelse(($reports['enrollment_by_course'] ?? collect()) as $c)
                                <tr>
                                    <td>{{ $c->title }}</td>
                                    <td class="num">{{ $c->enrollments_count ?? $c->count ?? 0 }}</td>
                                </tr>
                            @empty
            ...
            <div class="rp-panel" id="panel-trainees" role="tabpanel">
                <div class="rp-stats">
                    <div class="rp-stat rp-stat--success">
                        ...
                        <div class="rp-stat__value">{{ $reports['active_trainees'] ?? 0 }}</div>
                    </div>
                    <div class="rp-stat">
                        <div class="rp-stat__icon">🎯</div>
                        <div class="rp-stat__label">Completed</div>
                        <div class="rp-stat__value">{{ $reports['completed_trainees'] ?? 0 }}</div>
                    </div>
                    <div class="rp-stat rp-stat--danger">
                        <div class="rp-stat__icon">⛔</div>
                        <div class="rp-stat__label">Dropped</div>
                        <div class="rp-stat__value">{{ $reports['dropped_trainees'] ?? 0 }}</div>
                    </div>
                </div>
                ...
                <div class="rp-table-wrap">
                    <table class="rp-table">
                        ...
                        <tbody>
                            @forelse(($reports['attendance_summary'] ?? collect()) as $r)
                                <tr>
                                    <td>{{ $r->date }}</td>
                                    <td class="num">{{ $r->present_count }}</td>
                                </tr>
                            @empty
            ...
            <div class="rp-panel" id="panel-assessments" role="tabpanel">
                <div class="rp-stats">
                    <div class="rp-stat">
                        ...
                        <div class="rp-stat__value">{{ $reports['assessments_total'] ?? 0 }}</div>
                    </div>
                </div>
                <div class="rp-info">
            ...
            <div class="rp-panel" id="panel-certificates" role="tabpanel">
                <div class="rp-stats">
                    <div class="rp-stat rp-stat--success">
                        ...
                        <div class="rp-stat__value">{{ $reports['certificates_issued'] ?? 0 }}</div>
                    </div>
                    <div class="rp-stat rp-stat--warning">
                        <div class="rp-stat__icon">⏳</div>
                        <div class="rp-stat__label">Pending</div>
                        <div class="rp-stat__value">{{ $reports['certificates_pending'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="rp-panel" id="panel-trainers" role="tabpanel">
                <div class="rp-stats">
                    <div class="rp-stat">
                        ...
                        <div class="rp-stat__value">{{ $reports['trainers_count'] ?? 0 }}</div>
                    </div>
                </div>
                <div class="rp-info">
                    <span class="rp-info__icon">ℹ️</span>
            ...
            <div class="rp-panel" id="panel-courses" role="tabpanel">
                ...
                <div class="rp-table-wrap">
                    <table class="rp-table">
                        ...
                        <tbody>
                            @forelse(($reports['course_completion'] ?? collect()) as $c)
                                @php
                                ...
                                <tr>
                                    <td>{{ $c->title }}</td>
                                    <td class="num">{{ $c->completed_count }}</td>
                                    <td class="num" style="color:var(--muted)">{{ $c->total_enrolled }}</td>
                                    <td>
                                        <div class="rp-bar-wrap">
                                            <div class="rp-bar">
                                                <div class="rp-bar__fill" data-pct="{{ $pct }}"></div>
                                            </div>
                                            <span class="rp-bar__pct">{{ $pct }}%</span>
                                        </div>
                                    </td>
                                </tr>
                            @empty
                ...
                <div class="rp-stats">
                    <div class="rp-stat rp-stat--success">
                        ...
                        <div class="rp-stat__value" style="font-size:1.6rem">
                            ₱{{ number_format($reports['total_fees_collected'] ?? 0, 2) }}
                        </div>
                    </div>
                </div>
                <div class="rp-info">
            ...
            <div class="rp-panel" id="panel-system" role="tabpanel">
                <div class="rp-stats">
                    <div class="rp-stat">
                        ...
                        <div class="rp-stat__value">{{ $reports['login_history_count'] ?? 0 }}</div>
                    </div>
                </div>
                <div class="rp-info">
                    <span class="rp-info__icon">ℹ️</span>
