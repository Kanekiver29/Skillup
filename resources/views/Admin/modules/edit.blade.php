...
<div class="container mx-auto p-6">
    <header class="mb-6">
        ...
        <p class="text-sm text-gray-600">Editing: <span class="font-medium">{{ $module->title }}</span></p>
    </header>
    ...
    <div class="bg-white shadow rounded p-6 max-w-2xl">
        <form action="{{ route('admin.modules.update', $module) }}" method="POST">
            ...
            <div class="mt-6 flex items-center space-x-3">
                ...
                <a href="{{ route('admin.modules.index', ['course_id' => $module->course_id]) }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition">
                    Cancel
                </a>
            </div>
        </form>
    ...
    <div class="mt-8 max-w-2xl bg-amber-50 border border-amber-200 rounded p-6">
        ...
        <form action="{{ route('admin.modules.destroy', $module) }}" method="POST" onsubmit="return confirm('Are you sure you want to archive this module?');">
            @csrf
            @method('DELETE')
    ...
    <div class="mt-4 max-w-2xl bg-red-50 border border-red-200 rounded p-6">
        ...
        <form action="{{ route('admin.modules.force-delete', $module) }}" method="POST" onsubmit="return confirm('Are you sure? This will PERMANENTLY delete this module and all its data. This cannot be undone.');">
            @csrf
            @method('DELETE')
