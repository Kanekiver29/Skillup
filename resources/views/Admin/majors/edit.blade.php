...
<div class="container mx-auto max-w-2xl px-6 py-8">
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">{{ $major->name }}</p>
    </div>

    <div class="bg-white rounded-lg shadow p-8">
        <form method="POST" action="{{ route('admin.majors.update', $major) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input 
                        ...
                        name="department" 
                        type="text" 
                        value="{{ old('department', $major->department) }}" 
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input 
                            ...
                            name="color" 
                            type="color" 
                            value="{{ old('color', $major->color ?? '#3B82F6') }}" 
