<div class="grid grid-cols-1 gap-6">
    <div>
        ...
        <input type="text" name="title" value="{{ old('title', $course->title ?? '') }}" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md" required>
        @error('title')<p class="text-red-600 text-xs mt-1">{{ $message }}</p>@enderror
    </div>

    <div>
        <label class="block text-sm font-medium text-white">Short Description</label>
        <textarea name="short_description" rows="2" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md">{{ old('short_description', $course->short_description ?? '') }}</textarea>
    ...
    <div>
        ...
        <textarea name="description" rows="4" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md">{{ old('description', $course->description ?? '') }}</textarea>
    ...
    <div class="grid grid-cols-2 gap-6">
        <div>
            ...
            <input type="text" name="category" value="{{ old('category', $course->category ?? '') }}" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md" required>
    ...
    <div class="grid grid-cols-2 gap-6">
        <div>
            ...
            <input type="number" step="0.1" name="duration_hours" value="{{ old('duration_hours', $course->duration_hours ?? '') }}" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md">
        ...
        <div>
            ...
            <input type="text" name="image_url" value="{{ old('image_url', $course->image_url ?? '') }}" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md">
    ...
    <div class="grid grid-cols-2 gap-6">
        <div>
            ...
            <input type="text" name="instructor_name" value="{{ old('instructor_name', $course->instructor_name ?? '') }}" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md">
        ...
        <div>
            ...
            <input type="text" name="instructor_title" value="{{ old('instructor_title', $course->instructor_title ?? '') }}" class="mt-1 block w-full text-white bg-slate-800 border-slate-600 rounded-md">
