...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-semibold mb-6">Enrollments</h1>
                ...
                <tbody>
                    @forelse($enrollments as $e)
                        <tr class="border-b hover:bg-gray-50">
                            <td class="px-6 py-4 text-sm font-medium">{{ $e->course->title }}</td>
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $e->user->name }}<br><span class="text-xs text-gray-500">{{ $e->user->email }}</span></td>
