    ...
    @if ($total)
        ...
        <div class="sp-summary" role="list" aria-label="Student summary">
            ...
            <div class="sp-stat" style="animation-delay:.05s" role="listitem">
                ...
                <div class="sp-stat__value">{{ $total }}</div>
            ...
            <div class="sp-stat" style="animation-delay:.2s" role="listitem">
                ...
                <div class="sp-stat__value clr-blue">{{ $avgProg }}%</div>
            ...
            <div class="sp-stat" style="animation-delay:.25s" role="listitem">
                ...
                <div class="sp-stat__value clr-indigo">{{ $highProg }}</div>
                ...
                >
                    <div class="s-card-inner">
                        ...
                        <div class="s-card__top">
                            <div class="s-avatar {{ $av }}" aria-hidden="true">
                                {{ $initials }}
                                <span class="s-avatar__badge {{ $onlineCls }}" title="{{ ucfirst($onlineCls) }}"></span>
                            </div>
                        ...
                        <div class="s-card__body">
                            ...
                            <div class="s-micro">
                                ...
                                <div class="s-micro__val">{{ $grade ?? '—' }}</div>
                            </div>
                        </div>
                        ...
                        <div class="s-progress__row">
                            ...
                            <span class="s-progress__val">{{ $progress }}%</span>
                        </div>
                        <div
