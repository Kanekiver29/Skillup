...
<div class="page-card">
    ...
    <div class="account-info-grid">
        <div class="section-block">
            ...
            <strong data-i18n="name">Name</strong>: {{ auth()->user()->name ?? 'Instructor Name' }}
        </div>
        <div class="section-block">
            <i class="fa-solid fa-envelope"></i>
            <strong data-i18n="email">Email</strong>: {{ auth()->user()->email ?? 'teacher@example.com' }}
        </div>
        <div class="section-block">
    ...
    <div style="margin-top:1.5rem;">
        <a href="{{ route('sias.teacher.account.password') }}" class="btn btn-black">
