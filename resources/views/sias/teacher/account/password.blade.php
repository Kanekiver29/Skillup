...
<div class="page-card" style="max-width:720px">
    ...
    <form method="POST" action="{{ route('sias.teacher.account.password.update') }}" style="display:grid;gap:1.1rem;margin-top:1.25rem;" id="changePasswordForm">
        @csrf
        @method('PUT')
        ...
        <div style="display:flex;align-items:center;gap:.75rem;margin-top:.25rem;flex-wrap:wrap;">
            ...
            <a href="{{ route('sias.teacher.account') }}" class="btn btn-white">
