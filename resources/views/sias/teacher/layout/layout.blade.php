...
<head>
    ...
    <title>@yield('title', 'SIAS Teacher')</title>
    ...
    <script>
        (function () {
            var configuredTheme = @json(data_get(auth()->user()?->settings, 'appearance.theme'));
...
<div class="layout-shell">
    <aside class="nav-panel" id="navPanel">
        ...
        <div class="brand-mark">
            <img class="seal" src="{{ asset('image/hello.png') }}" alt="SkillUp logo">
            <div class="brand-copy">
                <span class="eyebrow">{{ __('sias.faculty_access') }}</span>
                <h1><span data-i18n="teacher_portal">SIAS Teacher</span></h1>
            </div>
        </div>
        <nav>
            <a href="{{ url('/sias/teacher/dashboard') }}" class="{{ request()->is('sias/teacher/dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('sias.teacher.programs') }}" class="{{ request()->is('sias/teacher/programs*') ? 'active' : '' }}">
                <i class="fa-solid fa-graduation-cap"></i> <span>{{ __('sias.my_training_programs') }}</span>
                <span class="nav-tooltip">{{ __('sias.my_training_programs') }}</span>
            </a>
            <a href="{{ route('sias.teacher.classes') }}" class="{{ request()->is('sias/teacher/classes*') ? 'active' : '' }}">
                <i class="fa-solid fa-users-rectangle"></i> <span>{{ __('sias.my_classes_batches') }}</span>
                <span class="nav-tooltip">{{ __('sias.my_classes_batches') }}</span>
            </a>
            <a href="{{ route('sias.teacher.trainees') }}" class="{{ request()->is('sias/teacher/trainees*') ? 'active' : '' }}">
                <i class="fa-solid fa-user-group"></i> <span>{{ __('sias.trainees') }}</span>
                <span class="nav-tooltip">{{ __('sias.trainees') }}</span>
            </a>
            <a href="{{ route('sias.teacher.schedule') }}" class="{{ request()->is('sias/teacher/schedule*') ? 'active' : '' }}">
                <i class="fa-solid fa-calendar-days"></i> <span>{{ __('sias.training_schedule') }}</span>
                <span class="nav-tooltip">{{ __('sias.training_schedule') }}</span>
            </a>
            <a href="{{ route('sias.teacher.attendance') }}" class="{{ request()->is('sias/teacher/attendance*') ? 'active' : '' }}">
                <i class="fa-solid fa-calendar-check"></i> <span>{{ __('sias.attendance') }}</span>
                <span class="nav-tooltip">{{ __('sias.attendance') }}</span>
            </a>
            <a href="{{ route('sias.teacher.competency') }}" class="{{ request()->is('sias/teacher/competency*') ? 'active' : '' }}">
                <i class="fa-solid fa-layer-group"></i> <span>{{ __('sias.competency_modules') }}</span>
                <span class="nav-tooltip">{{ __('sias.competency_modules') }}</span>
            </a>
            <a href="{{ route('sias.teacher.assessments') }}" class="{{ request()->is('sias/teacher/assessments*') ? 'active' : '' }}">
                <i class="fa-solid fa-clipboard-check"></i> <span>{{ __('sias.assessment') }}</span>
                <span class="nav-tooltip">{{ __('sias.assessment') }}</span>
            </a>
            <a href="{{ route('sias.teacher.materials') }}" class="{{ request()->is('sias/teacher/materials*') ? 'active' : '' }}">
                <i class="fa-solid fa-folder-open"></i> <span>{{ __('sias.learning_materials') }}</span>
                <span class="nav-tooltip">{{ __('sias.learning_materials') }}</span>
            </a>
            <a href="{{ route('sias.teacher.progress') }}" class="{{ request()->is('sias/teacher/progress*') ? 'active' : '' }}">
                <i class="fa-solid fa-chart-line"></i> <span>{{ __('sias.trainee_progress') }}</span>
                <span class="nav-tooltip">{{ __('sias.trainee_progress') }}</span>
            </a>
            <a href="{{ route('sias.teacher.reports') }}" class="{{ request()->is('sias/teacher/reports*') ? 'active' : '' }}">
                <i class="fa-solid fa-chart-column"></i> <span>{{ __('sias.reports') }}</span>
                <span class="nav-tooltip">{{ __('sias.reports') }}</span>
            </a>
            <a href="{{ route('sias.teacher.announcements') }}" class="{{ request()->is('sias/teacher/announcements*') ? 'active' : '' }}">
                <i class="fa-solid fa-bullhorn"></i> <span>{{ __('sias.announcements') }}</span>
                <span class="nav-tooltip">{{ __('sias.announcements') }}</span>
            </a>
            <a href="{{ url('/sias/teacher/profile') }}" class="{{ request()->is('sias/teacher/profile') ? 'active' : '' }}">
                <i class="fa-solid fa-user"></i> <span>{{ __('sias.trainer_profile') }}</span>
                <span class="nav-tooltip">{{ __('sias.trainer_profile') }}</span>
            </a>
            <a href="{{ route('sias.teacher.settings') }}" class="{{ request()->is('sias/teacher/settings*') ? 'active' : '' }}">
                <i class="fa-solid fa-gear"></i> <span>{{ __('sias.teacher_settings') }}</span>
                <span class="nav-tooltip">{{ __('sias.teacher_settings') }}</span>
            </a>
        </nav>
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <button type="submit" class="btn btn-logout">
                ...
                <span>{{ __('sias.sign_out') }}</span>
                <span class="nav-tooltip">{{ __('sias.sign_out') }}</span>
            </button>
        </form>
    </aside>
                ...
                <div class="lang-pill">
                    @foreach(['en' => 'EN', 'tl' => 'TL'] as $code => $label)
                        <form method="GET" action="{{ route('language.switch', $code) }}" style="margin:0;display:inline-flex;">
                            <button type="submit" class="lang-btn {{ app()->getLocale() === $code ? 'is-active' : '' }}">{{ $label }}</button>
                        </form>
                    @endforeach
                </div>
