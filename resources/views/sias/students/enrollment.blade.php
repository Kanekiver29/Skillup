...
<div class="page-card" style="max-width: 1100px; margin: 0 auto;">
    <div class="enrollment-header">
        ...
        <div style="display:flex; gap:.75rem; flex-wrap:wrap;">
            <a href="{{ route('sias.student.registration') }}" class="btn-black">Register Course</a>
            <a href="{{ route('sias.student.registration.enrollment_form') }}" class="btn-white">Enrollment Form</a>
        </div>
    </div>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <strong>{{ auth()->user()->program ?? 'Bachelor of Science in Information Technology' }}</strong>
        </div>
        <div class="stat-card">
            <span class="label">Year Level</span>
            <strong>{{ auth()->user()->year_level ?? '4th Year' }}</strong>
        </div>
        <div class="stat-card">
    ...
    <div class="form-actions">
        <a href="{{ route('sias.student.registration.assessment_form') }}" class="btn-black">Print Assessment Form</a>
        <a href="{{ route('sias.student.registration.enrollment_certificate') }}" class="btn-white">Certificate of Enrollment</a>
