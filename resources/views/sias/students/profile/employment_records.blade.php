...
@section('page_title', 'Employment Records')
...
<div class="page-card" style="padding:1.5rem;">
    ...
    <form method="POST" action="{{ route('sias.student.profile.employment_records.update') }}" class="section-card" style="display:grid;gap:1.5rem;max-width:860px;">
        @csrf
