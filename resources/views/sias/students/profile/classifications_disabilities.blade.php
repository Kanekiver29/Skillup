...
@section('title', 'Classifications & Disabilities')
@section('page_title', 'Classifications & Disabilities')
...
<div class="page-card" style="padding:1.5rem;">
    ...
    <form method="POST" action="{{ route('sias.student.profile.classifications_disabilities.update') }}" class="section-card" style="display:grid;gap:1.5rem;max-width:860px;">
        @csrf
