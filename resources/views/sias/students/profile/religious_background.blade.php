...
@section('page_title', 'Religious Background')
...
<div class="page-card" style="padding:1.5rem;">
    ...
    <form method="POST" action="{{ route('sias.student.profile.religious_background.update') }}" class="section-card" style="display:grid;gap:1.5rem;max-width:860px;">
        @csrf
