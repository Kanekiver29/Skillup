...
@section('title', $sectionMeta['title'] ?? 'Student Report')
@section('page_title', $sectionMeta['title'] ?? 'Student Report')
    ...
    <div class="rpt-header-card anim anim-1">
        <div class="rpt-title-area">
            <div class="rpt-breadcrumb">
                <span>Reports</span>
                <div class="dot"></div>
                <span>{{ $sectionMeta['title'] ?? 'Student Report' }}</span>
                <div class="dot"></div>
                <span class="chip">Period: {{ session('current_period') ?? '2025-2' }}</span>
            </div>
        ...
        <div class="rpt-actions no-print">
            ...
            <a href="{{ route('sias.student.reports.print', ['section' => $currentSection]) }}" target="_blank" rel="noopener" class="btn-rpt btn-pdf">
