    ...
    <div class="doc-box">
        <div class="doc-header">
            <div class="doc-brand-wrap">
                <img src="{{ asset('image/logo_oif_skillup_1_-removebg-preview.png') }}" alt="SkillUp Logo" class="doc-logo" />
                <div>
        ...
        <div class="student-meta">
            ...
            <div><span>Program</span><strong>{{ $course?->title ?? 'Not selected' }}</strong></div>
        ...
        <table class="doc-table">
            ...
            <tbody>
                <tr>
                    <td>{{ $course?->title ?? 'No course selected' }}</td>
                    <td>
                        @if($subjects->count())
