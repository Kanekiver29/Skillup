        ...
        <div class="rg-frame">
            <div class="rg-card" id="rg-card">
                ...
                <div class="rg-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="rg-form" novalidate>
                        @csrf

                        {{-- Full name --}}
                        <div class="rg-field @error('name') has-error @enderror">
                            <label for="name">
                            ...
                            >
                            @error('name')
                                <p class="rg-error" id="name-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>

                        {{-- Email --}}
                        <div class="rg-field @error('email') has-error @enderror">
                            <label for="email">
                            ...
                            >
                            @error('email')
                                <p class="rg-error" id="email-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>

                        {{-- Birthday + Age --}}
                        <div class="rg-grid-2">
                            <div class="rg-field @error('birthday') has-error @enderror">
                                <label for="birthday">
                                ...
                                >
                                @error('birthday')
                                    <p class="rg-error" id="birthday-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                                @enderror
                            </div>

                            <div class="rg-field @error('age') has-error @enderror">
                                <label for="age">
                                ...
                                >
                                @error('age')
                                    <p class="rg-error" id="age-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                                @enderror
                            </div>
                        </div>

                        {{-- Address --}}
                        <div class="rg-field @error('address') has-error @enderror">
                            <label for="address">
                            ...
                            >
                            @error('address')
                                <p class="rg-error" id="address-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>

                        {{-- Password --}}
                        <div class="rg-field @error('password') has-error @enderror">
                            <label for="password">
                            ...
                            @error('password')
                                <p class="rg-error" id="password-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>

                        {{-- Confirm Password --}}
                        <div class="rg-field @error('password_confirmation') has-error @enderror">
                            ...
                            @error('password_confirmation')
                                <p class="rg-error" id="password_confirmation-error"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="rg-checkbox" id="rg-terms-row">
                            ...
                            <label for="terms">
                                I agree to the
                                <a href="{{ route('terms') }}" target="_blank" rel="noopener">Terms of Service</a>
                                and
                                <a href="{{ route('privacy') }}" target="_blank" rel="noopener">Privacy Policy</a>
                            </label>
                            @error('terms')
                                <p class="rg-error" style="margin-left:0"><i class="fas fa-exclamation-circle"></i>{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <a href="{{ route('login') }}" class="rg-btn-outline">
