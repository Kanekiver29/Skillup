...
@section('title', 'SkillUp – A Personalized Learning Portal for Youth Career Development')
...
<section id="hero">
    ...
    {{-- Signature element: orbiting skill paths around the hero --}}
 ...
 <div class="institute-banner">
        ...
        <div class="hero-ctas hero-sr hero-sr-6">
            @auth
                ...
                <a href="{{ route('userpage.dashboard') }}" class="btn-ghost">
        ...
        <div class="marquee-track" aria-hidden="true">
            ...
            @foreach(array_merge($tags, $tags) as $tag)
                <span class="marquee-item">
                    <span class="marquee-dot"></span> {{ $tag }}
                </span>
            @endforeach
        </div>
    </div>
...
<section id="features">
    ...
    <div class="features-grid">
        ...
        @foreach($features as $i => $f)
            <div class="feature-card" data-sr data-sr-d="{{ min($i % 3 + 1, 5) }}" data-tilt>
                <div class="card-spotlight" aria-hidden="true"></div>
                <div class="card-edge" aria-hidden="true"></div>
                <span class="feature-index">MOD_{{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}</span>
                <div class="feature-icon {{ $f['fi'] }}">
    ...
    <div style="max-width:1100px;margin:0 auto;">
        ...
        <div class="how-grid" id="how-grid">
            ...
            @foreach($steps as $i => $step)
                <div class="step-card" data-sr data-sr-d="{{ $i + 1 }}" data-step>
                    <div class="step-dot"></div>
                    <span class="step-tag mono-font">{{ $step['tag'] }}</span>
                    <div class="step-num-wrap">
                        <div class="step-num {{ $step['sn'] }}">{{ $step['n'] }}</div>
                        <div class="step-icon-chip"><i class="fas {{ $step['icon'] }}"></i></div>
                    </div>
...
<section id="explore">
    ...
    <div class="explore-grid">
        <a href="{{ route('courses.index') }}" class="explore-card" data-sr data-sr-d="1">
        ...
        <a href="{{ route('about') }}" class="explore-card" data-sr data-sr-d="2">
        ...
        <a href="{{ route('contact') }}" class="explore-card" data-sr data-sr-d="3">
    ...
    <div style="max-width:1100px;margin:0 auto;">
        ...
        <div class="testimonials-grid">
            ...
            @foreach($testimonials as $i => $t)
                <article class="testimonial-card" data-sr data-sr-d="{{ $i + 1 }}">
                    <span class="t-quote-mark" aria-hidden="true">&rdquo;</span>
                    <div class="testimonial-header">
                        <div class="t-avatar {{ $t['ta'] }}">{{ $t['init'] }}</div>
                        <div>
...
<section id="cta-banner">
    ...
    <div class="cta-inner" data-sr>
        ...
        <div style="margin-top:2rem;">
            @auth
                <a href="{{ route('userpage.dashboard') }}" class="btn-primary">
    ...
    <div style="max-width:720px;margin:0 auto;">
        ...
        <div class="faq-list">
            ...
            @foreach($faqs as $i => $faq)
                <details class="faq-item" data-sr data-sr-d="{{ min($i + 1, 5) }}">
                    <summary>
                        <span><span class="faq-index mono-font">{{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}</span><span class="faq-q">{{ $faq['q'] }}</span></span>
