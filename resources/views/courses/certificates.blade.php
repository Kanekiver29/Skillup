...
<div class="max-w-6xl mx-auto px-4 py-10">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('userpage.dashboard') }}" class="inline-flex items-center px-4 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition">
    ...
    @if($completedEnrollments->isEmpty())
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <a href="{{ route('courses.index') }}" class="mt-5 inline-flex items-center px-5 py-3 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition">
                ...
                @if($course)
                    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-md">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="mt-3 text-xl font-bold text-gray-900">{{ $course->title ?? $course->course_title }}</h3>
                            <p class="mt-2 text-sm text-gray-600">Certificate of completion for successfully finishing this course.</p>

                            <div class="mt-5 flex flex-wrap gap-3">
                                <a href="{{ route('certificates.show', $course->slug) }}" class="inline-flex items-center px-4 py-2 rounded-lg bg-amber-500 text-white font-semibold hover:bg-amber-600 transition">
                                    <i class="fas fa-eye mr-2"></i> View
                                </a>
                                <a href="{{ route('certificates.show', $course->slug) }}?print=1" target="_blank" rel="noopener" class="inline-flex items-center px-4 py-2 rounded-lg border border-indigo-200 bg-indigo-50 text-indigo-700 font-semibold hover:bg-indigo-100 transition">
