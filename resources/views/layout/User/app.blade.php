...
<head>
    ...
    <title>@yield('title', 'SkillUp - Dashboard')</title>
...
<body>
    ...
    <header class="topbar">
        <div class="brand">
            ...
            <a href="{{ route('userpage.dashboard') }}" class="brand-name">SkillUp</a>
        </div>
        ...
        <div class="top-actions">
            ...
            <a href="{{ route('userpage.profile') }}" class="top-btn" aria-label="Profile">
                <i class="fas fa-user-circle"></i>
            </a>

            @auth
                <form action="{{ route('logout') }}" method="POST" class="inline" id="topbar-logout-form">
                    @csrf
    ...
    <div class="mobile-overlay" id="mobileOverlay" aria-hidden="true" role="dialog" aria-modal="true" aria-label="Navigation">
        ...
        <nav class="mobile-panel">
            ...
            <div class="mobile-nav">
                <a href="{{ route('userpage.dashboard') }}"><i class="fas fa-th-large" style="width:18px;color:var(--purple)"></i> Dashboard</a>
                <a href="{{ route('userpage.profile') }}"><i class="fas fa-user-circle" style="width:18px;color:var(--purple)"></i> Profile</a>
                <a href="{{ route('courses.index') }}"><i class="fas fa-book-open" style="width:18px;color:var(--purple)"></i> Courses</a>
                <a href="{{ route('chats.index') }}"><i class="fas fa-comment-alt" style="width:18px;color:var(--purple)"></i> Messages</a>
                <a href="{{ route('notifications.index') }}"><i class="fas fa-bell" style="width:18px;color:var(--purple)"></i> Notifications</a>
    ...
    <div class="main-wrap">
        ...
        <aside class="sidebar" aria-label="Dashboard navigation">
            ...
            <nav class="sb-nav">
                <a href="{{ route('userpage.dashboard') }}"
                   class="sb-link {{ request()->routeIs('userpage.dashboard') ? 'active' : '' }}">
                ...
                <a href="{{ route('badges.index') }}"
                   class="sb-link {{ request()->routeIs('badges.*') ? 'active' : '' }}">
            ...
            <nav class="sb-nav">
                <a href="{{ route('userpage.profile') }}"
                   class="sb-link {{ request()->routeIs('userpage.profile*') ? 'active' : '' }}">
                    <i class="fas fa-user sb-icon"></i> My Profile
                </a>
                <a href="{{ route('chats.index') }}"
                   class="sb-link {{ request()->routeIs('chats.*') ? 'active' : '' }}">
        ...
        <footer class="footer">
            <div class="footer-inner">
                <span>&copy; {{ date('Y') }} SkillUp. All rights reserved.</span>
