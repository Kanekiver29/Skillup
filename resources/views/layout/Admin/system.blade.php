...
<head>
    ...
    <title>@yield('title', 'SkillUp Admin')</title>
...
<header class="topbar" role="banner">
    ...
    <a href="{{ route('admin.dashboard') }}" class="topbar-brand" aria-label="SkillUp Admin Home">
        <div class="brand-logo-wrap">
            <img src="{{ asset('image/logo oif skillup(1).png') }}" alt="SkillUp Logo">
        </div>
    ...
    <div class="topbar-center">
        <div class="topbar-breadcrumb">
            ...
            <span class="bc-page">@yield('title', 'Dashboard')</span>
        </div>
    </div>
    ...
    <div class="topbar-actions">
        ...
        <div style="position:relative;" x-data="{ open: false }">
            ...
            <div class="dropdown" x-show="open" @click.away="open = false" x-cloak role="menu">
                <div class="dropdown-header">
                    <div class="dh-name">{{ Auth::check() ? Auth::user()->name : 'Admin' }}</div>
                    <div class="dh-email">{{ Auth::check() ? Auth::user()->email : 'admin@skillup.com' }}</div>
                </div>
            ...
            <div class="nav-section" role="navigation" aria-label="Main">
                ...
                <div class="nav-group">
                    ...
                    <a href="{{ route('admin.admins') }}"
                       ...
                       @if(request()->routeIs('admin.admins*')) aria-current="page" @endif>
                    ...
                    <a href="{{ route('admin.teachers.index') }}"
                       ...
                       @if(request()->routeIs('admin.teachers*')) aria-current="page" @endif>
            ...
            <div class="nav-section" role="navigation" aria-label="Communication">
                ...
                <div class="nav-group">
                    <a href="{{ route('admin.chats.index') }}"
                       ...
                       data-tip="Messenger"
                       @if(request()->routeIs('admin.chats*')) aria-current="page" @endif>
            ...
            <div class="nav-section" role="navigation" aria-label="Management">
                ...
                <div class="nav-group">
                    <a href="{{ route('admin.excel.index') }}"
                       class="nav-link {{ request()->routeIs('admin.excel*') ? 'active' : '' }}"
                       data-tip="Excel Reports"
                       @if(request()->routeIs('admin.excel*')) aria-current="page" @endif>
                    ...
                    <a href="{{ route('admin.archive') }}"
                       ...
                       data-tip="Archive"
                       @if(request()->routeIs('admin.archive')) aria-current="page" @endif>
...
<footer id="siteFooter" role="contentinfo">
    <div class="footer-inner">
        <span class="footer-copy">
            &copy; {{ date('Y') }} SkillUp. All rights reserved.
