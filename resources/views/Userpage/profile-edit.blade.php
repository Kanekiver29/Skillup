...
<div class="ep-page min-h-screen pt-20">
    <div class="max-w-4xl mx-auto px-4 pb-16">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
            <div class="ep-enter">
                <a href="{{ route('userpage.profile') }}" class="ep-link ep-mono inline-flex items-center text-sm uppercase tracking-wide mb-4 transition">
        ...
        <div class="ep-card ep-enter ep-enter-1 p-8">
            <form id="profile-form" action="{{ route('userpage.profile-update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="ep-subcard-violet mb-8 p-6">
                    ...
                    <div class="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div class="flex-1 w-full">
                            ...
                            @error('profile_image')
                                <p class="ep-error-text">{{ $message }}</p>
                            @enderror
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="lrn" placeholder="e.g., 123456789012" value="{{ old('lrn', auth()->user()->lrn ?? '') }}"
                                class="ep-input @error('lrn') ep-input-error @enderror">
                ...
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        <textarea name="bio" rows="6" placeholder="Tell us about yourself, your goals, and what you're passionate about..."
                            class="ep-textarea @error('bio') ep-input-error @enderror">{{ old('bio', auth()->user()->bio ?? '') }}</textarea>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('userpage.profile') }}" class="ep-btn-ghost px-8 py-3 inline-flex items-center">
                        Cancel
                    </a>
                </div>
                ...
                <div id="sticky-save-bar" class="fixed bottom-0 left-0 right-0 p-4 hidden justify-center z-50">
                    ...
                    <a href="{{ route('userpage.profile') }}" class="ep-btn-ghost ml-4 px-8 py-3 inline-flex items-center">
                        Cancel
                    </a>
                </div>
            </form>
