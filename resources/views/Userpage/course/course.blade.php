...
@section('title', 'Courses - SkillUp Learning Platform')
@section('content')
...
{{-- =====================================================================
     GOOGLE FONTS — a geometric display face for a console-like feel,
     a clean sans for reading, monospace for system-style data tags,
     and a warm serif for the book pages themselves (the one place the
     interface asks to be read rather than operated).
     ===================================================================== --}}
...
<div id="course-page">
    ...
    <div class="cp-layout">
                ...
                <ul class="cp-nav-list">
                    <li class="cp-nav-item">
                        <a href="{{ route('courses.index') }}"
                           class="cp-nav-link {{ request()->routeIs('courses.index') ? 'is-active' : '' }}">
                            <span class="cp-nav-ico">📖</span><span>Explore</span>
                        </a>
                    </li>
                    <li class="cp-nav-item">
                        <a href="{{ route('quiz') }}"
                           class="cp-nav-link {{ request()->routeIs('quiz') ? 'is-active' : '' }}">
                            <span class="cp-nav-ico">❓</span><span>Quizzes</span>
                        </a>
                    </li>
                    <li class="cp-nav-item">
                        <a href="{{ route('subjects') }}"
                           class="cp-nav-link {{ request()->routeIs('subjects') ? 'is-active' : '' }}">
                            <span class="cp-nav-ico">📚</span><span>Subjects</span>
                        </a>
                    </li>
                    <li class="cp-nav-item">
                        <a href="{{ route('trivia') }}"
                           class="cp-nav-link {{ request()->routeIs('trivia') ? 'is-active' : '' }}">
        ...
        <div class="cp-main">
            ...
            <div id="book-shell" data-course-book='@json($bookData)' class="book-shell">
