    ...
    <section id="about-hero" class="about-hero pt-32 pb-28 px-4 text-white">
        ...
        <div class="max-w-6xl mx-auto text-center relative z-10">
            <nav data-animate class="text-slate-300 text-sm mb-8" aria-label="Breadcrumb">
                <a href="{{ url('/') }}" class="hover:text-white transition-colors underline underline-offset-2">Home</a>
            ...
            <div data-animate class="delay-300 mt-10 flex flex-wrap justify-center gap-4">
                ...
                <a href="{{ route('courses.index') }}" class="btn-about font-display inline-flex items-center justify-center border-2 border-white/80 px-8 py-3.5 rounded-xl font-bold hover:bg-white hover:text-[#0a2540] transition-colors">
            ...
            <div data-animate class="delay-400 mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                @foreach ([
                    ...
                    <div class="hero-mini-stat hud-panel about-hover-lift rounded-3xl px-5 py-5">
                        ...
                        <p class="font-display text-2xl font-bold">{{ $s[0] }}</p>
                        <p class="mini-label text-[11px] uppercase text-cyan-100/70 mt-2">{{ $s[1] }}</p>
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="about-marquee-wrap max-w-full">
            <div class="about-marquee-track">
                ...
                @foreach (array_merge($tags,$tags) as $tag)
                    <span class="about-marquee-item">[ {{ $tag }} ]</span>
                @endforeach
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-6 items-stretch mb-16">
                ...
                <div data-animate class="delay-200 flex flex-col items-center justify-center py-6 lg:py-0">
                    ...
                    <div class="logo-display-wrap" id="logo-display-wrap" style="width:280px; height:280px;">
                        ...
                        <img
                            src="{{ asset('image/logo_oif_skillup_1_-removebg-preview.png') }}"
                    ...
                    <div data-animate class="delay-375 mt-6 flex items-center justify-center gap-6 flex-wrap">
                        <img
                            src="{{ asset('image/logo%20new.jpg') }}"
                            alt="Partner logo"
                            loading="lazy"
                            decoding="async"
                        ...
                        >
                        <img
                            src="{{ asset('image/bagong-pilipinas-logo-png_seeklogo-534301.png') }}"
                            ...
                            <div class="mt-6 grid gap-3 sm:grid-cols-2">
                                @foreach ([
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <span class="text-sm text-gray-700 leading-relaxed">{{ $policy }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @foreach ($values as $i => $v)
                    <div data-animate class="{{ $vd[$i] }} about-value-card hud-corners about-glass about-hover-lift p-8 rounded-2xl shadow-md border border-slate-200/70 group relative">
                        <span class="value-num-badge" aria-hidden="true">{{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}</span>
                        <div class="about-icon-wrap hex-icon w-14 h-14 {{ $v['bg'] }} flex items-center justify-center mb-5">
                            <i class="fas {{ $v['icon'] }} {{ $v['text'] }} text-2xl"></i>
                        </div>
                        <h3 class="font-display text-xl font-bold mb-3 text-gray-800">{{ $v['title'] }}</h3>
                        <p class="text-gray-600 leading-relaxed text-sm">{{ $v['desc'] }}</p>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="py-24 px-4 bg-gradient-to-b from-slate-50 to-white">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                @endphp
                @foreach ($apart as $i => $item)
                    <div data-animate class="{{ $ad[$i] }} about-apart-card hud-corners about-glass about-hover-lift p-8 rounded-2xl shadow-md border border-slate-200/70 group">
                        <div class="flex items-start gap-5">
                            <div class="about-icon-wrap hex-icon w-14 h-14 {{ $item['bg'] }} flex items-center justify-center shrink-0">
                                <i class="fas {{ $item['icon'] }} {{ $item['text'] }} text-2xl"></i>
                            </div>
                            <div>
                                <h3 class="font-display text-xl font-bold mb-2 text-gray-800">{{ $item['title'] }}</h3>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                @foreach ($mentors as $i => $m)
                    <div data-animate class="{{ $md[$i] }} about-mentor-card hud-corners about-glass about-hover-lift p-7 rounded-2xl shadow-md border border-slate-200/70">
                        <div class="flex items-center gap-4 mb-5">
                            <div class="about-mentor-avatar bg-gradient-to-br {{ $m['grad'] }}">{{ $m['initials'] }}</div>
                            <div>
                                <h3 class="font-display font-bold text-gray-800 leading-tight">{{ $m['name'] }}</h3>
                                <p class="text-xs text-gray-500 mt-0.5">{{ $m['role'] }}</p>
                            </div>
                        </div>
                        <p class="text-gray-600 text-sm leading-relaxed mb-4">{{ $m['desc'] }}</p>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                @foreach ($stats as $i => $stat)
                    <div data-animate class="{{ $sd[$i] }} about-stat-card hud-corners about-hover-lift p-6 md:p-8 rounded-2xl shadow-md text-center">
                        <p class="font-display text-3xl md:text-4xl font-bold about-stat-gradient mb-2 stat-number relative z-10"
                           data-count="{{ $stat['value'] }}"
                           data-suffix="{{ $stat['suffix'] }}"
                           @if(!empty($stat['decimal'])) data-decimal="1" @endif>
                            {{ $stat['display'] }}
                        </p>
                        <p class="about-stat-label font-semibold text-sm md:text-base relative z-10">{{ $stat['label'] }}</p>
                        <p class="about-stat-sub text-xs mt-1 relative z-10 font-hud">{{ $stat['sub'] }}</p>
                    </div>
                @endforeach
            </div>
                ...
                <div data-animate class="delay-100 milestone-rail">
                    ...
                    @foreach ($milestones as $ms)
                        <div class="milestone-item">
                            ...
                            <p class="milestone-tag mb-1">{{ $ms['tag'] }}</p>
                            <h4 class="font-display font-bold text-gray-800 mb-1.5">{{ $ms['title'] }}</h4>
                            <p class="text-gray-600 text-sm leading-relaxed max-w-xl">{{ $ms['desc'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                @foreach ($steps as $i => $step)
                    <div data-animate class="{{ $stepDel[$i] }} about-step text-center group">
                        <div class="about-timeline-dot hidden md:block" aria-hidden="true"></div>
                        <div class="about-step-circle {{ $step['bg'] }} text-white w-20 h-20 flex items-center justify-center mx-auto mb-5 text-3xl font-bold shadow-lg font-display">
                            {{ $step['num'] }}
                        </div>
                        <h3 class="font-display font-bold text-lg mb-2 text-gray-800">{{ $step['title'] }}</h3>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="space-y-4" id="faq-list">
                ...
                @foreach ($faqs as $i => $faq)
                    <div data-animate class="{{ $i % 2 == 0 ? 'delay-100' : 'delay-200' }} faq-item" data-faq>
                        <button type="button" class="faq-trigger" aria-expanded="false" aria-controls="faq-panel-{{ $i }}">
                            <span class="font-display font-semibold text-gray-800 text-base md:text-lg">{{ $faq['q'] }}</span>
                            <span class="faq-icon" aria-hidden="true"><i class="fas fa-plus text-xs"></i></span>
                        </button>
                        <div class="faq-panel" id="faq-panel-{{ $i }}" role="region">
                            <div class="faq-panel-inner">{{ $faq['a'] }}</div>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section class="py-20 px-4 bg-slate-50/90">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <a data-animate href="{{ route('courses.index') }}" class="delay-100 about-link-card hud-corners about-glass block p-6 rounded-2xl border border-slate-200/80 shadow-sm group">
                ...
                @auth
                    <a data-animate href="{{ route('userpage.roadmap') }}" class="delay-200 about-link-card hud-corners about-glass block p-6 rounded-2xl border border-slate-200/80 shadow-sm group">
                    ...
                    <a data-animate href="{{ route('ai-chatbot.index') }}" class="delay-300 about-link-card hud-corners about-glass block p-6 rounded-2xl border border-slate-200/80 shadow-sm group">
                ...
                @else
                    <a data-animate href="{{ route('register') }}" class="delay-200 about-link-card hud-corners about-glass block p-6 rounded-2xl border border-slate-200/80 shadow-sm group">
                    ...
                    <a data-animate href="{{ route('contact') }}" class="delay-300 about-link-card hud-corners about-glass block p-6 rounded-2xl border border-slate-200/80 shadow-sm group">
    ...
    <section class="py-20 px-4 about-cta text-white">
        ...
        <div data-animate class="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                @auth
                    <a href="{{ route('userpage.dashboard') }}" class="btn-about font-display inline-flex items-center justify-center bg-white text-[#0a2540] px-10 py-4 rounded-xl font-bold text-lg shadow-xl">
                        Go to your dashboard <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                @else
                    <a href="{{ route('register') }}" class="btn-about font-display inline-flex items-center justify-center bg-white text-[#0a2540] px-10 py-4 rounded-xl font-bold text-lg shadow-xl">
                        Get started free <i class="fas fa-rocket ml-2"></i>
                    </a>
                    <a href="{{ route('login') }}" class="btn-about font-display inline-flex items-center justify-center border-2 border-white/80 px-10 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-[#0a2540] transition-colors">
                        Sign in
                    </a>
                @endauth
            </div>
