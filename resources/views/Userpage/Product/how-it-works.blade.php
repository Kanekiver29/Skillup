...
@section('title', 'How It Works - SkillUp')
@section('content')
<div class="min-h-screen bg-slate-50 text-slate-900">
                ...
                @foreach([
                    ...
                    <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div class="flex items-center justify-between">
                            <span class="font-mono text-sm font-bold text-cyan-600">{{ $number }}</span>
                            <i class="fas {{ $icon }} text-lg text-blue-600" aria-hidden="true"></i>
                        </div>
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                @foreach([
                    ...
                    <div class="rounded-2xl bg-slate-50 p-6">
                        ...
                        <h3 class="mt-5 font-display text-lg font-bold">{{ $label }}</h3>
    ...
    {{-- Original learning loop, kept and expanded --}}
    <section class="px-4 py-20">
        <div class="mx-auto max-w-6xl">
            <div class="mb-12 max-w-2xl">
    ...
    <section class="border-y border-slate-200 bg-white px-4 py-16">
        <div class="mx-auto flex max-w-5xl flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            ...
            <a href="{{ route('courses.index') }}" class="inline-flex items-center rounded-xl bg-blue-600 px-6 py-3 font-bold text-white transition hover:bg-blue-700">Explore courses <i class="fas fa-arrow-right ml-2"></i></a>
        </div>
    </section>
</div>
@endsection