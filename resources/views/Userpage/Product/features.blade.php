...
@section('title', 'Features - SkillUp')
...
@section('content')
    ...
    <section class="py-20 px-4 bg-gray-50">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="overflow-hidden rounded-2xl shadow-xl border border-gray-200">
                ...
                <div class="grid grid-cols-3 {{ $i % 2 === 0 ? 'bg-white' : 'bg-gray-50' }} text-sm border-t border-gray-200">
                    <div class="px-6 py-4 text-gray-700">{{ $row[0] }}</div>
                ...
                <div class="grid grid-cols-3 border-t border-gray-200">
                    ...
                    <div class="px-6 py-6 text-center">
                        @guest
                            <a href="{{ route('register') }}" class="inline-block border-2 border-purple-600 text-purple-600 px-5 py-2 rounded-lg font-semibold hover:bg-purple-600 hover:text-white transition text-sm">
                                Sign Up Free
                            </a>
                        @endguest
                        @auth
                    ...
                    <div class="px-6 py-6 text-center bg-purple-50">
                        <a href="{{ route('pricing') }}" class="inline-block gradient-primary text-white px-5 py-2 rounded-lg font-semibold hover:opacity-90 transition text-sm">
                            Upgrade Now
                        </a>
                    </div>
                </div>
    ...
    <section class="py-24 px-4 gradient-primary text-white text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                @guest
                    <a href="{{ route('register') }}" class="bg-white text-purple-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-purple-50 transition shadow-lg">
                        Get Started Free <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                    <a href="{{ route('login') }}" class="border-2 border-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-purple-600 transition">
                        Log In
                    </a>
                @endguest
                @auth
                    <a href="{{ route('courses.index') }}" class="bg-white text-purple-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-purple-50 transition shadow-lg">
                        Browse All Courses <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                    <a href="{{ route('userpage.dashboard') }}" class="border-2 border-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-purple-600 transition">
                        Go to Dashboard
                    </a>
                @endauth
            </div>
