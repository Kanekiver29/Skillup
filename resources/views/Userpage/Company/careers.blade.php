		...
		<div class="max-w-6xl mx-auto relative">
			<nav class="text-sm text-purple-100 mb-6" aria-label="Breadcrumb">
				<ol class="flex flex-wrap items-center gap-2">
					...
					<li><a href="{{ route('company.aboutus') }}" class="hover:text-white transition">Company</a></li>
					<li><i class="fas fa-angle-right text-xs"></i></li>
		...
		<div class="max-w-6xl mx-auto">
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6" id="jobs-grid">
				<article class="job-card bg-white border border-gray-200 rounded-2xl p-6 card-hover" data-department="product">
					...
					<a href="{{ route('contact') }}" class="inline-flex items-center text-purple-600 font-semibold hover:text-purple-700 transition">Apply Now <i class="fas fa-arrow-right ml-2 text-sm"></i></a>
				</article>
	...
	<section class="py-16 px-4 gradient-secondary text-white">
		<div class="max-w-4xl mx-auto text-center">
			...
			<div class="flex flex-col sm:flex-row gap-4 justify-center">
				<a href="{{ route('contact') }}" class="bg-white text-pink-600 px-8 py-3 rounded-lg font-semibold hover:bg-pink-50 transition">Apply Through Contact Form</a>
				<a href="{{ route('company.blog') }}" class="border border-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-pink-600 transition">Read Team Stories</a>
			</div>
		</div>
	</section>
@endsection
