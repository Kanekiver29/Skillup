...
@section('title', 'Company Contact - SkillUp')
		...
		<div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
			...
			<aside class="space-y-6">
				...
				<div class="bg-linear-to-br from-indigo-50 to-pink-50 border border-indigo-100 rounded-2xl p-6">
					...
					<a href="{{ route('contact') }}" class="inline-flex items-center text-purple-600 font-semibold hover:text-purple-700">Open Support Contact <i class="fas fa-arrow-right ml-2 text-xs"></i></a>
				</div>
			</aside>
		</div>
	</section>
