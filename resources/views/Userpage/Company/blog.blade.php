		...
		<div class="max-w-6xl mx-auto">
			<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
				<article class="lg:col-span-2 bg-gray-50 border border-gray-200 rounded-2xl overflow-hidden card-hover">
					<img src="{{ asset('images/blog/blog-featured.svg') }}" alt="How to Build a Career-Ready Portfolio" class="w-full h-64 md:h-80 object-cover">
		...
		<div class="max-w-6xl mx-auto">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="blog-grid">
				<article class="blog-card bg-gray-50 border border-gray-200 rounded-xl overflow-hidden card-hover" data-category="career">
					<img src="{{ asset('images/blog/blog-resume.svg') }}" alt="5 Resume Upgrades Recruiters Notice" class="w-full h-40 object-cover">
					<div class="p-5">
				...
				<article class="blog-card bg-gray-50 border border-gray-200 rounded-xl overflow-hidden card-hover" data-category="learning">
					<img src="{{ asset('images/blog/blog-study.svg') }}" alt="A 45-Minute Study Sprint" class="w-full h-40 object-cover">
					<div class="p-5">
				...
				<article class="blog-card bg-gray-50 border border-gray-200 rounded-xl overflow-hidden card-hover" data-category="stories">
					<img src="{{ asset('images/blog/blog-story.svg') }}" alt="From Beginner to Intern: Maria's Journey" class="w-full h-40 object-cover">
					<div class="p-5">
				...
				<article class="blog-card bg-gray-50 border border-gray-200 rounded-xl overflow-hidden card-hover" data-category="learning">
					<img src="{{ asset('images/blog/blog-questions.svg') }}" alt="How to Ask Better Questions" class="w-full h-40 object-cover">
					<div class="p-5">
				...
				<article class="blog-card bg-gray-50 border border-gray-200 rounded-xl overflow-hidden card-hover" data-category="career">
					<img src="{{ asset('images/blog/blog-portfolio.svg') }}" alt="Portfolio Interview Questions" class="w-full h-40 object-cover">
					<div class="p-5">
				...
				<article class="blog-card bg-gray-50 border border-gray-200 rounded-xl overflow-hidden card-hover" data-category="stories">
					<img src="{{ asset('images/blog/blog-teamwork.svg') }}" alt="Team Learning Circles" class="w-full h-40 object-cover">
					<div class="p-5">
